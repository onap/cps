...
import org.onap.cps.nfproxy.rest.controller.NfProxyRestControllerSpecification
...
@WebMvcTest
class NfProxyRestExceptionHandlerSpec extends NfProxyRestControllerSpecification {
    ...
    def performTestRequest() {
        return mvc.perform(
                get("$dataNodeBaseEndpoint/cm-handles/$cmHandle/node").param('xpath', xpath)
                        .header("Authorization", getAuthorizationHeader()))
                        .andReturn().response
    }

    static void assertTestResponse(response, expectedStatus,
