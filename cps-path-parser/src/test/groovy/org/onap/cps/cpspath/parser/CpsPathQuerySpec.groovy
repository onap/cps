...
class CpsPathQuerySpec extends Specification {
    ...
    def 'Parse cps path with error: #scenario.'() {
        ...
        where: 'the following data is used'
            ...
            'invalid list element with missing ['                                                 | '/parent-206/child-206/grand-child-206@key="A"]'            | PathParsingException
            'invalid list element with incorrect ]'                                               | '/parent-206/child-206/grand-child-206]@key="A"]'           | PathParsingException
            'invalid list element with incorrect ::'                                              | '/parent-206/child-206/grand-child-206::@key"A"]'           | PathParsingException
