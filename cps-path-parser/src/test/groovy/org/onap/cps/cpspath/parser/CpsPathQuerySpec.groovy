...
class CpsPathQuerySpec extends Specification {
    ...
    def 'Parse cps path to form the Normalized cps path containing #scenario.'() {
        ...
        where: 'the following data is used'
            ...
            'parent & child with more than one operator'                  | '/parent/child[@key1=1 and @key2="abc" or @key="xyz"]/child2' || "/parent/child[@key1='1' and @key2='abc' or @key='xyz']/child2"
    ...
    def 'Parse cps path that ends with a yang list containing #scenario.'() {
        ...
        where: 'the following data is used'
            ...
            'more than one attribute'                 | '//child[@int-leaf=5 and @leaf-name="leaf value"]' || 2                       ||  ['and']
