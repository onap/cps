...
public class CpsPathBuilder extends CpsPathBaseListener {
    ...
    @Override
    public void exitFloatValue(final CpsPathParser.FloatValueContext ctx) {
        throw new IllegalStateException("Comparison of float value " + ctx.getText() + " not supported");
    }
