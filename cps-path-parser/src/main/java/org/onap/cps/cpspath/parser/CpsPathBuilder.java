...
public class CpsPathBuilder extends CpsPathBaseListener {
    ...
    public void exitCpsPathWithSingleLeafCondition(final CpsPathParser.CpsPathWithSingleLeafConditionContext ctx) {
        ...
        cpsPathQuery.setLeafName(leavesData.keySet().iterator().next());
        cpsPathQuery.setLeafValue(leavesData.values().iterator().next());
    }
    ...
    private String stripFirstAndLastCharacter(final String wrappedString) {
