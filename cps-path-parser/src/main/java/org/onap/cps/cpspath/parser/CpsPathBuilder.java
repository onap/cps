 ...
 *  Modifications Copyright (C) TechMahindra Ltd.
 *  ================================================================================
...
public class CpsPathBuilder extends CpsPathBaseListener {
    ...
    public void exitLeafCondition(final LeafConditionContext ctx) {
        ...
        appendOperatorCondition(normalizedXpathBuilder, ctx.leafName().getText(), comparisonValue);
    ...
    private void appendOperatorCondition(final StringBuilder currentNormalizedPathBuilder, final String name,
                                         final Object value) {
        final char lastCharacter = currentNormalizedPathBuilder.charAt(currentNormalizedPathBuilder.length() - 1);
        currentNormalizedPathBuilder.append(lastCharacter == '[' ? "" : " " + queueBooleanOperators.poll() + " ")
                                    .append("@")
                                    .append(name)
                                    .append("='")
                                    .append(value)
