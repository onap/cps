...
public class MicroMeterConfig {
    ...
    private final CmHandleStateMetrics cmHandleStateMetrics = new CmHandleStateMetrics();
    ...
    public Gauge advisedCmHandles(final MeterRegistry meterRegistry) {
        return Gauge.builder(CMHANDLE_STATE_GAUGE, cmHandleStateMetrics,
                        lcmMetric -> cmHandleStateMetrics.getCmHandlesByState().get("advisedCmHandlesCount"))
                .tag(TAG, "ADVISED")
    ...
    public Gauge readyCmHandles(final MeterRegistry meterRegistry) {
        return Gauge.builder(CMHANDLE_STATE_GAUGE, cmHandleStateMetrics,
                        lcmMetric -> cmHandleStateMetrics.getCmHandlesByState().get("readyCmHandlesCount"))
                .tag(TAG, "READY")
    ...
    public Gauge lockedCmHandles(final MeterRegistry meterRegistry) {
        return Gauge.builder(CMHANDLE_STATE_GAUGE, cmHandleStateMetrics,
                        lcmMetric -> cmHandleStateMetrics.getCmHandlesByState().get("lockedCmHandlesCount"))
                .tag(TAG, "LOCKED")
    ...
    public Gauge deletingCmHandles(final MeterRegistry meterRegistry) {
        return Gauge.builder(CMHANDLE_STATE_GAUGE, cmHandleStateMetrics,
                        lcmMetric -> cmHandleStateMetrics.getCmHandlesByState().get("deletingCmHandlesCount"))
                .tag(TAG, "DELETING")
