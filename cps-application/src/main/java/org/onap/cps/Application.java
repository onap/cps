...
import org.onap.cps.startup.HostnameStartupDelayManager;
...
public class Application {
    ...
    static HostnameStartupDelayManager hostnameStartupDelayManager = new HostnameStartupDelayManager();
    ...
    public static void main(final String[] args) {
        hostnameStartupDelayManager.applyHostnameBasedStartupDelay();
