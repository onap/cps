...
/**
 * These test verify the correct use of dependencies in CPS modules.
 */
...
public class CpsArchitectureTest extends ArchitectureTestBase {
    ...
    @ArchTest
    static final ArchRule cpsRestControllerShouldOnlyDependOnService =
            classes().that().resideInAPackage("org.onap.cps.rest..").should().onlyDependOnClassesThat()
                    .resideInAnyPackage(commonAndListedPackages("org.onap.cps.rest..", "org.onap.cps.api..",
    ...
    @ArchTest
    static final ArchRule cpsServiceShouldDependOnServiceAndEventsAndPathParserPackages =
            classes().that().resideInAPackage("org.onap.cps.api.impl..").should().onlyDependOnClassesThat()
                    .resideInAnyPackage(commonAndListedPackages("org.onap.cps.api.impl..", "org.onap.cps.api..",
                            "org.onap.cps.utils..", "org.onap.cps.spi..", "org.onap.cps.events..",
                            "org.onap.cps.impl.utils..", "org.onap.cps.cpspath.parser..", "org.onap.cps.yang.."));
    ...
    @ArchTest
    static final ArchRule referenceImplShouldOnlyHaveDependantsInReferenceImplAndCpsService =
