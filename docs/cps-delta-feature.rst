...
- The concept of CPS Delta Feature is to have the ability to find the delta or difference between two configurations CPS.
...
**Detailed analysis of Delta Feature:** `CPS Delta Feature <https://wiki.onap.org/display/DW/CPS+Delta+Feature>`_
...
**Additional Information:** `Analysis of RFC 9144 and RFC6902 for Delta Report Format <https://wiki.onap.org/display/DW/Analysis+of+RFC+9144+and+RFC6902+for+Delta+Report+generation>`_
