...
The calculated differences can then be used to generate a Delta Report, which can be used in several different ways, one such use case is sending it over the Kafka Notification Service to the user.
...
**Additional Information.** `Analysis of RFC 9144 and RFC 6902 for Delta Report generation <https://wiki.onap.org/display/DW/Analysis+of+RFC+9144+and+RFC6902+for+Delta+Report+generation>`_
