...
**Limitations**
  ...
  - When mixing ``and/or`` operators the order of execution is not guaranteed and therefore the result is unpredicted. Although no error will be reported this mixing of operator is not recommended.
