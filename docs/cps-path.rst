...
**Limitations**
  ...
  - Using comparative operators with string values will lead to an error at runtime. This error can't be validate earlier as the datatype is unknown until the execution phase.
