...
CM-Handles in the *'LOCKED'* state will be retried when the system has availability. CM-Handle in a *'LOCKED'*
state are processed by the retry mechanism, by setting CM-Handle state back to *'ADVISED'*.
