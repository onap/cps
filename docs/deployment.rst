...
+--------------+------------------------------------+----------------------------------------------------------+
| cps-ncmp     | alternateIdToCmHandleIdCacheConfig | Stores the Alternate ID by CM Handle ID.                 |
+--------------+------------------------------------+----------------------------------------------------------+
| cps-ncmp     | cmHandleIdToAlternateIdCacheConfig | Stores the CM Handle ID by Alternate ID.                 |
+--------------+------------------------------------+----------------------------------------------------------+
