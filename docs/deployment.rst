...
+--------------+------------------------------------+----------------------------------------------------------+
| cps-ncmp     | alternateIdToCmHandleIdCacheConfig | Stores the Module Set Tags for cmHandles.                |
+--------------+------------------------------------+----------------------------------------------------------+
| cps-ncmp     | cmHandleIdToAlternateIdCacheConfig | Stores and tracks CmSubscription requests.               |
+--------------+------------------------------------+----------------------------------------------------------+
