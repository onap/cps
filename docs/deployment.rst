...
Any spring supported property can be configured by providing in ``additional.<spring-supported-property-name>: value`` Example: additional.spring.datasource.hikari.maximumPoolSize: 30
