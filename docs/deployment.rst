...
.. note::
   Below-mentioned endpoint  will change the log level at runtime. After executing it effectiveLevel will be working with immediate effect without restarting CPS service.
