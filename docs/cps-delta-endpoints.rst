...
-----------------------------------------------------------
This API performs a POST operation, which allows the user to find the delta between configuration stored under an anchors and a JSON payload provided as part of the request. The API has the following input parameters:
