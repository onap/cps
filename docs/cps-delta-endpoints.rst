...
**Additional Information on 1st API:** `CPS Delta between 2 Anchors API design <https://wiki.onap.org/display/DW/CPS+Delta+between+2+Anchors+API>`_
...
**Additional Information on 2nd API:** `CPS Delta between an anchor and JSON payload API <https://wiki.onap.org/display/DW/CPS+Delta+between+an+anchor+and+JSON+payload+API>`_
