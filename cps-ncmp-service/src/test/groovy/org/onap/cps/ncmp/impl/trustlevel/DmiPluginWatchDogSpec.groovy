...
package org.onap.cps.ncmp.impl.trustlevel
...
class DmiPluginWatchDogSpec extends Specification {
    ...
    def objectUnderTest = new DmiPluginWatchDog(mockDmiRestClient, mockNetworkCmProxyDataService, mockTrustLevelManager, trustLevelPerDmiPlugin)
