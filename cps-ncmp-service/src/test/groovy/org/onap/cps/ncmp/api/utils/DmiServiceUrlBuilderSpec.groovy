...
class DmiServiceUrlBuilderSpec extends Specification {
    ...
    def 'Test dmi api base path with #scenario.'() {
        given: 'uri variables'
        ...
        where: 'the following parameters are used'
            ...
            'With / '    | 'Invalid base path as it starts with /'   | '/dmi'      || 'dmiServiceName//dmi/v1/ch/cmHandle/data/ds/ncmp-datastore:passthrough-running'
            'Without / ' | 'Valid path as it does not starts with /' | 'dmi'       || 'dmiServiceName/dmi/v1/ch/cmHandle/data/ds/ncmp-datastore:passthrough-running'
    }
}
