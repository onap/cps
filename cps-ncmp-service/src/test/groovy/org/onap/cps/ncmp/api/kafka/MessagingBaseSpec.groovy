...
class MessagingBaseSpec extends Specification {
    ...
    @SpringBean
    KafkaTemplate eventKafkaTemplate = new KafkaTemplate<>(new DefaultKafkaProducerFactory<Integer, String>(producerConfigProperties()))

    @SpringBean
    KafkaTemplate cloudEventKafkaTemplate = new KafkaTemplate<>(new DefaultKafkaProducerFactory<Integer, CloudEvent>(cloudEventProducerConfigProperties()))
