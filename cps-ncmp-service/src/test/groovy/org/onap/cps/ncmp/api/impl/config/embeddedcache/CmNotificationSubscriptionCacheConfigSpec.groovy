...
import org.onap.cps.ncmp.api.impl.events.cmsubscription.model.DmiCmNotificationScopeFilter
...
class CmNotificationSubscriptionCacheConfigSpec extends Specification {
    ...
    def 'Provided CM Subscription data'() {
        given: 'a cm subscription properties'
            ...
            def cmSubscriptionPredicate = new DmiCmNotificationSubscriptionPredicate(targetCmHandleIds: ['cmhandle1', 'cmhandle2'], dmiCmNotificationScopeFilter: new DmiCmNotificationScopeFilter(datastoreType: DatastoreType.PASSTHROUGH_RUNNING, xpaths: ['/a/b/c']))
            def cmSubscriptionCacheObject = new DmiCmNotificationSubscriptionDetails(dmiCmNotificationSubscriptionPredicates: [cmSubscriptionPredicate], cmSubscriptionStatus: CmSubscriptionStatus.PENDING)
