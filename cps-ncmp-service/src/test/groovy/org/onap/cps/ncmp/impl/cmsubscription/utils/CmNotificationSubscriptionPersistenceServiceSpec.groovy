...
import static org.onap.cps.ncmp.impl.cmsubscription.utils.CmNotificationSubscriptionPersistenceService.CPS_PATH_QUERY_FOR_CM_SUBSCRIPTION_FILTERS_WITH_DATASTORE_AND_CMHANDLE
import static org.onap.cps.ncmp.impl.cmsubscription.utils.CmNotificationSubscriptionPersistenceService.CPS_PATH_QUERY_FOR_CM_SUBSCRIPTION_WITH_DATASTORE_CMHANDLE_AND_XPATH
import static org.onap.cps.ncmp.impl.cmsubscription.utils.CmNotificationSubscriptionPersistenceService.CPS_PATH_QUERY_FOR_CM_SUBSCRIPTION_WITH_ID

class CmNotificationSubscriptionPersistenceServiceSpec extends Specification {

    def jsonObjectMapper = new JsonObjectMapper(new ObjectMapper())
    def mockCpsQueryService = Mock(CpsQueryService)
    def mockCpsDataService = Mock(CpsDataService)

    def objectUnderTest = new CmNotificationSubscriptionPersistenceService(jsonObjectMapper, mockCpsQueryService, mockCpsDataService)
