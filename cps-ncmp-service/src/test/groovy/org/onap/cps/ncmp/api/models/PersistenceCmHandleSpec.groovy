...
class PersistenceCmHandleSpec extends Specification {
    ...
    def 'Setting and getting additional & public properties.'() {
        given: 'a map of one property is added'
            ...
            objectUnderTest.asDmiProperties([myAdditionalProperty: 'some value'])
            objectUnderTest.asPublicProperties([myPublicProperty: 'some value'])
        when: 'the additional properties are retrieved'
            def additionalProperties = objectUnderTest.getDmiProperties()
        ...
        and: 'the property in the result has the correct name and value'
            ...
            def expectedAdditionalProperty = new PersistenceCmHandle.PropertyConstructor('myAdditionalProperty','some value')
            def expectedPublicProperty = new PersistenceCmHandle.PropertyConstructor('myPublicProperty','some value')
