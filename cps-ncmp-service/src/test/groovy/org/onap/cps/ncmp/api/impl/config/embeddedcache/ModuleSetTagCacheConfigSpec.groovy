...
class ModuleSetTagCacheConfigSpec extends Specification {
    ...
    def 'Embedded (hazelcast) Caches for Module Set Tag.'() {
        ...
        and: 'they have the correct name'
            assert Hazelcast.allHazelcastInstances.name.containsAll('moduleSetTags')
    }

    def 'Verify configs for Distributed object.'(){
    ...
    def 'Verify deployment network configs for Distributed object.'() {
        given: 'the Module Set Tag Map config'
