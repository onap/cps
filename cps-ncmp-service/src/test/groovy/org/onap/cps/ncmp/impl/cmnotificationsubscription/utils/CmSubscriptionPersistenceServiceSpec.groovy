...
class CmSubscriptionPersistenceServiceSpec extends Specification {
    ...
    def 'Check ongoing cm data job subscription details #scenario'() {
        ...
        when: 'we check for an ongoing cm data job subscription'
            def response = objectUnderTest.isOngoingSubscriptionDetails('dataType1', 'altId1')
        then: 'we get expected response'
            assert response == isOngoingSubscriptionDetails
        where: 'following scenarios are used'
            scenario                  | dataNode                                             || isOngoingSubscriptionDetails
    ...
    def 'Add new subscriber to an ongoing subscription details'() {
    ...
    def 'Add new subscriber to new subscription details'() {
    ...
    def 'Remove subscriber from a list of an ongoing subscription details'() {
    ...
    def 'Removing last subscriber for an ongoing subscription details'() {
    ...
    def 'Removing non existing subscriber for an ongoing subscription details'() {
