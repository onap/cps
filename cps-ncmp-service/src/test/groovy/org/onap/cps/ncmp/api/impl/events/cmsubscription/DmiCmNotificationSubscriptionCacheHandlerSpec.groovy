...
class DmiCmNotificationSubscriptionCacheHandlerSpec extends MessagingBaseSpec {
    ...
    IMap<String, Map<String, DmiCmNotificationSubscriptionDetails>> testCache = HazelcastInstanceFactory
            .getOrCreateHazelcastInstance(new Config('hazelcastInstanceName'))
            .getMap('testCache')

    def objectUnderTest = Spy(new DmiCmNotificationSubscriptionCacheHandler(testCache, mockInventoryPersistence))
