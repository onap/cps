...
class SyncUtilsSpec extends Specification{
    ...
    @Shared
    def dataNode = new DataNode(leaves: ['id': 'Some-Cm-Handle'])
    ...
    def 'Get an advised Cm-Handle where ADVISED cm handle #scenario'() {
        ...
        and: 'get yang model cm handles is invoked the correct number of times'
           expectedCallsToGetYangModelCmHandle * mockYangModelCmHandleRetriever.getYangModelCmHandle(dataNode.getLeaves().get("id"))
