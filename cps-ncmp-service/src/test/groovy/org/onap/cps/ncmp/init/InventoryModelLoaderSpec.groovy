...
class InventoryModelLoaderSpec extends Specification {
    ...
    void setup() {
        yangResourceToContentMap = objectUnderTest.createYangResourceToContentMap('dmi-registry@2023-08-23.yang')
    ...
    def 'Onboard subscription model via application ready event.'() {
        ...
        then: 'the module service is used to create the new schema set from the correct resource'
            1 * mockCpsModuleService.createSchemaSet('NCMP-Admin', 'dmi-registry@2023-08-23.yang', yangResourceToContentMap)
        and: 'the admin service is used to update the anchor'
            1 * mockCpsAdminService.updateAnchorSchemaSet('NCMP-Admin', 'ncmp-dmi-registry', 'dmi-registry@2023-08-23.yang')
