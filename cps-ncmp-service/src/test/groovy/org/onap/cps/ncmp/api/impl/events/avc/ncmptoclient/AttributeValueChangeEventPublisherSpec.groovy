...
class AttributeValueChangeEventPublisherSpec extends MessagingBaseSpec {
    ...
    def 'Publish an attribute value change event'() {
        ...
        when: 'the event is being published'
        ...
        then: 'a cloud event should be published to the client on the cm-events topic'
            1 * mockEventsPublisher.publishCloudEvent("cm-events", someEventKey,
                cloudEvent -> {
