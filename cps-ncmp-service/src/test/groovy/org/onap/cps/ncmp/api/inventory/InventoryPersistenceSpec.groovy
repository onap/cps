...
class InventoryPersistenceSpec extends Specification {
    ...
    public static final String DATASPACE_NAME = DmiRegistryConstants.NCMP_DATASPACE_NAME;
    public static final String ANCHOR_NAME = DmiRegistryConstants.NCMP_DATASPACE_NAME;
