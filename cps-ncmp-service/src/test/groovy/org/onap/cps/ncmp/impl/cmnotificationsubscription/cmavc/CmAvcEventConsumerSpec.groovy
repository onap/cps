...
class CmAvcEventConsumerSpec extends MessagingBaseSpec {
    ...
    @SpringBean
    CmAvcEventConsumer avcEventConsumer = new CmAvcEventConsumer(eventsProducer, mockCmAvcEventService, mockInventoryPersistence)
    ...
    def 'Consume and forward valid message'() {
        given: 'consumer has a subscription on a topic'
            ...
            avcEventConsumer.cmEventsTopicName = cmEventsTopicName
        ...
        when: 'the event is consumed and forwarded to target topic'
            avcEventConsumer.consumeAndForward(consumerRecord)
