...
class CmAvcEventConsumerSpec extends MessagingBaseSpec {
    ...
    def 'Consume and process CM Avc event when #scenario'() {
        ...
        and: 'consumer has a subscription on a topic'
            ...
            cmAvcEventConsumer.cmEventsTopicName =  'test-topic-2'
            cloudEventKafkaConsumer.subscribe([cmAvcEventConsumer.cmEventsTopicName])
        ...
        when: 'the event consumer is called for the event'
            cmAvcEventConsumer.consumeAndForward(consumerRecord)
