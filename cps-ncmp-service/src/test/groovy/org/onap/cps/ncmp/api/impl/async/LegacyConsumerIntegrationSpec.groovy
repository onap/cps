...
@SpringBootTest(classes =[NcmpAsyncRequestResponseEventConsumer, RecordFilterStrategies, KafkaConfig])
@DirtiesContext
@Testcontainers
@EnableAutoConfiguration
class LegacyConsumerIntegrationSpec extends MessagingBaseSpec<DmiAsyncRequestResponseEvent> {
