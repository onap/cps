        ...
        when: 'synchronous #method request is made'
            ...
            switch(method) {
                ...
                case 'post':
                    ...
                    break
                case 'put':
                    result = objectUnderTest.synchronousPutOperation(DATA, new ResourceOneOf('test'), urlTemplateParameters)
                    break
                case 'patch':
                    result = objectUnderTest.synchronousPatchOperation(DATA, [new PatchItem()], urlTemplateParameters, 'application/json-patch+json')
                    break
                case 'delete':
