...
abstract class DmiOperationsBaseSpec extends Specification {
    ...
    @Shared
    def dmiSampleProperty = new YangModelCmHandle.Property('prop1', 'val1')
    ...
    def mockYangModelCmHandleRetrieval(dmiProperties) {
        ...
        mockCmHandlePropertiesRetriever.retrieveCmHandleDmiServiceNameAndDmiProperties(cmHandleId) >> yangModelCmHandle
    }
}
