...
class CmSubscriptionConfigSpec extends Specification {
    ...
    def 'Provided CM Subscription data'() {
        given: 'a cm subscription properties'
            ...
            def cmSubscriptionPredicate = new DmiCmSubscriptionPredicate(['cmhandle1', 'cmhandle2'].toSet(), DatastoreType.PASSTHROUGH_RUNNING, ['/a/b/c'].toSet())
            def cmSubscriptionCacheObject = new DmiCmSubscriptionDetails([cmSubscriptionPredicate], CmSubscriptionStatus.PENDING)
