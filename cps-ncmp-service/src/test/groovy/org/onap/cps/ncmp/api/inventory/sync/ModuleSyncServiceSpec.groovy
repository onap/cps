...
class ModuleSyncServiceSpec extends Specification {
    ...
    def 'upgrade model for a existing cm handle with #scenario'() {
        ...
        and: 'yang resource returns some module references'
            def moduleReferences = [new ModuleReference('module1', '1'), new ModuleReference('module2', '2')]
        ...
        when: 'module upgrade is triggered'
            objectUnderTest.syncAndCreateOrUpgradeSchemaSetAndAnchor(yangModelCmHandle)
        then: 'upgrade schema set from module is invoked with correct parameters'
