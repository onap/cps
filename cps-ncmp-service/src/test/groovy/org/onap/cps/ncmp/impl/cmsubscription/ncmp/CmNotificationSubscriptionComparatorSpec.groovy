...
class CmNotificationSubscriptionComparatorSpec extends Specification {

    def mockCmNotificationSubscriptionPersistenceService = Mock(CmNotificationSubscriptionPersistenceService)
    def objectUnderTest = new CmNotificationSubscriptionComparator(mockCmNotificationSubscriptionPersistenceService)
