...
class NetworkCmProxyDataServiceImplModelSyncSpec extends Specification {
    ...
    def dmiUrl = 'http://someUrl/ch/some%20handle/'
    ...
    def yangResourceToContentMap = [someModule: 'someResource']
    ...
    def 'Sync model for a (new) cm handle'() {
        ...
        and: 'CPS-Core returns list of known modules'
            ...
            def moduleNotAlreadyInCps = new ModuleReference('module2','some namespace','1')
        ...
        then: 'the CPS module service is called once with the correct parameters'
            1 * mockCpsModuleService.createSchemaSetFromModules(expectedDataspaceName, cmHandle, yangResourceToContentMap , [knownModule1, moduleNotAlreadyInCps])
    }
}
