...
class NetworkCmProxyDataServiceImplModelSyncSpec extends Specification {
    ...
    def 'Sync model for a (new) cm handle with #scenario'() {
        ...
        where: 'the following parameters are used'
            ...
            'one new module'     | [new ModuleReference('module2', '2'), new ModuleReference('module3', '3')] | [new ModuleReference(moduleName:'module1',revision:'1')] | [module1: 'some yang source'] || [new ModuleReference('module2', '2')]
            ...
            'no new module'      | [new ModuleReference('module1', '1'), new ModuleReference('module2', '2')] | []                                                       | [:]                           || [new ModuleReference('module1', '1'), new ModuleReference('module2', '2')]
    }
}
