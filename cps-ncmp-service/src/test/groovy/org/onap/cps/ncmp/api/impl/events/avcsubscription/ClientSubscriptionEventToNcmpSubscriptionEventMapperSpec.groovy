...
class ClientSubscriptionEventToNcmpSubscriptionEventMapperSpec extends Specification {

    ClientSubscriptionEventToNcmpSubscriptionEventMapper objectUnderTest = Mappers.getMapper(ClientSubscriptionEventToNcmpSubscriptionEventMapper)
