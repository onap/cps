...
import org.onap.cps.ncmp.impl.cmsubscription.service.CmNotificationSubscriptionPersistenceService
...
class DmiCacheHandlerSpec extends MessagingBaseSpec {
    ...
    def testCache = [:]
    def objectUnderTest = new DmiCacheHandler(mockCmNotificationSubscriptionPersistenceService, testCache, mockInventoryPersistence)
