...
class NetworkCmProxyDataServicePropertyHandlerSpec extends Specification {
    ...
    def '#scenario error leads to #exception when we try to update cmHandle'() {
        ...
        where:
            ...
            'Invalid cm handle id'     | 'cmHandleId with spaces' |new DataValidationException('Invalid Data.', "contains an invalid character") || CM_HANDLE_INVALID_ID     | 'cm-handle has an invalid id'
    }
