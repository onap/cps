...
class NcmpInEventConsumerSpec extends MessagingBaseSpec {
    ...
    def mockCmNotificationSubscriptionHandlerService = Mock(CmSubscriptionHandler)
    def objectUnderTest = new NcmpInEventConsumer(mockCmNotificationSubscriptionHandlerService)
