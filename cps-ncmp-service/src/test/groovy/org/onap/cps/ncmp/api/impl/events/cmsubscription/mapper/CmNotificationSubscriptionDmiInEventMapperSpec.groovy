...
class CmNotificationSubscriptionDmiInEventMapperSpec extends Specification {
    ...
    def 'Check for Cm Notification Subscription DMI In Event mapping'() {
        given: 'a collection of cm subscription predicates'
            def dmiCmNotificationSubscriptionPredicates = [new DmiCmNotificationSubscriptionPredicate(['ch-1'],PASSTHROUGH_RUNNING,['/ch-1']),
                                                           new DmiCmNotificationSubscriptionPredicate(['ch-2'],PASSTHROUGH_OPERATIONAL,['/ch-2'])]
