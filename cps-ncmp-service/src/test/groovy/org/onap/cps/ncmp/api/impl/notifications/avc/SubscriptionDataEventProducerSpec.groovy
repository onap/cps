...
import org.onap.cps.ncmp.utils.KafkaProducerConfig
...
@SpringBootTest(classes = [KafkaProducerConfig, ObjectMapper, JsonObjectMapper])
@DirtiesContext
class SubscriptionDataEventProducerSpec extends Specification {
    ...
    def 'produce subscription creation data event for testing'() {
        ...
        and: 'an avc subscription creation event is sent without any exception'
            println(jsonData);
    }
}