...
class DmiModelOperationsSpec extends DmiOperationsBaseSpec {
    ...
    static final expectedModulesUrlTemplateWithVariables = new UrlTemplateParameters(dmiServiceName + '/' + dmiBasePath + '/v1/ch/{cmHandleId}/modules', ['cmHandleId': cmHandleId])
    static final expectedModuleResourcesUrlTemplateWithVariables = new UrlTemplateParameters(dmiServiceName + '/' + dmiBasePath + '/v1/ch/{cmHandleId}/moduleResources', ['cmHandleId': cmHandleId])
