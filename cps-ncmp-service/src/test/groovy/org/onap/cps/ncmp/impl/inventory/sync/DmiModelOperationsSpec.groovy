...
class DmiModelOperationsSpec extends DmiOperationsBaseSpec {
    ...
    static final expectedModulesUrlTemplateWithVariables = new UrlTemplateParameters(dmiServiceName + '/{dmiBasePath}/v1/ch/{cmHandleId}/{resourceName}', ['resourceName': 'modules', 'dmiBasePath': dmiBasePath, 'cmHandleId': cmHandleId])
    static final expectedModuleResourcesUrlTemplateWithVariables = new UrlTemplateParameters(dmiServiceName + '/{dmiBasePath}/v1/ch/{cmHandleId}/{resourceName}', ['resourceName': 'moduleResources', 'dmiBasePath': dmiBasePath, 'cmHandleId': cmHandleId])
