...
class DmiModelOperationsSpec extends DmiOperationsBaseSpec {
    ...
    def 'Retrieving module references.'() {
        ...
        and: 'a positive response from DMI service when it is called with the expected parameters'
            ...
            mockDmiRestClient.synchronousPostOperationWithErrorMapping(MODEL, expectedModulesUrlTemplateWithVariables, '{"cmHandleProperties":{},"moduleSetTag":""}', READ, NO_AUTH_HEADER) >> responseFromDmi
    ...
    def 'Retrieving module references, additional property handling:  #scenario.'() {
        ...
        and: 'a positive response from DMI service when it is called with tha expected parameters'
            ...
            mockDmiRestClient.synchronousPostOperationWithErrorMapping(MODEL, expectedModulesUrlTemplateWithVariables,
    ...
    def 'Retrieving yang resources from DMI with no module references.'() {
        ...
        and: 'no request is sent to DMI'
            0 * mockDmiRestClient.synchronousPostOperationWithErrorMapping(*_)
    }
