...
@SpringBootTest(classes = [TracingExclusionConfig, OpenTelemetryConfig])
class OpenTelemetryConfigSpec extends Specification {
    ...
    @Autowired
    TracingExclusionConfig tracingExclusionConfig

    def setup() {
        objectUnderTest = new OpenTelemetryConfig(tracingExclusionConfig)
