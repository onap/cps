...
@SpringBootTest(classes = [ExcludedTaskNamesConfig, OpenTelemetryConfig])
class OpenTelemetryConfigSpec extends Specification {
    ...
    @Autowired
    ExcludedTaskNamesConfig excludedTaskNamesConfig

    def setup() {
        objectUnderTest = new OpenTelemetryConfig(excludedTaskNamesConfig)
        objectUnderTest.serviceId = 'sample-app'
        objectUnderTest.tracingExporterEndpointUrl = tracingExporterEndpointUrl
        objectUnderTest.jaegerRemoteSamplerUrl = jaegerRemoteSamplerUrl
    }
