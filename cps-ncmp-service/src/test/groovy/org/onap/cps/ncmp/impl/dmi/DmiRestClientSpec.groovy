...
class DmiRestClientSpec extends Specification {
    ...
    def 'DMI DELETE Operation for DMI Data Service '() {
        given: 'the Data web client returns HTTP 200 OK for the delete request'
            ...
            def responseEntity = ResponseEntity.ok(resource)
            ...
            mockResponseSpec.toEntity(Resource.class) >> Mono.just(responseEntity)
