...
class DmiDataOperationsSpec extends DmiOperationsBaseSpec {
    ...
    def 'Execute (async) data operation from DMI service for #scenario.'() {
        ...
        where: 'the following exceptions are occurred'
            ...
            'http client request exception' | new DmiClientRequestException(HttpStatus.NOT_FOUND.value(), 'message', 'details', UNABLE_TO_READ_RESOURCE_DATA)     || UNABLE_TO_READ_RESOURCE_DATA
            'dmi request timeout'           | new DmiClientRequestException(HttpStatus.REQUEST_TIMEOUT.value(), 'message', 'details', DMI_SERVICE_NOT_RESPONDING) || DMI_SERVICE_NOT_RESPONDING
    }
