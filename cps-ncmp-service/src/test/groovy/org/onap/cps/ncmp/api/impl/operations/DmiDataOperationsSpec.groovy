...
class DmiDataOperationsSpec extends DmiOperationsBaseSpec {
    ...
    def 'call get resource data for #expectedDatastoreInUrl from DMI without topic #scenario.'() {
        ...
        and: 'a positive response from DMI service when it is called with the expected parameters'
            ...
            dmiServiceUrlBuilder.getDmiDatastoreUrl(*_) >> expectedUrl
        ...
        where: 'the following parameters are used'
            ...
            'with properties'    | [yangModelCmHandleProperty] | PASSTHROUGH_OPERATIONAL | option  || expectedJsonWithDmiProp                                      | passThroughOperational    | expectedOption
            'null options'       | [yangModelCmHandleProperty] | PASSTHROUGH_OPERATIONAL | null    || expectedJsonWithDmiProp                                      | passThroughOperational    | ''
