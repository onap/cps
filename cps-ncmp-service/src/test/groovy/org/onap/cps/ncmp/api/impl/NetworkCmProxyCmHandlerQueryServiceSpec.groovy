...
class NetworkCmProxyCmHandlerQueryServiceSpec extends Specification {
    ...
    def spyCmHandleQueries = Spy(CmHandleQueriesImpl)
    ...
    def objectUnderTestSpy = new NetworkCmProxyCmHandlerQueryServiceImpl(spyCmHandleQueries, mockInventoryPersistence)
    ...
    def 'Retrieve CMHandleIds when #scenario.' () {
        ...
        and: 'the inventoryPersistence returns different CmHandleIds'
            spyCmHandleQueries.queryCmHandlePublicProperties(*_) >> cmHandlesWithMatchingPublicProperties
            spyCmHandleQueries.queryCmHandleAdditionalProperties(*_) >> cmHandlesWithMatchingPrivateProperties
            spyCmHandleQueries.getCmHandlesByDmiPluginIdentifier(*_) >> dmiNames
        and: 'the underlying service called as many times as expected'
            methodCalls * spyCmHandleQueries.combineCmHandleQueries(_, _)
        when: 'the query executed'
