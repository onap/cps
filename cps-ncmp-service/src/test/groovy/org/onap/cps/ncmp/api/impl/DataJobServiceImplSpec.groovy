...
class DataJobServiceImplSpec extends Specification{
    ...
    def '#operation data job request.'() {
        ...
        and: 'the inventory persistence returns a data node'
            mockInventoryPersistenceService.getCmHandleDataNodeByAlternateId('some/write/path') >> new DataNode(leaves: [id: 'ch-1', 'data-producer-identifier': 'my-data-producer-identifier'])
