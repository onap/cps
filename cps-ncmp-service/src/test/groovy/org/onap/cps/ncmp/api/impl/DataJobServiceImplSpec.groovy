...
class DataJobServiceImplSpec extends Specification{
    ...
    def '#operation data job request.'() {
        ...
        and: 'the inventory persistence returns a data node'
            mockInventoryPersistenceService.getCmHandleDataNodeByLongestMatchAlternateId('some/write/path', '/') >> new DataNode(leaves: [id: 'ch-1', 'dmi-service-name': 'my-dmi-service-name', 'data-producer-identifier': 'my-data-producer-identifier'])
