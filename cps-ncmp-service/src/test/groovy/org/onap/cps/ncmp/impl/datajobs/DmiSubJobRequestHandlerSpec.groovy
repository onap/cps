...
class DmiSubJobRequestHandlerSpec extends Specification {
    ...
    def 'Send a sub-job request to the DMI Plugin.'() {
        ...
        and: 'the dmi rest client will return a response (for the correct parameters)'
            ...
            mockDmiRestClient.synchronousPostOperationWithErrorMapping(RequiredDmiService.DATAJOBS_WRITE, _ as UrlTemplateParameters, expectedJson, OperationType.CREATE, authorization) >> responseEntity
