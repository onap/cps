...
class ParameterHelperSpec extends Specification {
    ...
    def 'Extract action request parameters with fdn with #scenario.'() {
        ...
        where: 'The following URIs are used'
            ...
            '1 segment'         | 'prov-mns-extensions/v1alpha1/actions/segment1/myAction'                            || '/segment1'
            '2 segments'        | 'prov-mns-extensions/v1alpha1/actions/segment1/segment2/myAction'                   || '/segment1/segment2'
            'multiple segments' | 'prov-mns-extensions/v1alpha1/actions/segment1/segment2/segment3/segment4/myAction' || '/segment1/segment2/segment3/segment4'
