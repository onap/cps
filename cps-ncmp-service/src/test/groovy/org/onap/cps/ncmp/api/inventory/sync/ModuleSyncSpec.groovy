...
class ModuleSyncSpec extends Specification {
    ...
    def 'Schedule a Cm-Handle Sync for ADVISED Cm-Handles'() {
        ...
        and: 'the first cm handle is updated'
            1 * mockSyncUtils.updateCmHandleState(yangModelCmHandle1)
        ...
        then: 'the second cm handle is updated'
            1 * mockSyncUtils.updateCmHandleState(yangModelCmHandle2)
    }
    ...
    def 'Schedule a Cm-Handle Sync for ADVISED with failure'() {
        ...
        and: 'lock cm handle with lock reason and details is invoked'
            1 * mockSyncUtils.lockCmHandleState(yangModelCmHandle1, LockReasonEnum.LOCKED_MISBEHAVING, 'some exception')
    }
