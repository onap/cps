...
class ModuleSyncSpec extends Specification {
    ...
    def 'Schedule a Cm-Handle Sync for ADVISED with failure'() {
        ...
        and: 'update cm handle with state LOCKED and with lock reason and details is invoked'
            1 * mockSyncUtils.lockCmHandleState(yangModelCmHandle1, CmHandleState.LOCKED, LockReasonEnum.LOCKED_MISBEHAVING, 'some exception')
    }
