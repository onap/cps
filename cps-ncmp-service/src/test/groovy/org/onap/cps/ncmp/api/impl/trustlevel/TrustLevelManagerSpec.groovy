...
class TrustLevelManagerSpec extends Specification {
    ...
    def 'Handle restart of application'() {
        when: 'the restart handled'
            objectUnderTest.handleRestartCpsNcmpApplication('ch-1', 'COMPLETE')
        then: 'notification is sent'
            1 * mockAttributeValueChangeEventPublisher.publishAttributeValueChangeEvent('ch-1', 'trustLevel', null, 'COMPLETE')
    }
