...
class NetworkCmProxyDataServiceImplSpec extends Specification {
    ...
    def 'process data job #operation  request.'() {
        given: 'list of read/write operations'
            def restProtocolParameters = new OutputParameters(destination: 'client-topic', dataAcceptType: ' application/vnd.3gpp.object-tree-hierarchical+json', dataContentType: 'application/3gpp-json-patch+json')
