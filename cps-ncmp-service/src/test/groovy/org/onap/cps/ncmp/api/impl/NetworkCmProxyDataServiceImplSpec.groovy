...
class NetworkCmProxyDataServiceImplSpec extends Specification {
    ...
    def 'Get resource data for pass-through operational from dmi.'() {
        given: 'data node representing cmHandle and its properties and resource data is got from DMI'
        ...
        when: 'get resource data is called'
            ...
            'testFieldQuery',
            5)
        then: 'cps data service is being called once to get cm-handle details'
