...
class NetworkCmProxyDataServiceImplSpec extends Specification {
    ...
    def 'Write resource data for pass-through running from DMI using an invalid cm handle id.'() {
    ...
    def 'Get resource data for pass-through operational from DMI with invalid cm handle id.'() {\
        when: 'get resource data operational for cm-handle is called'
    ...
    def 'Get resource data for pass-through running from DMI with invalid cm handle id.'() {
        when: 'get resource data operational for cm-handle is called'
    ...
    def 'Getting Yang Resources with an invalid cm handle id.'() {
        when: 'yang resources is called'
    ...
    def 'Get a cm handle with an invalid cm handle id.'() {
