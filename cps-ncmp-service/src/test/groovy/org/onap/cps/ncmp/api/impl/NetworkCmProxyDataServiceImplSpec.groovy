...
class NetworkCmProxyDataServiceImplSpec extends Specification {
    ...
    def 'Get data operation resource data for #datastoreName from DMI.'() {
        given: 'cpsDataService returns valid data node'
            def dataOperationRequest = getDataOperationRequest(datastoreName)
        when: 'request resource data for data operation is called'
            objectUnderTest.requestResourceDataForDataOperationCmHandle('some topic', dataOperationRequest, 'requestId')
