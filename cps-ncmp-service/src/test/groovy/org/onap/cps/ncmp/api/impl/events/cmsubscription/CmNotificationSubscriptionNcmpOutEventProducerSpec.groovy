...
class CmNotificationSubscriptionNcmpOutEventProducerSpec extends Specification {
    ...
    def 'Create and #scenario Cm Notification Subscription NCMP out event'() {
        given: 'a cm subscription response for the client'
            ...
            def scheduledTaskParameters = new CmNotificationSubscriptionNcmpOutEventPublishingTaskParameters(eventPublishingTaskToBeScheduled: eventPublishingTaskToBeScheduled, cancelOngoingEventPublishingTask: cancelOngoingEventPublishingTask)
        ...
        where: 'following scenarios are considered'
            scenario                                            | delayInMs | eventPublishingTaskToBeScheduled | cancelOngoingEventPublishingTask || publishCloudEventInvocations
            'publish event now'                                 | 0         | false                            | false                            || 1
            'publish event now, with no effect of cancellation' | 0         | false                            | true                             || 1
            'schedule event for later'                          | 1500      | true                             | false                            || 1
            'schedule event for later and then cancel it'       | 1500      | true                             | true                             || 0
    }
