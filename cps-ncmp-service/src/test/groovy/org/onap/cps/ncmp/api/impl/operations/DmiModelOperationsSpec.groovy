...
class DmiModelOperationsSpec extends DmiOperationsBaseSpec {
    ...
    static final expectedModulesUriTemplateWithVariables = new UriTemplateParameters(dmiServiceName + '/{dmiBasePath}/v1/ch/{cmHandleId}/{resourceName}', ['resourceName': 'modules', 'dmiBasePath': dmiBasePath, 'cmHandleId': cmHandleId])
    static final def expectedModuleResourcesUriTemplateWithVariables = new UriTemplateParameters(dmiServiceName + '/{dmiBasePath}/v1/ch/{cmHandleId}/{resourceName}', ['resourceName': 'moduleResources', 'dmiBasePath': dmiBasePath, 'cmHandleId': cmHandleId])
    ...
    def 'Retrieving module references.'() {
        ...
        and: 'a positive response from DMI service when it is called with the expected parameters'
            ...
            mockDmiRestClient.synchronousPostOperationWithJsonData(MODEL, expectedModulesUriTemplateWithVariables, '{"cmHandleProperties":{},"moduleSetTag":""}', READ, NO_AUTH_HEADER) >> responseFromDmi
    ...
    def 'Retrieving module references, DMI property handling:  #scenario.'() {
        ...
        and: 'a positive response from DMI service when it is called with tha expected parameters'
            ...
            mockDmiRestClient.synchronousPostOperationWithJsonData(MODEL, expectedModulesUriTemplateWithVariables,
    ...
    def 'Retrieving yang resources.'() {
        ...
        and: 'a positive response from DMI service when it is called with the expected parameters'
            ...
            mockDmiRestClient.synchronousPostOperationWithJsonData(MODEL, expectedModuleResourcesUriTemplateWithVariables,
