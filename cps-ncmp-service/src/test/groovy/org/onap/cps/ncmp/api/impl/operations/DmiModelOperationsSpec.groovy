...
class DmiModelOperationsSpec extends DmiOperationsBaseSpec {
    ...
    def 'Retrieving module references.'() {
        ...
        and: 'a positive response from DMI service when it is called with the expected parameters'
            ...
            mockDmiRestClient.postOperationWithJsonData(expectedUrl, '{"cmHandleProperties":{}}', OperationEnum.READ)
                    >> responseFromDmi
    ...
    def 'Retrieving module references, DMI property handling:  #scenario.'() {
        ...
        and: 'a positive response from DMI service when it is called with tha expected parameters'
            ...
            mockDmiRestClient.postOperationWithJsonData("${dmiServiceName}/dmi/v1/ch/${cmHandleId}/modules",
                    '{"cmHandleProperties":' + expectedAdditionalPropertiesInRequest + '}', OperationEnum.READ) >> responseFromDmi
    ...
    def 'Retrieving yang resources.'() {
        ...
        and: 'a positive response from DMI service when it is called with the expected parameters'
            ...
            mockDmiRestClient.postOperationWithJsonData("${dmiServiceName}/dmi/v1/ch/${cmHandleId}/moduleResources",
                    '{"data":{"modules":[' + expectedModuleReferencesInRequest + ']},"cmHandleProperties":{}}', OperationEnum.READ) >> responseFromDmi
    ...
    def 'Retrieving yang resources, DMI property handling #scenario.'() {
        ...
        and: 'a positive response from DMI service when it is called with the expected parameters'
            ...
            mockDmiRestClient.postOperationWithJsonData("${dmiServiceName}/dmi/v1/ch/${cmHandleId}/moduleResources",
                    '{"data":{"modules":[' + expectedModuleReferencesInRequest + ']},"cmHandleProperties":' + expectedAdditionalPropertiesInRequest + '}', OperationEnum.READ) >> responseFromDmi
        when: 'get new yang resources from DMI service'
