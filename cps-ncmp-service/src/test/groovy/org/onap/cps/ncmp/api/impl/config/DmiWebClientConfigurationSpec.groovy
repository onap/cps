...
@TestPropertySource(properties = ["ncmp.dmi.httpclient.connectionTimeoutInSeconds=1", "ncmp.dmi.httpclient.maximumInMemorySizeInBytes=1"])
class DmiWebClientConfigurationSpec extends Specification {
    ...
    def setup() {
        ...
        objectUnderTest.maximumInMemorySizeInBytes = 1
    }
