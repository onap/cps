...
class CmSubscriptionNcmpInEventConsumerSpec extends MessagingBaseSpec {
    ...
    def mockCmSubscriptionNcmpInEventMapper = Mock(org.onap.cps.ncmp.api.impl.events.cmsubscription.CmSubscriptionNcmpInEventMapper)
    def objectUnderTest = new org.onap.cps.ncmp.api.impl.events.cmsubscription.CmSubscriptionNcmpInEventConsumer(mockCmSubscriptionNcmpInEventMapper)
