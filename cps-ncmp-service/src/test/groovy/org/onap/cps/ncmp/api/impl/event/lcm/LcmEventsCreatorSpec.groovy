...
class LcmEventsCreatorSpec extends Specification {
    ...
    def 'Map the LcmEvent for existing flag value : #existingDataSyncEnableFlag and target value : #targetDataSyncEnableFlag'() {
        given: 'NCMP cm handle details with current and old details'
        ...
        where: 'following parameters are provided'
            existingDataSyncEnableFlag | targetDataSyncEnableFlag
            false                      | true
            false                      | null
            true                       | false
            true                       | null
