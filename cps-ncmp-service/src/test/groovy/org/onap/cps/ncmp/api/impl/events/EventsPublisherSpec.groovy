...
class EventsPublisherSpec extends Specification {
    ...
    def objectUnderTest = new EventsPublisher(mockLegacyKafkaTemplate, mockCloudEventKafkaTemplate)

    def 'Handle publish cloud event when event is successfully published'() {
    ...
    def 'Handle publish cloud event when event failed to publish'() {
    ...
    def 'Handle legacy event callback when successfully publishing an event'() {
    ...
    def 'Handle legacy event callback when event failed to publish'() {
