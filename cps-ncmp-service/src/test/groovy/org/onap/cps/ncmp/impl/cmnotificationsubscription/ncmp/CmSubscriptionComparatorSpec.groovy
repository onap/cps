...
class CmSubscriptionComparatorSpec extends Specification {
    ...
    def 'Find Delta of given list of predicates'() {
        ...
        and: '3 positive responses and 1 negative.'
            mockCmSubscriptionPersistenceService.isOngoingSubscriptionDetails(PASSTHROUGH_OPERATIONAL.getDatastoreName(), 'ch-1') >>> true
            mockCmSubscriptionPersistenceService.isOngoingSubscriptionDetails(PASSTHROUGH_OPERATIONAL.getDatastoreName(), 'ch-2') >>> false
