...
class NetworkCmProxyDataServiceImplRegistrationSpec extends Specification {
    ...
    def 'Remove CmHandle Successfully: #scenario'() {
        ...
        and: 'an event is created that specifies cm handle is DELETED'
            1 * mockLcmEventsService.publishLcmEvent('cmhandle',_)
        where:
    ...
    def 'Remove CmHandle Error Handling: Schema Set Deletion failed'() {
        ...
        and: 'cm-handle is not deleted and no event is sent'
            ...
            0 * mockLcmEventsService.publishLcmEvent('cmhandle',_)
    ...
    def getObjectUnderTest() {
        return Spy(new NetworkCmProxyDataServiceImpl(spiedJsonObjectMapper, mockDmiDataOperations,
            mockNetworkCmProxyDataServicePropertyHandler, mockInventoryPersistence, stubbedNetworkCmProxyCmHandlerQueryService,
                mockLcmEventsCmHandleStateHandler, mockLcmEventsService))
    }
}
