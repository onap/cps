...
class ResourceDataBatchRequestUtilsSpec extends Specification {
    ...
    def 'Process per operation in batch request with #serviceName.'() {
        ...
        where: 'the following dmi service is applied'
            ...
            'dmi1'      | 0              || 'operational-12'    | 'ncmp-datastore:passthrough-running'     | ['ch1', 'ch2']
            'dmi2'      | 0              || 'operational-14'    | 'ncmp-datastore:passthrough-operational' | ['ch3']
            'dmi2'      | 1              || 'operational-15'    | 'ncmp-datastore:passthrough-operational' | ['ch4']
    }
