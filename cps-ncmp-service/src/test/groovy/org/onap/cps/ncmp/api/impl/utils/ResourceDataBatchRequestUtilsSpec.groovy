...
class ResourceDataBatchRequestUtilsSpec extends Specification {
    ...
    def 'Process per operation in batch request with #scenario.'() {
        ...
        then: 'operation details are generated for dmi service as expected'
            ...
            assert dmiBatchRequestBodyAsJsonNode.get('operation').asText() == operationType
        ...
        where: 'the following parameters are used'
            scenario             | operationElement | operationType | operationId | datastore                                || numberOfcmHandles
            'dmi service name 1' | 0                | "read"        | "14"        | "ncmp-datastore:passthrough-running"     || 2
            'dmi service name 2' | 0                | "read"        | "12"        | "ncmp-datastore:passthrough-operational" || 1
            'dmi service name 2' | 1                | "read"        | "15"        | "ncmp-datastore:passthrough-operational" || 1
    }
