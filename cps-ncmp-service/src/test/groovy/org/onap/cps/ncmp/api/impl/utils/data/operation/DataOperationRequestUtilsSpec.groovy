...
class DataOperationRequestUtilsSpec extends Specification {
    ...
    def 'Process per data operation request with #serviceName.'() {
        ...
        when: 'data operation request is processed'
            def operationsOutPerDmiServiceName = DataOperationRequestUtils.processPerOperationInBatchRequest('client-topic','request-id', dataOperationRequest, yangModelCmHandles)
