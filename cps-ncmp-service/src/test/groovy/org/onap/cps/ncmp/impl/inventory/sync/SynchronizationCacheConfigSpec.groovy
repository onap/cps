...
@TestPropertySource(properties = ['hazelcast.instance-config-name=synchronizationCacheConfigSpecInstance'])
class SynchronizationCacheConfigSpec extends Specification {
    ...
    def cleanupSpec() {
        Hazelcast.getHazelcastInstanceByName('synchronizationCacheConfigSpecInstance').shutdown()
    }
