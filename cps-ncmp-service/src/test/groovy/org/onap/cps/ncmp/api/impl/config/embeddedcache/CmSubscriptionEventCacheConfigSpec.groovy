...
class CmSubscriptionEventCacheConfigSpec extends Specification {
    ...
    def 'Provided CM Subscription data'() {
        given: 'a cm subscription properties'
            ...
            def cmSubscriptionPredicate = new CachedCmSubscriptionPredicate(targetFilter: ['cmhandle1', 'cmhandle2'], cachedScopeFilter: new CachedScopeFilter(datastoreType: DatastoreType.PASSTHROUGH_RUNNING, xpathFilters: ['/a/b/c']))
            def cmSubscriptionCacheObject = new CachedCmSubscription(cachedCmSubscriptionPredicates: [cmSubscriptionPredicate] , cmSubscriptionStatus: CmSubscriptionStatus.PENDING)
