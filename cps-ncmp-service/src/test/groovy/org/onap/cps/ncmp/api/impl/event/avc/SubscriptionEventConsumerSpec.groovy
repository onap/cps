...
class SubscriptionEventConsumerSpec extends MessagingBaseSpec {
    ...
    @SpringBean
    CpsValidator cpsValidator = Mock()

    @SpringBean
    CpsAdminService cpsAdminService = Mock()

    @SpringBean
    CpsModuleService cpsModuleService = Mock()

    @SpringBean
    CpsDataService cpsDataService = Mock()

    @SpringBean
    InventoryPersistenceImpl mockInventoryPersistenceImpl = Mock()

    def spiedJsonObjectMapper = Spy(new JsonObjectMapper(new ObjectMapper()))

    def objectUnderTest = new SubscriptionEventConsumer(mockInventoryPersistenceImpl)
