...
public class DmiCmNotificationSubscriptionCacheHandler {
    ...
    /**
     *  Update map of subscription details per DMI.
     *
     ...
     *
     */
    public void updateDmiCmNotificationSubscriptionCacheStatusPerDmi(
        final String subscriptionId ,final String dmiServiceName, final CmNotificationSubscriptionStatus status) {
        cmNotificationSubscriptionCache.get(subscriptionId).get(dmiServiceName).setCmNotificationSubscriptionStatus(status);
    }
     ...
     *
     */
    public void persistCacheIntoDatabasePerDmi(final String subscriptionId, final String dmiServiceName){
