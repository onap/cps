...
public interface NetworkCmProxyDataService {
     ...
     */
    Set<NcmpServiceCmHandle> queryCmHandles(CmHandleQueryApiParameters cmHandleQueryApiParameters);
     ...
     */
    Set<String> queryCmHandleIds(CmHandleQueryApiParameters cmHandleQueryApiParameters);
}
