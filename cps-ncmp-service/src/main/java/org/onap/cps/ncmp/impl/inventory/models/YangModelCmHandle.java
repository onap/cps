...
public class YangModelCmHandle {
     ...
     *
     * @param dmiInfo dmi service name, dmi data service name, dmi model service name
     ...
     * @return instance of yangModelCmHandle
     */
    public static YangModelCmHandle toYangModelCmHandle(final DmiPluginRegistration dmiInfo,
        ...
        yangModelCmHandle.setDmiServiceName(dmiInfo.getDmiPlugin());
        yangModelCmHandle.setDmiDataServiceName(dmiInfo.getDmiDataPlugin());
        yangModelCmHandle.setDmiModelServiceName(dmiInfo.getDmiModelPlugin());
