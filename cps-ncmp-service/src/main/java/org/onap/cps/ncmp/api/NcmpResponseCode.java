...
public enum NcmpResponseCode {
    ...
    UNKNOWN_ERROR("107", "Unknown error"),
    CM_HANDLE_ALREADY_EXIST("108", "cm-handle already exists"),
    CM_HANDLE_INVALID_ID("109", "cm-handle has an invalid character(s) in id");
