...
public class AvcEventConsumer {
    ...
    private final CloudEventsPublisher<CloudEvent> cloudEventsPublisher;
    ...
    public void consumeAndForward(final ConsumerRecord<String, CloudEvent> avcEventConsumerRecord) {
        ...
        final CloudEvent mutatedCloudEvent =
                CloudEventBuilder.from(avcEventConsumerRecord.value()).withId(mutatedEventId).build();
        cloudEventsPublisher.publishEvent(cmEventsTopicName, mutatedEventId, mutatedCloudEvent);
    }
}
