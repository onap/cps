...
public class CmHandleRegistrationResponse {
    ...
    private NcmpResponseCode ncmpResponseCode;
    ...
    public static CmHandleRegistrationResponse createFailureResponse(final String cmHandleId,
        ...
        return CmHandleRegistrationResponse.builder()
            ...
            .ncmpResponseCode(UNKNOWN_ERROR)
     ...
     *
     * @param cmHandleId          cmHandleId
     * @param ncmpResponseCode registration error code and status
     * @return CmHandleRegistrationResponse
     */
    public static CmHandleRegistrationResponse createFailureResponse(final String cmHandleId,
        ...
        return CmHandleRegistrationResponse.builder().cmHandle(cmHandleId)
            .status(Status.FAILURE)
            .ncmpResponseCode(ncmpResponseCode)
            .errorText(ncmpResponseCode.getStatusMessage())
            .build();
    }
     ...
     * @param ncmpResponseCode enum describing the type of registration error
     * @return CmHandleRegistrationResponse
     */
        ...
        for (final String xpath : failedXpaths) {
            ...
            if (matcher.find()) {
                cmHandleRegistrationResponses.add(
                    CmHandleRegistrationResponse.createFailureResponse(matcher.group(1), ncmpResponseCode));
            } else {
