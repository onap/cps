...
public class DataJobController  {
    ...
    /**
     * Handles POST requests to write data job.
     * This endpoint processes a data job write request by extracting necessary metadata and data
    ...
    public ResponseEntity<List<SubJobWriteResponse>> writeDataJob(@RequestHeader(value = "Authorization",
        ...
        final DataJobMetadata dataJobMetadata = dataJobRequest.getDataJobMetadata();
        final DataJobWriteRequest dataJobWriteRequest = dataJobRequest.getDataJobWriteRequest();
        final List<SubJobWriteResponse> response = dataJobService.writeDataJob(authorization, dataJobId,
