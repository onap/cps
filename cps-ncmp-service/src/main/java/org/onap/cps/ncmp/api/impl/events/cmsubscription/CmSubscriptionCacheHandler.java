...
public class CmSubscriptionCacheHandler {
    ...
    Map<String, CmSubscriptionCacheObject> getAllCmSubscriptionCacheObjectByDmiMap(
    ...
    Map<String, List<String>> groupTargetCmHandlesByDmi(final Predicate requestPredicate) {
