...
public class InventoryPersistenceImpl extends NcmpPersistenceImpl implements InventoryPersistence {
    ...
    public Map<String, String> getCmHandleIdPerAlternateId() {
        final Map<String, String> cmHandleIdPerAlternateId = new HashMap<>();
        final Collection<DataNode> dataNodes = getDataNode(NCMP_DMI_REGISTRY_PARENT, DIRECT_CHILDREN_ONLY)
                .iterator().next().getChildDataNodes();
        for (final DataNode dataNode : dataNodes) {
            ...
            if (StringUtils.isNotBlank(alternateId)) {
                ...
                cmHandleIdPerAlternateId.put(cmHandleId, cmHandleId);
            }
        }
        return cmHandleIdPerAlternateId;
    }
