/*
 *  ============LICENSE_START=======================================================
 *  Copyright (C) 2024Nordix Foundation
 *  ================================================================================
...
public interface DataJobService {
     ...
     */
    Response readDataJob(OutputParameters outputParameters,
                         String dataJobId, DataJobRequest dataJobRequest);
     ...
     * @return job current status
     */
    Response writeDataJob(OutputParameters outputParameters,
                          String dataJobId, DataJobRequest dataJobRequest, Map<String, String> metadata);
}