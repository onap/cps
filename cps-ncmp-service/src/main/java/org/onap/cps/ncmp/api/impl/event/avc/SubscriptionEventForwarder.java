...
public class SubscriptionEventForwarder {
    ...
    public void forwardCreateSubscriptionEvent(final SubscriptionEvent subscriptionEvent) {
        ...
        final Map<String, Map<String, Map<String, Serializable>>> dmiNameCmHandleMap =
    ...
    private Map<String, Map<String, Map<String, Serializable>>> organizeByDmiName(
        ...
        yangModelCmHandles.forEach(cmHandle -> {
            ...
            if (!dmiNameCmHandlePropertiesMap.containsKey(dmiName)) {
                final Map<String, Map<String, Serializable>> cmHandleDmiPropertiesMap =
                    new HashMap<String, Map<String, Serializable>>();
                cmHandleDmiPropertiesMap.put(cmHandle.getId(), cmHandle.dmiPropertiesAsMap());
