...
import org.onap.cps.ncmp.api.ProcessReadDataJobs;
...
public class ProcessReadDataJobsImpl implements ProcessReadDataJobs {

    @Override
    public Response readDataJob(final RestProtocolParameters restProtocolParameters,
