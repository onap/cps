...
public class JexParser {
    ...
    private static Optional<String> extractFdnPrefix(final String locationPath) {
        final ArrayList<String> locationPathSegments = splitIntoLocationPathsSegments(locationPath);
    ...
    private static ArrayList<String> splitIntoLocationPathsSegments(final String locationPath) {
