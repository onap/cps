...
public class DmiOperations {
    ...
    static NcmpConfiguration.DmiProperties dmiProperties;

    static final String URL_SEPARATOR = "/";
    static final String DMI_API_PATH = dmiProperties.getDmiApiPath();
    static final String DMI_CM_HANDLE_PATH = dmiProperties.getDmiCmHandlePath();
