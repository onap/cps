...
public class CompositeStateUtils {
    ...
    /**
     * Sets the cmHandleState to ADVISED and updates the timestamp.
     *
     * @return Updated CompositeState
     */
    public static Consumer<CompositeState> setCompositeStateToAdvised() {
    ...
    /**
     * Sets the cmHandleState to LOCKED and updates the timestamp.
     *
     * @return Updated CompositeState
     */
    public static Consumer<CompositeState> setCompositeStateToLocked() {
        return compositeState -> {
    ...
    /**
     * Sets the cmHandleState to READY and operational datastore sync state to UNSYNCHRONIZED.
     *
     * @return Updated CompositeState
     */
    public static Consumer<CompositeState> setCompositeStateToReadyWithInitialDataStoreSyncState() {
        return compositeState -> {
            ...
            final CompositeState.Operational operational =
                    CompositeState.Operational.builder().dataStoreSyncState(DataStoreSyncState.UNSYNCHRONIZED)
     ...
     * @return Updated CompositeState
     */
    public static Consumer<CompositeState> setCompositeStateToAdvisedAndRetainOldLockReasonDetails() {
        return compositeState -> {
            compositeState.setCmHandleState(CmHandleState.ADVISED);
            compositeState.setLastUpdateTimeNow();
