...
public class CpsServicesConfig {
    ...
    @Bean
    public CpsServices cpsServices(final CpsDataspaceService dataspaceService,
                                   final CpsModuleService moduleService,
                                   final CpsAnchorService anchorService,
                                   final CpsDataService dataService) {
        return new CpsServices(dataspaceService, moduleService, anchorService, dataService);
    }
