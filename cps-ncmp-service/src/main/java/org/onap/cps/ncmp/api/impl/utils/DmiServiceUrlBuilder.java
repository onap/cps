...
public class DmiServiceUrlBuilder {
    ...
    public MultiValueMap<String, String> populateQueryParams(final String resourceId,
        ...
        getQueryParamConsumer().accept("resourceIdentifier",
            topicParamInQuery == null ? "" : URLEncoder.encode(resourceId, StandardCharsets.UTF_8),
            queryParams);
        getQueryParamConsumer()
            .accept("options", optionsParamInQuery == null ? "" : URLEncoder.encode(optionsParamInQuery,
            StandardCharsets.UTF_8), queryParams);
