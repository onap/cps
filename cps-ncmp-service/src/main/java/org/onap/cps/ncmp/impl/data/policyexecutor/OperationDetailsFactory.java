...
public class OperationDetailsFactory {
    ...
    public CreateOperationDetails buildCreateOperationDetails(final OperationType operationType,
        ...
        final ResourceObjectDetails resourceObjectDetails = fromJson(resourceAsObject, requestPathParameters);
    ...
    private ResourceObjectDetails fromJson(final Object resourceAsObject,
                                           final RequestPathParameters requestPathParameters) {
        ...
        try {
            ...
            final Map<String, Object> resourceAsMap = objectMapper.readValue(resourceAsJson, typeRef);
            ...
            throw new NcmpException("Cannot convert Resource Object to String",
                    "Invalid Json: " + resourceAsJson);
        }
    }

    private static String extractObjectClass(final Map<String, Object> resourceAsMap,
                                             final RequestPathParameters requestPathParameters) {
        final Object objClass = resourceAsMap.get("objectClass");
