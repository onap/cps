...
public class DmiDataOperations extends DmiOperations {
    ...
    public ResponseEntity<Object> getResourceDataFromDmi(final String cmHandleId,
        ...
        final YangModelCmHandle yangModelCmHandle = gettYangModelCmHandle(cmHandleId);
    ...
    /**
     * This method fetches the all resource data from operational data store for given cm handle
    ...
    private YangModelCmHandle gettYangModelCmHandle(final String cmHandleId) {
