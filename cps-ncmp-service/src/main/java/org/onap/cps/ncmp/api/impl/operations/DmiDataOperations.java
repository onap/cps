...
public class DmiDataOperations extends DmiOperations {
    ...
    public ResponseEntity<Object> getResourceDataFromDmi(final List<String> cmHandleIds,
        ...
        buildBulkResourceDataRequestAndSend(resourceId, optionsParamInQuery, dataStoreName, requestId,
                topicParamInQuery, dmiServiceNameCmHandlePropertiesMap);
    ...
    private void buildBulkResourceDataRequestAndSend(final String resourceId, final String optionsParamInQuery,
