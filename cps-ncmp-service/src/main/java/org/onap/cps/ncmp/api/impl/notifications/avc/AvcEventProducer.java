...
public class AvcEventProducer {
     ...
     */
    public void sendMessage(final AvcEvent avcEvent) {
        log.debug("Forwarding AVC event {} to topic {} ", avcEvent.getEventId(), "clientTopic");
        kafkaTemplate.send("clientTopic", avcEvent.getEventId(), avcEvent);
    }
}
