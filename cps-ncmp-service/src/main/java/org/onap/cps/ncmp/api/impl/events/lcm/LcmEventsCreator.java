...
public class LcmEventsCreator {
    ...
    private LcmEvent buildLcmEvent(final String cmHandleId,
        ...
        if (existingNcmpServiceCmHandle.getAlternateId() == null) {
            if (targetNcmpServiceCmHandle.getAlternateId() == null) {
                alternateId = "";
            } else {
                alternateId = targetNcmpServiceCmHandle.getAlternateId();
                existingNcmpServiceCmHandle.setAlternateId("");
            }
        } else {
            alternateId = existingNcmpServiceCmHandle.getAlternateId();
        }
        payload.setAlternateId(alternateId);
