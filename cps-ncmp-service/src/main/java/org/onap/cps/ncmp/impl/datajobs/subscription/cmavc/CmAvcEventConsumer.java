 ...
 *   <li>Single mode (default): processes one event at a time without transactions (max-poll-records=1).</li>
 *   <li>Batch mode: processes multiple events in a single transaction with exactly-once semantics.</li>
 */
@Component
@Slf4j
...
public class CmAvcEventConsumer {
    ...
    public void consumeAndForward(final ConsumerRecords<String, CloudEvent> cmAvcEventBatch) {
        ...
        cmEventsForwardedCounter.increment(eventsToForward.size());
    }
