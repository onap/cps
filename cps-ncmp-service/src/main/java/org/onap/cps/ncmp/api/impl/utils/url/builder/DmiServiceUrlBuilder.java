...
public class DmiServiceUrlBuilder extends UriComponentsBuilder {
     ...
     * @return this builder instance
     */
    public DmiServiceUrlBuilder variablePathSegment(final String pathSegment, final String value) {
    ...
    public UrlTemplateParameters createUrlTemplateParameters(final String dmiServiceBaseUrl, final String dmiBasePath) {
        ...
        final String urlTemplate = dmiServiceBaseUrl + build().toUriString();
