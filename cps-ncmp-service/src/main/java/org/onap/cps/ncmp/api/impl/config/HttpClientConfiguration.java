...
public class HttpClientConfiguration {
    ...
    private Duration connectTimeoutInSec = Duration.ofSeconds(180);
     ...
     */
    private int maxConnTotal = maxConnPerRoute * 2;

    /**
     * The duration after which idle connections are evicted.
     */
    @DurationUnit(ChronoUnit.SECONDS)
    private Duration evictIdleConnsInSec = Duration.ofSeconds(5);
