...
public class CmNotificationSubscriptionHandlerServiceImpl implements CmNotificationSubscriptionHandlerService {
    ...
    public void processSubscriptionCreateRequest(
        ...
        if (cmNotificationSubscriptionPersistenceService.isUniqueSubscriptionId(subscriptionId)) {
            ...
            handleSubscriptionCreateRequest(subscriptionId);
    ...
    private void handleSubscriptionCreateRequest(final String subscriptionId) {
        ...
        dmiCmNotificationSubscriptionDetailsMap.forEach((dmiPluginName, dmiCmNotificationSubscriptionDetails) -> {
            ...
            if (dmiCmNotificationSubscriptionPredicates.isEmpty()) {
                handleOverlappingCmSubscription(subscriptionId, dmiPluginName);
            } else {
                handleNonOverlappingCmSubscription(subscriptionId, dmiPluginName,
                        dmiCmNotificationSubscriptionPredicates);
            }
        });
    }

    private void handleNonOverlappingCmSubscription(final String subscriptionId, final String dmiPluginName,
            final List<DmiCmNotificationSubscriptionPredicate> dmiCmNotificationSubscriptionPredicates) {
    ...
    private void handleOverlappingCmSubscription(final String subscriptionId, final String dmiPluginName) {
