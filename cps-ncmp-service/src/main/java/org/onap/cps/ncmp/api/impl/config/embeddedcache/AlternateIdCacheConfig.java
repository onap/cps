...
public class AlternateIdCacheConfig extends HazelcastCacheConfig {
    ...
    private static final MapConfig alternateIdToCmHandleIdCacheConfig =
            createMapConfig("alternateIdToCmHandleIdCacheConfig");

    private static final MapConfig cmHandleIdToAlternateIdCacheConfig =
            createMapConfig("cmHandleIdToAlternateIdCacheConfig");
    ...
    public Map<String, String> alternateIdPerCmHandleId() {
        return createHazelcastInstance("hazelcastInstanceAlternateIdPerCmHandleIdMap",
                alternateIdToCmHandleIdCacheConfig).getMap("alternateIdPerCmHandleId");
    }
    ...
    public Map<String, String> cmHandleIdPerAlternateId() {
        return createHazelcastInstance("hazelcastInstanceCmHandleIdPerAlternateIdMap",
                cmHandleIdToAlternateIdCacheConfig).getMap("cmHandleIdPerAlternateId");
    }
}
