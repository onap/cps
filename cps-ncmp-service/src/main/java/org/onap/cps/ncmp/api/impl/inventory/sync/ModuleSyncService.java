...
public class ModuleSyncService {
    ...
    private String getModuleSetTag(final YangModelCmHandle yangModelCmHandle, final boolean inUpgrade) {
        if (inUpgrade) {
            return ModuleOperationsUtils.getLockedCompositeStateDetails(yangModelCmHandle
                    .getCompositeState().getLockReason()).get(ModuleOperationsUtils.MODULE_SET_TAG_KEY);
        }
