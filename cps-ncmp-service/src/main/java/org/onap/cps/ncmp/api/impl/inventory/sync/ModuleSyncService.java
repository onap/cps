...
public class ModuleSyncService {
    ...
    public void syncAndCreateOrUpgradeSchemaSetAndAnchor(final YangModelCmHandle upgradedCmHandle) {
        ...
        final String moduleSetTag = compositeState.getLockReason().getLockReasonCategory()
                ...
                ? compositeState.getLockReason().getDetails() : StringUtils.EMPTY;
        ...
        if (existingCmHandleWithSameModuleSetTag.isPresent()) {
            ...
            updateCmHandleModuleSetTag(upgradedCmHandle, moduleSetTag);
        } else {
    ...
    private void updateCmHandleModuleSetTag(final YangModelCmHandle upgradedCmHandle, final String moduleSetTag) {
