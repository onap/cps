...
public class CmHandleQueries {
    ...
    public Set<NcmpServiceCmHandle> getCmHandlesByDmiPluginIdentifier(final String dmiPluginIdentifier) {
        ...
        for (final ModelledDmiServiceLeafNames dmiProperty : ModelledDmiServiceLeafNames.values()) {
            dataNodes.addAll(getCmHandlesByDmiPluginIdentifierAndDmiProperty(
                    dmiPluginIdentifier,
                    dmiProperty.getLeafName()));
        }
        dataNodes.forEach(dataNode -> ncmpServiceCmHandles.add(createNcmpServiceCmHandle(dataNode)));
