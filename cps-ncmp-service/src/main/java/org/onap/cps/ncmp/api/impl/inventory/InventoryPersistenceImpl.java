...
public class InventoryPersistenceImpl extends NcmpPersistenceImpl implements InventoryPersistence {
    ...
    @Override
    public DataNode findLongestMatch(final String alternateId, final String separator) {
        ...
        while (true) {
            ...
            if (dataNodes.isEmpty()) {
                ...
                if (lastSeparatorIndex < 0) {
                    ...
                    bestMatch = bestMatch.substring(0, lastSeparatorIndex);
                }
            } else {
                return dataNodes.iterator().next();
            }
        }
        throw new AlternateIdNotFoundException(NCMP_DATASPACE_NAME, NCMP_DMI_REGISTRY_ANCHOR, alternateId);
    }
