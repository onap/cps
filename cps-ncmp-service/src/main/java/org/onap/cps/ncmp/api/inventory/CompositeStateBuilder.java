...
public class CompositeStateBuilder {
     ...
     */
    public CompositeStateBuilder withLockReason(final String reason) {
        this.lockReason = LockReason.builder().reason(reason).build();
        return this;
    }
     ...
     * @return CompositeStateBuilder
     */
    public CompositeStateBuilder withLockDetails(final String details) {
        this.lockReason = LockReason.builder().details(details).build();
        return this;
    }
    ...
    /**
     * To use existing CompositeState for creating {@link CompositeState}.
     *
     * @param compositeState existing composite state
     * @return CompositeStateBuilder
     */
    public CompositeStateBuilder fromExistingCompositeState(final CompositeState compositeState) {
        cmHandleState = compositeState.getCmhandleState();
        lockReason = compositeState.getLockReason();
        datastores = compositeState.getDataStores();
        return this;
    }
