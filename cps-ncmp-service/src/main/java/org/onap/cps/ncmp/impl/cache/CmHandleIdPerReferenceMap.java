...
public class CmHandleIdPerReferenceMap {
    ...
    /**
     * Check if the given reference key exists.
     *
     * @param cmHandleReference the reference to check
     * @return true if present
     */
    public boolean exists(final String cmHandleReference) {
     ...
     */
    public Collection<String> getReferenceByLike(final String searchTerm) {
    ...
    /**
     * Get a set of references from the map that already have an entry.
     *
     * @param cmHandleReferences a list of cm handle references
     * @return a set of references that already exist in the cache
     */
    public Set<String> getReferencesAlreadyInMap(final Set<String> cmHandleReferences) {
        return cmHandleIdPerReference.getAll(cmHandleReferences).keySet();
    }
}
