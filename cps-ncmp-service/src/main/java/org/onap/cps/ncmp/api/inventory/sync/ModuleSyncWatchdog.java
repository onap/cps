...
public class ModuleSyncWatchdog {
    ...
    private static final int ASYNC_TASK_TIME_OUT_IN_MILLISECONDS = (int) TimeUnit.MINUTES.toMillis(120000);
    ...
    public void executeAdvisedCmHandlePoll() {
        ...
        while (!unProcessedYangModelCmHandles.isEmpty()) {
            ...
            asyncTaskExecutor.executeTask(() ->
                    performModuleStateTransition(yangModelCmHandles), ASYNC_TASK_TIME_OUT_IN_MILLISECONDS
            );
    ...
    private String performModuleStateTransition(final List<YangModelCmHandle> yangModelCmHandles) {
        ...
        return "Module sync watchdog batch of size " + yangModelCmHandles.size() + " is finished.";
    }
    ...
    public void executeLockedCmHandlePoll() {
        ...
        asyncTaskExecutor.executeTask(() ->
                resynchronizeLockedCmHandles(lockedCmHandles), ASYNC_TASK_TIME_OUT_IN_MILLISECONDS
        );
    }
    ...
    private List<YangModelCmHandle> getUnProcessedCmHandles() {
        ...
        markAsBeingPickedByWatchdog().accept(yangModelCmHandles);
