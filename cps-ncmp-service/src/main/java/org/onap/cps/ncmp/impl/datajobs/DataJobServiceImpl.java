...
public class DataJobServiceImpl implements DataJobService {
    ...
    private static SubJobWriteRequest createSubJobWriteRequest(final String dataJobId,
                                                               final DataJobMetadata dataJobMetadata) {
        final SubJobWriteRequest subJobWriteRequest = new SubJobWriteRequest();
    ...
    private Dmi3ggpWriteOperation createWriteOperation(final WriteOperation writeOperation, final DataNode dataNode) {
        final Dmi3ggpWriteOperation dmiWriteOperation = new Dmi3ggpWriteOperation();
        dmiWriteOperation.setOp(writeOperation.op());
        dmiWriteOperation.setOperationId(writeOperation.operationId());
