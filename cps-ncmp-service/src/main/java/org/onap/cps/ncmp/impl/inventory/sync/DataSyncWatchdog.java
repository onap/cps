...
public class DataSyncWatchdog {
    ...
    public void executeUnSynchronizedReadyCmHandleForInitialDataSync() {
        ...
        if (unsynchronizedReadyCmHandles.isEmpty()) {
    ...
    private void performDataSyncForCmHandle(final String cmHandleId) {
        ...
        final Collection<String> moduleAndRootNodes = moduleOperationsUtils.getModuleAndRootNodes(cmHandleId);

        for (final String moduleAndRootNode : moduleAndRootNodes) {
            syncModuleAndRootNode(cmHandleId, moduleAndRootNode);
        }
    ...
    private void syncModuleAndRootNode(final String cmHandleId, final String moduleAndRootNode) {
        final String options = String.format("(fields=%s)", moduleAndRootNode);
