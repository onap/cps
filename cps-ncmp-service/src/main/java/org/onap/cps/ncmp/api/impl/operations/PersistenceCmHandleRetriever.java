...
public class PersistenceCmHandleRetriever {
    ...
    public PersistenceCmHandle retrieveCmHandleDmiServiceNameAndProperties(final String cmHandleId) {
        ...
        CmHandle cmHandle = new CmHandle(cmHandleId, getCmHandleProperties(cmHandleDataNode));
    ...
    private static Map<String, String> getCmHandleProperties(DataNode cmHandleDataNode) {
