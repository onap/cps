...
public class CmNotificationSubscriptionNcmpOutEventMapper {
    ...
    public CmNotificationSubscriptionNcmpOutEvent toCmNotificationSubscriptionNcmpOutEvent(final String subscriptionId,
        ...
        populateCmSubscriptionDataWithCmHandleIds(dmiCmNotificationSubscriptionDetailsMap, cmSubscriptionData);
        cmNotificationSubscriptionNcmpOutEvent.setData(cmSubscriptionData);

        return cmNotificationSubscriptionNcmpOutEvent;
    }

    private void populateCmSubscriptionDataWithCmHandleIds(
            final Map<String, DmiCmNotificationSubscriptionDetails> dmiCmNotificationSubscriptionDetailsMap,
        ...
        dmiCmNotificationSubscriptionDetailsMap.forEach((dmiPluginName, dmiCmNotificationSubscriptionDetails) -> {
            ...
            if (CmNotificationSubscriptionStatus.ACCEPTED == cmNotificationSubscriptionStatus) {
                acceptedCmHandleIds.addAll(extractCmHandleIds(dmiCmNotificationSubscriptionPredicates));
            } else if (CmNotificationSubscriptionStatus.PENDING == cmNotificationSubscriptionStatus) {
                pendingCmHandleIds.addAll(extractCmHandleIds(dmiCmNotificationSubscriptionPredicates));
            } else {
                rejectedCmHandleIds.addAll(extractCmHandleIds(dmiCmNotificationSubscriptionPredicates));
            }
        });
