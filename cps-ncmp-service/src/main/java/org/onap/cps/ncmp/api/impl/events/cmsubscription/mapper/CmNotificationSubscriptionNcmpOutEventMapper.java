...
public class CmNotificationSubscriptionNcmpOutEventMapper {
    ...
    /**
     * Mapper to form a rejected response for the client for the Cm Notification Subscription Create Request.
     *
     ...
     */
    public CmNotificationSubscriptionNcmpOutEvent toCmNotificationSubscriptionNcmpOutEventForRejectedCreateRequest(
