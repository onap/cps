...
public class DmiCacheHandler {
    ...
    public void updateDmiSubscriptionStatusPerDmi(final String subscriptionId, final String dmiServiceName,
        ...
        final Map<String, DmiCmSubscriptionDetails> dmiSubscriptionDetailsPerDmi =
                cmNotificationSubscriptionCache.get(subscriptionId);
        dmiSubscriptionDetailsPerDmi.get(dmiServiceName).setCmSubscriptionStatus(status);
        cmNotificationSubscriptionCache.put(subscriptionId, dmiSubscriptionDetailsPerDmi);
    }
    ...
    private void updateDmiSubscriptionDetailsPerDmi(
            ...
            final DmiCmSubscriptionPredicate dmiCmSubscriptionPredicate,
            final Map<String, DmiCmSubscriptionDetails> dmiSubscriptionDetailsPerDmi) {
        if (dmiSubscriptionDetailsPerDmi.containsKey(dmiServiceName)) {
            dmiSubscriptionDetailsPerDmi.get(dmiServiceName)
                    .getDmiCmSubscriptionPredicates().add(dmiCmSubscriptionPredicate);
        } else {
            dmiSubscriptionDetailsPerDmi.put(dmiServiceName,
