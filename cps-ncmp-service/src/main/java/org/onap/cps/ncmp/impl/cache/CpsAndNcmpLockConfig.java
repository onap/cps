...
public class CpsAndNcmpLockConfig extends HazelcastCacheConfig {
    ...
    private static final MapConfig CPS_AND_NCMP_LOCK_CONFIG = createMapConfig("cpsAndNcmpLockConfig");
    ...
    public IMap<String, String> cpsAndNcmpLock() {
        return getOrCreateHazelcastInstance(CPS_AND_NCMP_LOCK_CONFIG).getMap("cpsAndNcmpLock");
    }
