...
public class NcmpAsyncDataOperationEventConsumer {
    ...
    private final EventsPublisher<DataOperationEventV1_0_0> eventsPublisher;
    ...
    @KafkaListener(
            ...
            properties = {"spring.json.value.default.type=org.onap.cps.ncmp.events.async.DataOperationEventV1_0_0"})
    public void consumeAndPublish(final ConsumerRecord<String, DataOperationEventV1_0_0>
