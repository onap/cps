...
public class NcmpAsyncDataOperationEventConsumer {
    ...
    private final EventsPublisher<DataOperationEventV1> eventsPublisher;
    ...
    @KafkaListener(
            ...
            filter = "filterDataOperationEvents",
            groupId = "ncmp-data-operation-event-group",
            properties = {"spring.json.value.default.type=org.onap.cps.ncmp.events.async.DataOperationEventV1"})
    public void consumeAndPublish(final ConsumerRecord<String, DataOperationEventV1>
