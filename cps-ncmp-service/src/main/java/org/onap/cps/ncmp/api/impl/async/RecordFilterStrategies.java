...
public class RecordFilterStrategies {
    ...
    /**
     *  Includes the consumer records based on the cloud event type header, It
    ...
    public RecordFilterStrategy<String, CloudEvent> includeDataOperationEventsOnly() {
        return consumedRecord ->
                isNotCloudEventOfType(consumedRecord.headers(), "DataOperationEvent");
    }
    ...
    public RecordFilterStrategy<String, DmiAsyncRequestResponseEvent> includeDmiAsyncRequestResponseEventsOnly() {
        return consumerRecord ->
                isCloudEvent(consumerRecord.headers());
    }
    ...
    private boolean isNotCloudEventOfType(final Headers recordHeaders, final String requiredEventType) {
