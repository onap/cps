...
public class EventsPublisherConfig<T> {
    ...
    @Bean
    @Primary
    public ProducerFactory<String, T> eventsProducerFactory() {
    ...
    @Bean
    @Primary
    public ConsumerFactory<String, T> eventsConsumerFactory() {
        final Map<String, Object> configProps = new HashMap<>();
    ...
    public KafkaTemplate<String, T> kafkaTemplate() {
        final KafkaTemplate<String, T> kafkaTemplate = new KafkaTemplate<>(eventsProducerFactory());
        kafkaTemplate.setConsumerFactory(eventsConsumerFactory());
        return kafkaTemplate;
    }
}
