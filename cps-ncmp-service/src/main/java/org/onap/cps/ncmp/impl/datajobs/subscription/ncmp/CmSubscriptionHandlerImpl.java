...
public class CmSubscriptionHandlerImpl implements CmSubscriptionHandler {
    ...
    @Override
    public void updateSubscriptionStatus(final String subscriptionId,
                                         final String dmiServiceName, final CmSubscriptionStatus status) {
        ...
        for (final String dataNodeSelector : dataNodeSelectors) {
            ...
            if (cmHandleId == null) {
                ...
                if (resolvedDmiServiceName.equals(dmiServiceName)) {
                    cmDataJobSubscriptionPersistenceService.updateStatus(dataNodeSelector, status);
                }
            }
        }
    }
