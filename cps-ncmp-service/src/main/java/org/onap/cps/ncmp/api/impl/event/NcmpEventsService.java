...
public class NcmpEventsService {
    ...
    private final NcmpEventsGenerator ncmpEventsGenerator;
    ...
    public void publishNcmpEvent(final String cmHandleId, final Operation operation) {
        ...
        final NcmpEvent ncmpEvent = ncmpEventsGenerator.populateNcmpEvent(cmHandleId, operation, ncmpServiceCmHandle);
