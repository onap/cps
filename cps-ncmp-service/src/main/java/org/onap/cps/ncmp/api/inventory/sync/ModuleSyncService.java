...
public class ModuleSyncService {
    ...
    public void deleteSchemaSetIfExists(final YangModelCmHandle yangModelCmHandle) {
        ...
        try {
            ...
            log.info("No SchemaSet for {}. Assuming CmHandle has not been previously Module Synced.",
                schemaSetAndAnchorName);
            return;
        }
        log.info("SchemaSet for {} has been deleted. Ready to be recreated.", schemaSetAndAnchorName);
    }
