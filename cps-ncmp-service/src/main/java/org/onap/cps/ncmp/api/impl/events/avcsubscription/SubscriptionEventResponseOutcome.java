...
public class SubscriptionEventResponseOutcome {
     ...
     */
    public void generateAndSendResponse(final String subscriptionClientId, final String subscriptionName,
        ...
        final SubscriptionEventOutcome subscriptionEventOutcome =
                formSubscriptionOutcomeMessage(cmHandleIdToStatus, subscriptionClientId, subscriptionName,
                        isFullOutcomeResponse);
        final Headers headers = new RecordHeaders();
        outcomeEventsPublisher.publishEvent(subscriptionOutcomeEventTopic,
                subscriptionClientId + subscriptionName, headers,
