...
public class InventoryPersistenceImpl implements InventoryPersistence {
    ...
    public static String createCmHandleXPath(final String cmHandleId) {
        return "/dmi-registry/cm-handles[@id='" + cmHandleId + "']";
    }

    public static String createStateJsonData(final String state) {
        return "{\"state\":" + state + "}";
    }

    public static String createCmHandleJsonData(final String cmHandleId) {
