...
public class InventoryPersistenceImpl implements InventoryPersistence {
    ...
    @Override
    public Collection<String> queryAnchors(final Collection<String> moduleNamesForQuery) {
        return cpsAdminService.queryAnchorNames(NFP_OPERATIONAL_DATASTORE_DATASPACE_NAME, moduleNamesForQuery);
    }

    @Override
    public Collection<Anchor> getAnchors() {
        return cpsAdminService.getAnchors(NFP_OPERATIONAL_DATASTORE_DATASPACE_NAME);
    }
