 ...
 * Only http and https schemes are allowed, and known internal/metadata IP ranges are blocked.
 * An optional regex pattern can be configured to restrict allowed URLs further.
 */
@Component
