...
public class DmiPluginWatchDog implements ApplicationListener<ApplicationReadyEvent> {
     ...
     * CPS application has fully started and is ready. Upon receiving this applicationReadyEvent, the
     * method initialises the DMI keys for this cache from database since the cache
     * should not depend on initial registration.
     *
    ...
    public void onApplicationEvent(final ApplicationReadyEvent applicationReadyEvent) {
        final Collection<YangModelCmHandle> allYangModelCmHandles =
            inventoryPersistence.getYangModelCmHandles(getAllCmHandleIds());
