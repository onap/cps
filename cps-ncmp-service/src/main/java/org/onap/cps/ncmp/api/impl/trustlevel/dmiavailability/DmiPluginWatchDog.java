...
public class DmiPluginWatchDog {
    ...
    public void checkDmiAvailability() {
        trustLevelPerDmiPlugin.entrySet().forEach(dmiTrustLevelMapEntry -> {
            final TrustLevel newDmiTrustLevel;
            final TrustLevel oldDmiTrustLevel = dmiTrustLevelMapEntry.getValue();
            final String dmiServiceName = dmiTrustLevelMapEntry.getKey();
            ...
            if (oldDmiTrustLevel.equals(newDmiTrustLevel)) {
                ...
                dmiTrustLevelMapEntry.setValue(newDmiTrustLevel);
