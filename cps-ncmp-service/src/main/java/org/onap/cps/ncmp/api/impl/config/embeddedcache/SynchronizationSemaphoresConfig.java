...
public class SynchronizationSemaphoresConfig {
    ...
    private static final String DATA_SYNC_SEMAPHORE = "dataSyncSemaphore";
    ...
    public Map<String, String> dataSyncSemaphore() {
        return Hazelcast.newHazelcastInstance(
                initializeDefaultMapConfig(DATA_SYNC_SEMAPHORE, "dataSyncSemaphoreConfig"))
                .getMap(DATA_SYNC_SEMAPHORE);
    }
