...
public class SynchronizationSemaphoresConfig {
    ...
    public Map<String, String> moduleSyncSemaphore() {
        return Hazelcast.newHazelcastInstance(initializeDefaultMapConfig("moduleSyncSemaphore"))
                .getMap("moduleSyncSemaphore");
    }

    @Bean
    public Map<String, String> dataSyncSemaphore() {
        return Hazelcast.newHazelcastInstance(initializeDefaultMapConfig("dataSyncSemaphore"))
                .getMap("dataSyncSemaphore");
    }

    private Config initializeDefaultMapConfig(final String configName) {
