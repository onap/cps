...
public class SynchronizationSemaphoresConfig {
    ...
    public ConcurrentMap<String, Boolean> moduleSyncSemaphore() {
        return getOrCreateHazelcastInstance("moduleSyncSemaphore", "moduleSyncSemaphoreConfig")
    ...
    public Map<String, String> dataSyncSemaphore() {
        return getOrCreateHazelcastInstance("dataSyncSemaphore", "dataSyncSemaphoreConfig")
                .getMap("dataSyncSemaphore");
    }

    private HazelcastInstance getOrCreateHazelcastInstance(
            final String moduleSyncSemaphore, final String moduleSyncSemaphoreConfig) {
