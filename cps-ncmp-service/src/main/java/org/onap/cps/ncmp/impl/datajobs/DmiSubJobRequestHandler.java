...
public class DmiSubJobRequestHandler {
    ...
    public List<SubJobWriteResponse> sendRequestsToDmi(final String dataJobId, final DataJobMetadata dataJobMetadata,
        ...
        dmiWriteOperationsPerProducerKey.forEach((producerKey, dmi3ggpWriteOperations) -> {
            ...
            final UriTemplateParameters uriTemplateParameters = getDmiResourceUrl(dataJobId, producerKey);
    ...
    private UriTemplateParameters getDmiResourceUrl(final String dataJobId, final ProducerKey producerKey) {
        return DmiServiceUrlBuilder.newInstance()
                .fixedPathSegment("writeJob")
                .variablePathSegment("requestId", dataJobId)
                .createUriTemplateWithVariables(producerKey.dmiServiceName(), dmiProperties.getDmiBasePath());
    }
}
