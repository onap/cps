...
public class DmiSubJobRequestHandler {
     ...
     * @param dmi3ggpWriteOperationsPerProducerKey a collection of write requests per producer key.
     */
    public void sendRequestsToDmi(final String dataJobId, final DataJobMetadata dataJobMetadata, final Map<ProducerKey,
                                                    List<DmiWriteOperation>> dmi3ggpWriteOperationsPerProducerKey) {
    ...
    private SubJobWriteRequest createSubJobWriteRequest(final String dataJobId,
        ...
        return new SubJobWriteRequest(dataJobMetadata.dataAcceptType(),
                dataJobMetadata.dataContentType(), dataJobId, dmiWriteOperations);
    }
