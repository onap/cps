...
public class NetworkCmProxyCmHandleQueryServiceImpl implements NetworkCmProxyCmHandleQueryService {
    ...
    private Collection<String> executeCpsPathQuery(
        ...
        try {
            cpsPathQueryResult = CmHandleQueriesImpl.collectCmHandleIdsFromDataNodes(
    ...
    private Set<NcmpServiceCmHandle> getNcmpServiceCmHandles(final Collection<String> cmHandleIds) {
        final Collection<YangModelCmHandle> yangModelcmHandles
            = inventoryPersistence.getYangModelCmHandles(cmHandleIds);

        final Set<NcmpServiceCmHandle> ncmpServiceCmHandles = new HashSet<>(yangModelcmHandles.size());
