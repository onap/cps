...
public class LcmEventsCreator {
    ...
    private Event lcmEventPayload(final String eventCorrelationId, final NcmpServiceCmHandle targetNcmpServiceCmHandle,
        ...
        final CmHandleValueDifferencePair cmHandleValueDifferencePair =
                LcmEventsCreatorHelper.determineEventValues(targetNcmpServiceCmHandle, existingNcmpServiceCmHandle,
                        lcmEventType);
        event.setOldValues(cmHandleValueDifferencePair.getOldValues());
        event.setNewValues(cmHandleValueDifferencePair.getNewValues());
    ...
    @Getter
    @Setter
    static class CmHandleValueDifferencePair {
