...
public class CmSubscriptionHandlerImpl implements CmSubscriptionHandler {
    ...
    private DmiCmSubscriptionTuple getLastRemainingAndOverlappingSubscriptionsPerDmi(
        ...
        for (final DataNode subscriptionNode : subscriptionNodes) {
            ...
            final DatastoreType datastoreType = extractCmSubscriptionDatastore(xpath);
            final String cmHandleId = extractCmSubscriptionCmHandleId(xpath);
            ...
            final DmiCmSubscriptionKey dmiCmSubscriptionKey =
                    new DmiCmSubscriptionKey(datastoreType.getDatastoreName(), cmHandleId,
                            extractCmSubscriptionFilterXpath(xpath));
    ...
    private DatastoreType extractCmSubscriptionDatastore(final String xpath) {
    ...
    private String extractCmSubscriptionFilterXpath(final String xpath) {
    ...
    private String extractCmSubscriptionCmHandleId(final String xpath) {
