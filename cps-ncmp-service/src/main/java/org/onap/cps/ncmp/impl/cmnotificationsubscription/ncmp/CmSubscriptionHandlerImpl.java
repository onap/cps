...
public class CmSubscriptionHandlerImpl implements CmSubscriptionHandler {
    ...
    public void processSubscriptionDeleteRequest(final String subscriptionId) {
        ...
        final Map<String, DmiCmSubscriptionDetails> dmiCmSubscriptionDetailsMap =
                dmiCmSubscriptionDetailsPerDmiMapper.toDmiCmNotificationSubscriptionDetailsPerDmi(
                        lastAndOtherSubscriptionTuple.lastSubscriberPerDmi());
        final Map<String, DmiCmSubscriptionDetails> dmiCmSubscriptionDetailsMap2 =
                dmiCmSubscriptionDetailsPerDmiMapper.toDmiCmNotificationSubscriptionDetailsPerDmi(
                        lastAndOtherSubscriptionTuple.otherSubscribersPerDmi());
        dmiCacheHandler.add(subscriptionId,
                mergeDmiCmSubscriptionDetailsPerDmiMaps(dmiCmSubscriptionDetailsMap,
                        dmiCmSubscriptionDetailsMap2));
        sendSubscriptionDeleteRequestToDmi(subscriptionId, dmiCmSubscriptionDetailsMap);
    ...
    private Map<String, DmiCmSubscriptionDetails> mergeDmiCmSubscriptionDetailsPerDmiMaps(
        ...
        for (final Map.Entry<String, DmiCmSubscriptionDetails> dmiCmSubscriptionDetailsEntry :
                dmiCmSubscriptionDetailsMap2.entrySet()) {
            final String dmiServiceName = dmiCmSubscriptionDetailsEntry.getKey();
            final DmiCmSubscriptionDetails dmiCmSubscriptionDetails =
                    dmiCmSubscriptionDetailsEntry.getValue();
            ...
            if (mergedDmiCmSubscriptionDetailsMap.containsKey(dmiServiceName)) {
                ...
                final DmiCmSubscriptionDetails mergedDmiSubscriptionDetails =
                        mergeDmiCmSubscriptionDetails(dmiCmSubscriptionDetails1, dmiCmSubscriptionDetails);
                mergedDmiCmSubscriptionDetailsMap.put(dmiServiceName, mergedDmiSubscriptionDetails);
            } else {
                mergedDmiCmSubscriptionDetailsMap.put(dmiServiceName, dmiCmSubscriptionDetails);
            }
        }
