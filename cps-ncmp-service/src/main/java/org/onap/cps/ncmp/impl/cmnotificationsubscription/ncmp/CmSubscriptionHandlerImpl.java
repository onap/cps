...
public class CmSubscriptionHandlerImpl implements CmSubscriptionHandler {
    ...
    private static final String DATASTORE_FROM_XPATH_PATTERN = "/datastore\\[@name='(.*?)'\\]";
    private static final String CMHANDLE_ID_FROM_XPATH_PATTERN = "/cm-handle\\[@id='(.*?)'\\]";
    ...
    private void sendSubscriptionDeleteRequestToDmi(final String subscriptionId,
        ...
        dmiCmSubscriptionsPerDmi.forEach((dmiPluginName, dmiCmNotificationSubscriptionDetails) -> {
    ...
    private DatastoreType extractCmSubscriptionDatastoreFromXpath(final String xpath) {
        final Pattern pattern = Pattern.compile(DATASTORE_FROM_XPATH_PATTERN);
    ...
    private String extractCmSubscriptionCmHandleIdFromXpath(final String xpath) {
        final Pattern pattern = Pattern.compile(CMHANDLE_ID_FROM_XPATH_PATTERN);
        final Matcher matcher = pattern.matcher(xpath);
        if (matcher.find()) {
