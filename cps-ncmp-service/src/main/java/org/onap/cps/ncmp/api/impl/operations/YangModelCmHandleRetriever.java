...
public class YangModelCmHandleRetriever {
     ...
     */
    public YangModelCmHandle retrieveCmHandleDmiServiceNameAndDmiProperties(final String cmHandleId) {
     ...
     */
    public YangModelCmHandle retrieveCmHandleDetails(final String cmHandleId) {
        final DataNode cmHandleDataNode = getCmHandleDataNode(cmHandleId);
        final NcmpServiceCmHandle ncmpServiceCmHandle = new NcmpServiceCmHandle();
        ncmpServiceCmHandle.setCmHandleID(cmHandleId);
        populateCmHandleProperties(cmHandleDataNode, ncmpServiceCmHandle);
        return YangModelCmHandle.toYangModelCmHandle(null, null,
            null, ncmpServiceCmHandle);
    }
