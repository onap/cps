...
public class DmiRequestBody {
     ...
     *
     * @param dmiPropertiesAsList the cm handle additional properties
     */
    public void asDmiProperties(
        final List<PersistenceCmHandle.PropertyConstructor> dmiPropertiesAsList) {
        dmiProperties = new LinkedHashMap<>();
        for (final PersistenceCmHandle.PropertyConstructor dmiProperty : dmiPropertiesAsList) {
            dmiProperties.put(dmiProperty.getName(),
                dmiProperty.getValue());
        }
    }
