...
public class SynchronizationCacheConfig {
    ...
    private static final MapConfig moduleSyncStartedMapConfig = createMapConfig(TimeUnit.MINUTES.toSeconds(1));
    private static final MapConfig dataSyncSemaphoresMapConfig = createMapConfig(TimeUnit.MINUTES.toSeconds(30));
    ...
    public Map<String, Object> moduleSyncStartedOnCmHandles() {
        return createHazelcastInstance("moduleSyncStartedOnCmHandles", moduleSyncStartedMapConfig)
    ...
    public Map<String, Boolean> dataSyncSemaphores() {
        return createHazelcastInstance("dataSyncSemaphores", dataSyncSemaphoresMapConfig)
            .getMap("dataSyncSemaphores");
    }

    private HazelcastInstance createHazelcastInstance(
        final String hazelcastInstanceName, NamedConfig namedConfig) {
    ...
    private static MapConfig createMapConfig(final long timeToLiveSeconds) {
