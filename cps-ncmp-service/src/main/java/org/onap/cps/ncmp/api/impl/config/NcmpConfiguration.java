...
public class NcmpConfiguration {
    ...
    public static RestTemplate restTemplate(final RestTemplateBuilder restTemplateBuilder, 
        ...
        final ConnectionConfig connectionConfig = ConnectionConfig.copy(ConnectionConfig.DEFAULT)
                .setConnectTimeout(Timeout.of(httpClientConfiguration.getConnectTimeoutInSec()))
                .build();
        
        final PoolingHttpClientConnectionManager connectionManager = PoolingHttpClientConnectionManagerBuilder.create()
                .setDefaultConnectionConfig(connectionConfig)
                .setMaxConnTotal(httpClientConfiguration.getMaxConnTotal())
                .setMaxConnPerRoute(httpClientConfiguration.getMaxConnPerRoute())
                .build();
        
        final CloseableHttpClient httpClient = HttpClients.custom()
                .setConnectionManager(connectionManager)
                .evictExpiredConnections()
                .evictIdleConnections(TimeValue.of(httpClientConfiguration.getEvictIdleConnsInSec()))
                .build();
        ...
        final RestTemplate restTemplate = restTemplateBuilder
                ...
                .setConnectTimeout(httpClientConfiguration.getConnectTimeoutInSec())
                .build();
