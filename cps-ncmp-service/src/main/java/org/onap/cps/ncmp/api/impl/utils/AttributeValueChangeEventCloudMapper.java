...
public class AttributeValueChangeEventCloudMapper {
     ...
     *
     * @param attributeValueChangeEvent object
     * @param eventKey                  as String
     * @return CloudEvent built.
     */
    public CloudEvent toCloudEvent(final AttributeValueChangeEvent attributeValueChangeEvent, final String eventKey,
        ...
        try {
            ...
            return CloudEventBuilder.v1().withId(randomId)
                    ...
                    .withDataSchema(URI.create(
                            "urn:cps:org.onap.cps.ncmp.events.avc.ncmp_to_client.AttributeValueChangeEvent:1.0.0"))
                    .withData(objectMapper.writeValueAsBytes(attributeValueChangeEvent)).build();
