...
public class TrustLevelManager {
    ...
    /**
     * Add cmHandles to trustLevelPerCmHandle and publish initial trust level of cmHandles if it is NONE.
     *
    ...
    /**
     * Update a cmHandle in trustLevelPerCmHandle and publish if the trust level is different.
     *
