...
public class ResourceDataOperationRequestUtils {
    ...
    public static Map<String, List<DmiDataOperation>> processPerDefinitionInDataOperationsRequest(
        ...
        final Map<String, Map<NcmpEventResponseCode, List<String>>> cmHandleIdsPerOperationIdByResponseCode
                = new HashMap<>();
    ...
    private static void populateCmHandleIdsPerOperationIdByResponseCode(final Map<String, Map<NcmpEventResponseCode,
        ...
        if (!cmHandleIds.isEmpty()) {
            cmHandleIdsPerOperationIdByResponseCode.put(operationId, Map.of(ncmpEventResponseCode, cmHandleIds));
        }
    }
}
