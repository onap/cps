...
public class ModuleSyncService {
    ...
    private ModuleDelta getModuleDelta(final YangModelCmHandle yangModelCmHandle, final String targetModuleSetTag) {
        ...
        Collection<ModuleReference> allModuleReferences = cmHandleQueryService
                .queryModuleReferencesByModuleSetTag(targetModuleSetTag);
        log.debug("ModuleReferences for moduleSetTag '{}': {}", targetModuleSetTag, allModuleReferences);
