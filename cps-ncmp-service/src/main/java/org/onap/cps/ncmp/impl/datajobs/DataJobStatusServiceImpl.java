 ...
 * This service retrieves the status of a data job by delegating to {@link DmiSubJobStatusRequestHandler}.
 */
@Service
...
public class DataJobStatusServiceImpl implements DataJobStatusService {
    ...
    @Override
    public String getDataJobStatus(final String dmiServiceName,
                                   final String requestId,
                                   final String dataProducerJobId,
                                   final String dataProducerId,
                                   final String authorization) {
        return getDataJobStatusFromDmi(dmiServiceName, requestId, dataProducerJobId,dataProducerId, authorization);
    }

    private String getDataJobStatusFromDmi(final String dmiServiceName,
                                           final String requestId,
                                           final String dataProducerJobId,
                                           final String dataProducerId,
                                           final String authorization) {
    ...
    private UrlTemplateParameters buildUrlParameters(final String dmiServiceName, final String requestId,
