...
public class NcmpOutEventMapper {
     ...
     * @param dmiSubscriptionDetailsMap contains CmNotificationSubscriptionDetails per dmi plugin
    ...
    public NcmpOutEvent toNcmpOutEvent(final String subscriptionId,
        ...
        populateNcmpOutEventWithCmHandleIds(dmiSubscriptionDetailsMap,
                cmSubscriptionData);
