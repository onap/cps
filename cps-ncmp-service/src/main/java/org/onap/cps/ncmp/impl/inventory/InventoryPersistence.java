...
public interface InventoryPersistence extends NcmpPersistence {
    ...
    /**
     * Gets a map of alternate id to cm handle id for all cm handles in inventory.
     * @return a map of alternate id to cm handle id
     */
    Map<String, String> getAllCmHandleIdPerAlternateId();
}
