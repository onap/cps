...
public interface InventoryPersistence extends NcmpPersistence {
     ...
     */
    void setAndUpdateCmHandleField(String cmHandleIdToUpdate,
                                   String fieldName,
                                   String newFieldValue);


    /**
     * Bulk updates the specified fields of a CM handle with a new value in the DMI registry.
     *
     * @param cmHandleIdToValueMap                      the CM handle to be updated and new value
     * @param fieldName                                 the name of the field within the CM handle to be updated
     */
    void updateCmHandleFields(final Map<String, String> cmHandleIdToValueMap, final String fieldName);

    /**
     * Method to update a batch of cm handles status to the value in CompositeState.
     *
     * @param updates                                   the cmHandleId and state change being performed on it
     */
    void bulkUpdateCmHandleStates(List<CmHandleStateUpdate> updates);
