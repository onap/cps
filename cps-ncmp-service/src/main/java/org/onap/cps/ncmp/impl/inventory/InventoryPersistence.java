...
public interface InventoryPersistence extends NcmpPersistence {
     ...
     *
     * @param cmHandleStateAndDmiPropertiesUpdates               the cmHandleId and state change being performed on it
     */
    void bulkUpdateCmHandleStatesAndDmiProperties(
            List<CmHandleStateAndDmiPropertiesUpdate> cmHandleStateAndDmiPropertiesUpdates);
