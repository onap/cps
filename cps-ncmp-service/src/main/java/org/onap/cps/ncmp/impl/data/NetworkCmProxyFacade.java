...
public class NetworkCmProxyFacade {
    ...
    public Object getResourceDataForCmHandle(final CmResourceAddress cmResourceAddress,
        ...
        final CmResourceAddress resolvedCmResourceAddress = new CmResourceAddress(cmResourceAddress.datastoreName(),
            alternateIdMatcher.getCmHandleId(cmResourceAddress.cmHandleId()), cmResourceAddress.resourceIdentifier());
        final NcmpDatastoreRequestHandler ncmpDatastoreRequestHandler
            = getNcmpDatastoreRequestHandler(resolvedCmResourceAddress.datastoreName());

        return ncmpDatastoreRequestHandler.executeRequest(resolvedCmResourceAddress, optionsParamInQuery,
