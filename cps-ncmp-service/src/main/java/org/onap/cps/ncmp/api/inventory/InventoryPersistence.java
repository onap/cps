...
public class InventoryPersistence {
     ...
     */
    public void saveLockReasonAndDetails(final String cmHandleId, final LockReasonCategory reason,
                                         final String details) {
        final CompositeState.LockReason lockReason =
            CompositeState.LockReason.builder().lockReasonCategory(reason).details(details).build();
