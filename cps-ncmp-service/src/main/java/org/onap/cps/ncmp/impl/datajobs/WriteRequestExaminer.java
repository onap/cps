...
public class WriteRequestExaminer {
    ...
    private void examineWriteOperation(final String dataJobId,
        ...
        final DmiWriteOperation dmiWriteOperation = createDmi3ggpWriteOperation(writeOperation, dataNode);
    ...
    private DmiWriteOperation createDmi3ggpWriteOperation(final WriteOperation writeOperation,
