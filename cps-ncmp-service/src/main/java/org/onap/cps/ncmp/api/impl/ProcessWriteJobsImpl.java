...
import org.onap.cps.ncmp.api.ProcessWriteDataJobs;
...
public class ProcessWriteJobsImpl implements ProcessWriteDataJobs {

    @Override
    public Response writeDataJob(final RestProtocolParameters restProtocolParameters,
