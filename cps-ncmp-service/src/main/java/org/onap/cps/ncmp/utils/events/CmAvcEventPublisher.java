...
import static org.onap.cps.ncmp.events.NcmpEventDataSchema.CM_HANDLE_CHANGES_EVENT_V1;
...
public class CmAvcEventPublisher {
    ...
    public void publishAvcEvent(final String eventKey, final String attributeName,
        ...
        final CloudEvent avcCloudEvent = NcmpEvent.builder().type(AvcEvent.class.getTypeName())
                                                 .dataSchema(CM_HANDLE_CHANGES_EVENT_V1.getDataSchema()).data(avcEvent)
