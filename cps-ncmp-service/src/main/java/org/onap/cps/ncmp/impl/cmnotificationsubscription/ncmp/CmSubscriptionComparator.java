...
public class CmSubscriptionComparator {
     ...
     *
     * @param dmiCmSubscriptionPredicates list of DmiCmNotificationSubscriptionPredicates
     * @return new list of DmiCmNotificationSubscriptionPredicates
     */
    public List<DmiCmSubscriptionPredicate> getNewDmiCmNotificationSubscriptionPredicates(
        ...
        for (final DmiCmSubscriptionPredicate dmiCmSubscriptionPredicate : dmiCmSubscriptionPredicates) {
            ...
            for (final String cmHandleId : dmiCmSubscriptionPredicate.getTargetCmHandleIds()) {
                for (final String xpath : dmiCmSubscriptionPredicate.getXpaths()) {
                    if (!cmSubscriptionPersistenceService.isOngoingCmNotificationSubscription(datastoreType,
                            cmHandleId, xpath)) {
                        xpaths.add(xpath);
            ...
            populateValidDmiCmNotificationSubscriptionPredicates(targetCmHandleIds, xpaths, datastoreType,
                    newDmiCmSubscriptionPredicates);
        }
        return newDmiCmSubscriptionPredicates;
    }

    private void populateValidDmiCmNotificationSubscriptionPredicates(final Set<String> targetCmHandleIds,
