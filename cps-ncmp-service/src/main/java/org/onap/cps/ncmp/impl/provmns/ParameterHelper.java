...
public class ParameterHelper {
    ...
    public static RequestParameters createRequestParametersForPatch(final String pathWithAttributes) {
        final String fdn = extractFdn(pathWithAttributes);
        return createRequestParameters("PATCH", fdn);
    }

    /**
     * Remove trailing hash character from string if present.
     *
     * @param string the string to convert
     * @return string without trailing hash
     */
    public static String removeTrailingHash(final String string) {
    ...
    private static RequestParameters createRequestParameters(final String httpMethodName,
        ...
        final String id = splitClassNameId[1];
