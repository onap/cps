...
public class ParameterHelper {
    ...
    private static final String PROVMNS_EXTENSIONS_BASE_PATH = "ProvMnSExtensions/v\\d+/actions/";
    ...
    private static String getFullPath(final HttpServletRequest httpServletRequest) {
        ...
        final String[] pathVariables = uriPath.split(
            uriPath.contains("Extensions") ? PROVMNS_EXTENSIONS_BASE_PATH : PROVMNS_BASE_PATH);
