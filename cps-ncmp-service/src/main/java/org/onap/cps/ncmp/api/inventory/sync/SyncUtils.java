...
public class SyncUtils {
    ...
    private Optional<String> getFirstResource(final Object responseBody) {
        final StringBuilder resourceJson = new StringBuilder();
        final JsonObject overallJsonElement = new Gson().toJsonTree(responseBody).getAsJsonObject();
