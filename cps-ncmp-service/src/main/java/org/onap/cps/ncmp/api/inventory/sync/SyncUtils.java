...
public class SyncUtils {
    ...
    public List<YangModelCmHandle> getLockedMisbehavingCmHandles() {
        final List<DataNode> lockedCmHandleAsDataNodeList = cpsDataPersistenceService.queryDataNodes("NCMP-Admin",
            "ncmp-dmi-registry", "//lock-reason[@reason=\"LOCKED-MISBEHAVING\"]/ancestor::cm-handles",
            FetchDescendantsOption.OMIT_DESCENDANTS);
        final List<YangModelCmHandle> lockedCmHandleAsYangModelList = Collections.emptyList();
