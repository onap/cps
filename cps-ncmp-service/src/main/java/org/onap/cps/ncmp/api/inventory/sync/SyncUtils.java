...
public class SyncUtils {
    ...
    private final DmiRegistryPersistence dmiRegistryPersistence;
    ...
    public void setCmHandleReadyState(final YangModelCmHandle yangModelCmHandle) {
        ...
        dmiRegistryPersistence.updateCmHandleState(compositeState.getCmhandleState(), yangModelCmHandle.getId());
    }
    ...
    public void lockCmHandleState(final YangModelCmHandle yangModelCmHandle,
        ...
        dmiRegistryPersistence.updateCmHandleState(compositeState.getCmhandleState(), yangModelCmHandle.getId());
        dmiRegistryPersistence.saveLockReasonAndDetails(yangModelCmHandle.getId(), reason, details);
    }
