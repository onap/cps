...
public class InventoryModelLoader extends AbstractModelLoader {
    ...
    private static final String SCHEMA_SET_NAME_R20260128 = "dmi-registry-2026-01-28";
    private static final String SCHEMA_SET_NAME_R20260423 = "dmi-registry-2026-04-23";
    ...
    public void onboardOrUpgradeModel() {
        if (isMaster) {
            ...
            final String schemaToInstall =
                    ignoreR20260423Model ? SCHEMA_SET_NAME_R20260128 : SCHEMA_SET_NAME_R20260423;
    ...
    private void deleteOldButNotThePreviousSchemaSets() {
        deleteUnusedSchemaSets(NCMP_DATASPACE_NAME, SCHEMA_SET_NAME_R20260423, SCHEMA_SET_NAME_R20260128);
    }
