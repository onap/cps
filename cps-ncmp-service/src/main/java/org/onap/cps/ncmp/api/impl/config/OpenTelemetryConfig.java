...
public class OpenTelemetryConfig {
    ...
    */
    ...
    @ConditionalOnExpression(
        "${cps.tracing.enabled:false} && 'grpc'.equals('${cps.tracing.exporter.protocol:grpc}')")
    ...
    @Bean
    @ConditionalOnExpression(
        "${cps.tracing.enabled:false} && 'http'.equals('${cps.tracing.exporter.protocol:grpc}')")
     ...
     */
    @Bean
    @ConditionalOnProperty("cps.tracing.enabled:false")
