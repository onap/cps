...
public class DmiRestClient {
    ...
    public static final String SPRING_BOOT_HEALTH_RESPONSE_STATUS_FIELD = "status";
    ...
    public TrustLevel getDmiPluginTrustLevel(final String dmiPluginBaseUrl) {
        try {
            ...
            if (dmiPluginHealthStatus.get(SPRING_BOOT_HEALTH_RESPONSE_STATUS_FIELD).asText().equals("UP")) {
