...
public class DmiRestClient {
     ...
     * @param uriTemplateParameters   The DMI resource URL template with variables.
     ...
     * @param uriTemplateParameters   The URL template with variables for the POST request.
    ...
    public Mono<ResponseEntity<Object>> asynchronousPostOperationWithJsonData(final RequiredDmiService
                                                                              ...
                                                                              final OperationType operationType,
                                                                              final String authorization) {
        logUriTemplateParameters(uriTemplateParameters);
        final WebClient webClient = getWebClient(requiredDmiService);
        return webClient.post()
                .uri(uriTemplateParameters.uriTemplate(), uriTemplateParameters.uriVariables())
    ...
    private void logUriTemplateParameters(final UriTemplateParameters uriTemplateParameters) {
        log.debug("DMI service uri template: {}", uriTemplateParameters.uriTemplate());
        log.debug("DMI service uri variables: {}", uriTemplateParameters.uriVariables());
    }
