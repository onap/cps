...
public class DmiRestClient {
    ...
    public ResponseEntity<Object> postOperationWithJsonData(final String dmiResourceUrl,
        ...
        try {
            log.info("Started post operation for {} into thread: {}", dmiResourceUrl, Thread.currentThread().getName());
            ResponseEntity<Object> objectResponseEntity = restTemplate
                    .postForEntity(dmiResourceUrl, httpEntity, Object.class);
            log.info("Finished post operation for {} into thread: {}", dmiResourceUrl, Thread.currentThread().getName());
