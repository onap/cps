...
import org.onap.cps.ncmp.api.inventory.enums.FieldAccessType;
...
public class CmHandleQueriesImpl implements CmHandleQueries {
    ...
    public Map<String, NcmpServiceCmHandle> queryCmHandlePrivateProperties(
        ...
        return queryCmHandleAnyProperties(publicPropertyQueryPairs, FieldAccessType.PRIVATE);
    }

    @Override
    public Map<String, NcmpServiceCmHandle> queryCmHandlePublicProperties(
            final Map<String, String> publicPropertyQueryPairs) {
        return queryCmHandleAnyProperties(publicPropertyQueryPairs, FieldAccessType.PUBLIC);
    }
    ...
    private  Map<String, NcmpServiceCmHandle> queryCmHandleAnyProperties(
        ...
        for (final Map.Entry<String, String> publicPropertyQueryPair : publicPropertyQueryPairs.entrySet()) {
            final String cpsPath = "//" + accessType.toString() + "[@name=\"" + publicPropertyQueryPair.getKey()
