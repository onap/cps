...
public class ParameterMapper {
    ...
    public RequestParameters extractRequestParameters(final HttpServletRequest httpServletRequest) {
        ...
        if (splitClassNameId.length != 2) {
            final String title = String.format(INVALID_PATH_DETAILS_FORMAT, uriPath);
            throw new ProvMnSException(httpServletRequest.getMethod(), HttpStatus.UNPROCESSABLE_ENTITY, title);
        }
