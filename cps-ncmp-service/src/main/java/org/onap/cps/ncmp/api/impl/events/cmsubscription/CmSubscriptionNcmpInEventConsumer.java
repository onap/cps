...
public class CmSubscriptionNcmpInEventConsumer {
    ...
    public void consumeSubscriptionEvent(final ConsumerRecord<String, CloudEvent> subscriptionEventConsumerRecord) {
        ...
        assert cmSubscriptionNcmpInEvent != null;
    ...
    private void persistSubscriptionEvent(final CmSubscriptionNcmpInEvent cmSubscriptionNcmpInEvent) {
        final YangModelCmDataSubscriptionEvent yangModelCmDataSubscriptionEvent =
            cmSubscriptionNcmpInEventMapper.toYangModelCmDataSubscriptionEvent(cmSubscriptionNcmpInEvent);
        log.info("Subscription Event mapped to yang model: {}", yangModelCmDataSubscriptionEvent);
    }
