...
public class DataOperationRecordFilterStrategy {
     ...
     */
    @Bean
    public RecordFilterStrategy<String, DataOperationResponseEventV1> filterDataOperationDataResponseEvent() {
        return consumedRecord -> {
            ...
            return !(eventTypeHeaderValue != null
                    && eventTypeHeaderValue.startsWith("org.onap.cps.ncmp.events.async.DataOperationResponseEvent"));
        };
    }
}
