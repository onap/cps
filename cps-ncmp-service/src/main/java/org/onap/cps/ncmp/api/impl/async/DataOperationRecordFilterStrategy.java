...
public class DataOperationRecordFilterStrategy {
     ...
     */
    @Bean
    public RecordFilterStrategy<String, DataOperationEventV1_0_0> includeDataOperationEventsOnly() {
        return consumedRecord -> {
            ...
            return !(eventTypeHeaderValue != null
                    && eventTypeHeaderValue.startsWith("org.onap.cps.ncmp.events.async.DataOperationEventV1_0_0"));
        };
    }
}
