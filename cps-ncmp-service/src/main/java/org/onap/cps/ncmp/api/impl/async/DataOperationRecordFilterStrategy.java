...
public class DataOperationRecordFilterStrategy {
     ...
     */
    @Bean
    public RecordFilterStrategy<String, DataOperationEventV1> filterDataOperationEvents() {
        return consumedRecord -> {
            ...
            return !(eventTypeHeaderValue != null
                    && eventTypeHeaderValue.startsWith("org.onap.cps.ncmp.events.async.DataOperationEventV1"));
        };
    }
}
