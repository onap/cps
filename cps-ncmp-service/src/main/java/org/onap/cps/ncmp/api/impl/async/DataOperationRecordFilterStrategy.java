...
public class DataOperationRecordFilterStrategy {
     ...
     */
    @Bean
    public RecordFilterStrategy<String, CloudEvent> filterDataOperationResponseEvent() {
        return consumedRecord -> {
            ...
            return !(eventTypeHeaderValue != null
                    && eventTypeHeaderValue.startsWith("org.onap.cps.ncmp.events.async.DataOperationResponseEventV1"));
        };
    }
}
