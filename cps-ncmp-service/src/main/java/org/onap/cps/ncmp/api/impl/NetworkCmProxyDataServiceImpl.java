...
public class NetworkCmProxyDataServiceImpl implements NetworkCmProxyDataService {
    ...
    private JsonObject toJsonObject(final List<ModuleReference> unknownModuleReferences) {
        ...
        requestBodyJson.addProperty("operation", "read");

        final JsonArray moduleReferences = getModuleReferencesAsJson(unknownModuleReferences);

        final JsonObject data = new JsonObject();
        data.add("modules", moduleReferences);
        requestBodyJson.add("data", data);
