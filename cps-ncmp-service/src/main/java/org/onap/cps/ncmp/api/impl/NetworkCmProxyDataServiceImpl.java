    ...
    public void updateDmiRegistrationAndSyncModule(final DmiPluginRegistration dmiPluginRegistration) {
        ...
        try {
            ...
            final String message = String.format(
                    "Error occured while processing the CM-handle registration request [%s] ,caused by : [%s]",
                    dmiPluginRegistration, e.getMessage());
            log.error("Error occured while processing the CM-handle registration request {} ,caused by : {}",
                    dmiPluginRegistration, e.getMessage());
