...
public class NetworkCmProxyDataServiceImpl implements NetworkCmProxyDataService {
     ...
     */
    @Override
    public NcmpServiceCmHandle getNcmpServiceCmHandle(final String cmHandle) {
        final NcmpServiceCmHandle ncmpServiceCmHandle = new NcmpServiceCmHandle();
        final YangModelCmHandle yangModelCmHandle =
            yangModelCmHandleRetriever.retrieveYangModelCmHandleDmiServiceNameAndDmiProperties(cmHandle);
    ...
    private void setDmiProperties(final List<YangModelCmHandle.Property> dmiProperties,
        ...
        final Map<String, String> dmiPropertiesMap = new LinkedHashMap<>();
        for (final YangModelCmHandle.Property property: dmiProperties) {
            dmiPropertiesMap.put(property.getName(), property.getValue());
        }
    ...
    private void setPublicProperties(final List<YangModelCmHandle.Property> publicProperties,
        ...
        for (final YangModelCmHandle.Property property: publicProperties) {
            publicPropertiesMap.put(property.getName(), property.getValue());
        }
    ...
    public void parseAndCreateCmHandlesInDmiRegistrationAndSyncModules(
        ...
        final YangModelCmHandlesList createdYangModelCmHandlesList =
            getUpdatedYangModelCmHandlesList(dmiPluginRegistration, dmiPluginRegistration.getCreatedCmHandles());
    ...
    private void parseAndUpdateCmHandlesInDmiRegistration(final DmiPluginRegistration dmiPluginRegistration)
        ...
        final YangModelCmHandlesList updatedYangModelCmHandlesList =
            getUpdatedYangModelCmHandlesList(dmiPluginRegistration, dmiPluginRegistration.getUpdatedCmHandles());
        final String cmHandlesAsJson = jsonObjectMapper.asJsonString(updatedYangModelCmHandlesList);
    ...
    private void syncAndCreateSchemaSet(final YangModelCmHandle yangModelCmHandle) {
        ...
        if (unknownModuleReferences.isEmpty()) {
            ...
            newYangResourcesModuleNameToContentMap = dmiModelOperations.getNewYangResourcesFromDmi(yangModelCmHandle,
