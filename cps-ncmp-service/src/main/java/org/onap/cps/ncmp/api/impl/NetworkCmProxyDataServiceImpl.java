...
public class NetworkCmProxyDataServiceImpl implements NetworkCmProxyDataService {
    ...
    protected void modelSync(final PersistenceCmHandle cmHandle) {
        ...
        final List<ModuleReference> moduleReferencesNotAlreadyInCps = new ArrayList<>();
        ...
        for (final ModuleReference moduleReferenceFromDmiForCmHandle : moduleReferencesFromDmiForCmHandle) {
            if (knownModuleReferencesInCps.contains(moduleReferenceFromDmiForCmHandle)) {
                ...
                moduleReferencesNotAlreadyInCps.add(moduleReferenceFromDmiForCmHandle);
            }
        }

        final Map<String, String> newYangResourcesModuleNameToContentMap =
            getYangResources(cmHandle, moduleReferencesNotAlreadyInCps);
    ...
    private Map<String, String> getYangResources(final PersistenceCmHandle cmHandle,
        final List<ModuleReference> moduleReferencesNotAlreadyInCps) {
