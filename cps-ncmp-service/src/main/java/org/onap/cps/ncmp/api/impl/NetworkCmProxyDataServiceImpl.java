...
public class NetworkCmProxyDataServiceImpl implements NetworkCmProxyDataService {
        ...
        for (final List<String> tobeRemovedCmHandleBatch : Lists.partition(tobeRemovedCmHandles, DELETE_BATCH_SIZE)) {
            try {
                ...
                for (final String cmHandleId : tobeRemovedCmHandleBatch) {
                    final CmHandleRegistrationResponse response = deleteCmHandleWithResponse(cmHandleId);
                    cmHandleRegistrationResponses.add(response);
                }
            }
        }
    ...
    private CmHandleRegistrationResponse deleteCmHandleWithResponse(final String cmHandleId) {
        try {
