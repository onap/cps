...
public class ParametersBuilder {
    ...
    public UrlTemplateParameters createUrlTemplateParametersForGet(final Scope scope, final String filter,
        ...
        final String attributesString = formatQueryParameter(attributes);
        final String fieldsString = formatQueryParameter(fields);
    ...
    private String formatQueryParameter(final List<String> queryParameterList) {
