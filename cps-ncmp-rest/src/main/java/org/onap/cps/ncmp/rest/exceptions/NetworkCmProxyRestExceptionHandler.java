...
public class NetworkCmProxyRestExceptionHandler {
    ...
    private static ResponseEntity<Object> wrapDmiErrorResponse(final HttpStatus httpStatus, final Exception exception) {
        ...
        if (exception instanceof HttpClientRequestException) {
            dmiErrorResponse.setHttpCode(((HttpClientRequestException) exception).getHttpStatus());
            dmiErrorResponse.setBody(((HttpClientRequestException) exception).getDetails());
        }
