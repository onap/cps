...
public class ProvMnsController implements ProvMnS {
    ...
    private final ProvMnSParametersUtil provMnsParametersUtil;
    ...
    public ResponseEntity<Object> getMoi(final HttpServletRequest httpServletRequest, final Scope scope,
        ...
        try {
            ...
            final ResponseEntity<Object> errorResponse =
                provMnsParametersUtil.checkDataProducerIdentifierAndReadyState(yangModelCmHandle, "GET");
            if (errorResponse != null) {
                return errorResponse;
            }
            final UrlTemplateParameters urlTemplateParameters = provMnsParametersUtil.getUrlTemplateParameters(scope,
                filter, attributes,
            ...
            return provMnSErrorResponseBuilder.buildErrorResponseGet(HttpStatus.NOT_FOUND, errorResponseMessage);
        }
    }
        ...
        try {
            final YangModelCmHandle yangModelCmHandle = inventoryPersistence.getYangModelCmHandle(
                alternateIdMatcher.getCmHandleIdByLongestMatchingAlternateId(
                    provMnsRequestParameters.getAlternateId(), "/"));
            final ResponseEntity<Object> errorResponse =
                provMnsParametersUtil.checkDataProducerIdentifierAndReadyState(yangModelCmHandle, "PUT");
            if (errorResponse != null) {
                return errorResponse;
            }
            try {
                policyExecutor.checkPermission(yangModelCmHandle,
                    ...
                    null,
                    provMnsRequestParameters.getAlternateId(),
                    provMnsParametersUtil.policyExecutorOperationToJson(
            ...
            final UrlTemplateParameters urlTemplateParameters =
                provMnsParametersUtil.putUrlTemplateParameters(resource,
                    yangModelCmHandle);
