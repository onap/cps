...
public abstract class NcmpDatastoreHandler {
     ...
     * @return the boolean
     */
    protected Boolean isUserWantsAsyncResponse(final String topicParamInQuery) {
     ...
     */
    public ResponseEntity<Object> handle(final String cmHandleId,
                                         final String resourceIdentifier,
                                         final String optionsParamInQuery,
                                         final String topicParamInQuery,
        ...
        if (isUserWantsAsyncResponse(topicParamInQuery) && asyncEnabled) {
