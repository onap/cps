...
public class NetworkCmProxyInventoryController implements NetworkCmProxyInventoryApi {
     ...
     * @param includePrivatePropertiesParameter boolean value to determine the inclusion of private properties
     * @return collection of cm handles
     */
    @Override
    public ResponseEntity<List<RestOutputCmHandle>> searchCmHandles(
            final CmHandleQueryParameters cmHandleQueryParameters,
            final Boolean includePrivatePropertiesParameter) {
        ...
        final List<RestOutputCmHandle> restOutputCmHandles =
                networkCmProxyInventoryFacade.queryInventoryForCmHandles(cmHandleQueryApiParameters)
