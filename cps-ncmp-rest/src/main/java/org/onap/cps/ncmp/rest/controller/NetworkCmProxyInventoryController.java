...
public class NetworkCmProxyInventoryController implements NetworkCmProxyInventoryApi {
    ...
    private boolean isRegistrationFailureOnlyDueToConflict(
        final DmiPluginRegistrationErrorResponse dmiPluginRegistrationErrorResponse) {
        return !isFailedRegistration(dmiPluginRegistrationErrorResponse.getFailedCreatedCmHandles())
            || !isFailedRegistration(dmiPluginRegistrationErrorResponse.getFailedUpdatedCmHandles())
            || !isFailedRegistration(dmiPluginRegistrationErrorResponse.getFailedRemovedCmHandles())
            || !isFailedRegistration(dmiPluginRegistrationErrorResponse.getFailedUpgradeCmHandles());
    }

    private boolean isFailedRegistration(
