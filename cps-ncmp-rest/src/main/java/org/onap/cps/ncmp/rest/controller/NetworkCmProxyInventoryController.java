...
public class NetworkCmProxyInventoryController implements NetworkCmProxyInventoryApi {
    ...
    public ResponseEntity<Void> updateDmiPluginRegistration(
        ...
        DmiPluginRegistrationResponse dmiPluginRegistrationResponse =
        ...
        var failedRegistrationErrorResponse = getFailureRegistrationResponse(dmiPluginRegistrationResponse);
    ...
    private DmiPluginRegistrationErrorResponse getFailureRegistrationResponse(
        DmiPluginRegistrationResponse dmiPluginRegistrationResponse) {
        var dmiPluginRegistrationErrorResponse = new DmiPluginRegistrationErrorResponse();
    ...
    boolean allRegistrationsSuccessful(DmiPluginRegistrationErrorResponse dmiPluginRegistrationErrorResponse) {
    ...
    private List<CmHandlerRegistrationErrorResponse> getFailedResponses(
        List<CmHandleRegistrationResponse> cmHandleRegistrationResponseList) {
    ...
    private CmHandlerRegistrationErrorResponse toCMHandleRegistrationErrorResponse(
        CmHandleRegistrationResponse registrationResponse) {
