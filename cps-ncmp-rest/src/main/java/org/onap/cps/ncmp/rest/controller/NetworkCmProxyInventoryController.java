...
public class NetworkCmProxyInventoryController implements NetworkCmProxyInventoryApi {
     ...
     */
    @Override
    public ResponseEntity<RestOutputCmHandle> getCmHandleByDistinguishedName(final String distinguishedName,
                                                                             final Boolean outputDmiProperties) {
        final NcmpServiceCmHandle ncmpServiceCmHandle =
                networkCmProxyInventoryFacade.getNcmpServiceCmHandle(distinguishedName);
