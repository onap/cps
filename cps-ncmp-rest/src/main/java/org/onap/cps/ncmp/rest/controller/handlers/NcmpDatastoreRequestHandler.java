...
public abstract class NcmpDatastoreRequestHandler {
    ...
    public ResponseEntity<Object> executeRequest(final CmResourceAddress cmResourceAddress,
        ...
        if (asyncResponseRequested && notificationFeatureEnabled) {
            return getResourceDataForCmHandleAsynchronously(cmResourceAddress, optionsParamInQuery, topicParamInQuery,
        ...
        return getResourceDataForCmHandleSynchronously(getResourceDataForCmHandle(cmResourceAddress,
                optionsParamInQuery, NO_TOPIC, NO_REQUEST_ID, includeDescendants, authorization));
    }

    private ResponseEntity<Object> getResourceDataForCmHandleSynchronously(
            final Mono<Object> resourceDataForCmHandleAsMono) {
        return ResponseEntity.ok(resourceDataForCmHandleAsMono.block());
    }

    private ResponseEntity<Object> getResourceDataForCmHandleAsynchronously(final CmResourceAddress cmResourceAddress,
                                                                            final String optionsParamInQuery,
                                                                            final String topicParamInQuery,
                                                                            final boolean includeDescendants,
                                                                            final String authorization) {
