...
public abstract class NcmpDatastoreRequestHandler {
    ...
    public ResponseEntity<Object> executeRequest(final CmResourceAddress cmResourceAddress,
        ...
        return ResponseEntity.ok(getResourceDataForCmHandle(cmResourceAddress, optionsParamInQuery,
                NO_TOPIC, NO_REQUEST_ID, includeDescendants, authorization).block());
    }
    ...
    private ResponseEntity<Object> getResourceDataForCmHandleAsynchronously(final CmResourceAddress cmResourceAddress,
        ...
        getResourceDataForCmHandle(cmResourceAddress, optionsParamInQuery, topicParamInQuery, requestId,
                includeDescendants, authorization)
                .doOnSuccess(
                        result -> log.debug("Async operation succeeded for request id {}: {}", requestId, result))
                .doOnError(
                        error ->
