...
public interface TaskManagementDefaultHandler {
    ...
    default Supplier<Object> getTaskSupplierForAllRequest(final String cmHandleId, final String resourceIdentifier,
    ...
    default Supplier<Object> getTaskSupplierToQueryCachedResourceRequest(final String cmHandleId,
    ...
    //getTaskSupplierForBulkRequest
    default Supplier<Object> getTaskSupplierForPassthroughBulkRequest(final List<String> cmHandleIds,
                                                                      final String resourceIdentifier,
                                                                      final String optionsParamInQuery,
                                                                      final String topicParamInQuery,
