...
public interface TaskManagementDefaultHandler {
    ...
    default Supplier<Object> getTaskSupplierForPassthroughOrCachedRequest(final String cmHandleId,
    ...
    default Supplier<Object> getTaskSupplierForQueryCachedResourceRequest(final String cmHandleId,
                                                                          final String resourceIdentifier,
                                                                          final boolean includeDescendant) {
        return NO_OBJECT_SUPPLIER;
