...
@RestController
@RequestMapping("${rest.api.provmns-extension-base-path}")
@RequiredArgsConstructor
@Slf4j
public class ProvMnSExtensionController implements ProvMnSExtension {

    @Override
    public ResponseEntity<Object> provmnsExtensionAction(final HttpServletRequest httpServletRequest,
                                                         final Object body) {
