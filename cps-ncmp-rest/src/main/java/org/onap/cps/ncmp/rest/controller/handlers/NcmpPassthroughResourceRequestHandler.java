...
public class NcmpPassthroughResourceRequestHandler extends NcmpDatastoreRequestHandler {
    ...
    @Override
    public Supplier<Object> getTaskSupplierForPassthroughOrCachedRequest(final String cmHandleId,
    ...
    @Override
    public Supplier<Object> getTaskSupplierForPassthroughBulkRequest(final List<String> cmHandleIds,
                                                         final String resourceIdentifier,
                                                         final String optionsParamInQuery,
                                                         final String topicParamInQuery,
                                                         final String requestId,
