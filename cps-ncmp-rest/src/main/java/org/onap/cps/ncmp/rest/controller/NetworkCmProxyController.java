...
public class NetworkCmProxyController implements NetworkCmProxyApi {
    ...
    public ResponseEntity<Object> getResourceDataOperationalForCmHandle(final String cmHandle,
        ...
        if (isValidTopic(topicParamInQuery)) {
            ...
            if (!asyncEnabled) {
                return ResponseEntity.ok("Asynchronous messaging is currently disabled for passthrough-operational.");
            }
    ...
    public ResponseEntity<Object> getResourceDataRunningForCmHandle(final String cmHandle,
        ...
        if (isValidTopic(topicParamInQuery)) {
            ...
            if (!asyncEnabled) {
                return ResponseEntity.ok("Asynchronous messaging is currently disabled for passthrough-running.");
            }
