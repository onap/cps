...
public class NetworkCmProxyController implements NetworkCmProxyApi {
    ...
    public ResponseEntity<Object> getResourceDataForCmHandle(final String datastoreName,
        ...
        final String cmHandleId = validateCmHandleOrAlternateId(cmHandle);
    ...
    private String validateCmHandleOrAlternateId(final String cmHandle) {
        if (alternateIdMatcher.existingCmHandleId(cmHandle)) {
            return cmHandle;
        } else {
