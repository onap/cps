...
public class NetworkCmProxyController implements NetworkCmProxyApi {
     ...
     */
    @Override
    public ResponseEntity<RestOutputCmHandle> retrieveCmHandleDetailsByName(final String cmHandleName) {
        final NcmpServiceCmHandle ncmpServiceCmHandle = networkCmProxyDataService.getNcmpServiceCmHandle(cmHandleName);
