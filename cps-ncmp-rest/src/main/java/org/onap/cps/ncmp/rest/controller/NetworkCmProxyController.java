...
public class NetworkCmProxyController implements NetworkCmProxyApi {
    ...
    public ResponseEntity<List<RestOutputCmHandle>> executeCmHandleSearch(
        ...
        mapOldConditionProperties(cmHandleQueryApiParameters, cmHandleQueryRestParameters);
     ...
     *
     * @param cmHandleQueryApiParameters the converted input parameter
     * @param cmHandleQueryRestParameters the original input parameter
     */
    @Deprecated
    private void mapOldConditionProperties(final CmHandleQueryApiParameters cmHandleQueryApiParameters,
                                           final CmHandleQueryRestParameters cmHandleQueryRestParameters) {
        if (Objects.nonNull(cmHandleQueryRestParameters.getConditions())
                && Objects.isNull(cmHandleQueryApiParameters.getCmHandleQueryRestParameters())) {
            ...
            cmHandleQueryRestParameters.getConditions().forEach(
                oldConditionProperty -> {
                    if (Objects.nonNull(oldConditionProperty.getConditionParameters())
                        && Objects.nonNull(oldConditionProperty.getName())) {
                        ...
                        oldConditionProperty.getConditionParameters().forEach(
                            oldConditionParameter -> conditionApiProperties.getConditionParameters().add(
                                Collections.singletonMap("moduleName", oldConditionParameter.getModuleName())
                            )
                        );
