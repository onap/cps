...
import org.onap.cps.ncmp.rest.model.ModuleNameValuePair;
import org.onap.cps.ncmp.rest.model.ModuleNameValuePairs;
...
public class NetworkCmProxyController implements NetworkCmProxyApi {
    ...
    public ResponseEntity<CmHandles> executeCmHandleSearch(final Conditions conditions) {
        ...
        if (cmHandleIdentifiers.isEmpty()) {
            cmHandles.setCmHandles(toCmHandleProperties(""));
        }
    ...
    private Collection<String> executeCmHandleSearchesForModuleNames(final ConditionProperties conditionProperties) {
        return networkCmProxyDataService
            .executeCmHandleSearches(getModuleNames(conditionProperties.getConditionParameters()));
    }

    private Collection<String> getModuleNames(final ModuleNameValuePairs moduleNameValuePairs) {
        final Collection<String> moduleNames = new ArrayList<>(moduleNameValuePairs.size());
        for (final ModuleNameValuePair moduleNameValuePair : moduleNameValuePairs) {
            moduleNames.add(moduleNameValuePair.getModuleName());
        }
        return moduleNames;
    }
