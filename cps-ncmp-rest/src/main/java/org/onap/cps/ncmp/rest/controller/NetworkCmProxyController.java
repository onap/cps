...
import org.onap.cps.ncmp.rest.controller.handlers.NcmpDatastoreHandler;
import org.onap.cps.ncmp.rest.controller.handlers.NcmpDatastoreHandlerFactory;
...
public class NetworkCmProxyController implements NetworkCmProxyApi {
    ...
    public ResponseEntity<Object> getNcmpDatastore(final String datastoreName,
        ...
        final NcmpDatastoreHandler ncmpDatastoreHandler = new NcmpDatastoreHandlerFactory(
                networkCmProxyDataService,
                cpsNcmpTaskExecutor,
                timeOutInMilliSeconds,
                asyncEnabled).getNcmpDatastoreHandler(DatastoreType.fromDatastoreName(datastoreName));
