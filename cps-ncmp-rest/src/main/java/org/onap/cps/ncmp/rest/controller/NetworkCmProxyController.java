...
public class NetworkCmProxyController implements NetworkCmProxyApi {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(NetworkCmProxyController.class);
     ...
     */
    @Override
    public ResponseEntity<String> updateDmiPluginRegistration(
        ...
        try {
            ...
            LOGGER.error("Parsing error occurred while converting cm-handles to JSON {}", restDmiPluginRegistration);
    ...
    private DmiPluginRegistration convertRestObjectToJavaApiObject(
        ...
        final String jsonString = objectMapper.writeValueAsString(restDmiPluginRegistration);
