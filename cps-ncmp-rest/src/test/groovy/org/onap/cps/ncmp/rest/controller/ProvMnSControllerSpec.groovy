...
class ProvMnSControllerSpec extends Specification {
    ...
    static def validCmHandle2 = new YangModelCmHandle(id:'ch-2', alternateId: '/subnetwork=1/managedElement=2', dmiServiceName: 'someDmiService', dataProducerIdentifier: 'someDataProducerId', compositeState: new CompositeState(cmHandleState: READY))
