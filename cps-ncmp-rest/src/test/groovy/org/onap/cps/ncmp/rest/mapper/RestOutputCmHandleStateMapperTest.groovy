    ...
    def 'Composite State to Rest Output CmHandleState'() {
        given: 'a composite state model'
            def compositeState = new CompositeState(cmhandleState: CmHandleState.ADVISED,
                lockReason: LockReason.builder().reason('some-lock-reason').details('some-details').build(),
        ...
        and: 'mapped result should have correct values'
            ...
            assert result.lockReason.details == 'some-details'
            assert result.lockReason.reason == 'some-lock-reason'
