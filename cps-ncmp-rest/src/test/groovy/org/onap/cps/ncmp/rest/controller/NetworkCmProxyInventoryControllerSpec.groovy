...
class NetworkCmProxyInventoryControllerSpec extends Specification {
    ...
    def 'CmHandle search endpoint test without parameters.'() {
        ...
        and: 'the service returns an empty array of results'
            mockNetworkCmProxyDataService.executeCmHandleIdSearchForInventory(*_) >> []
        when: 'post request is performed & search is called with empty query parameter array'
            def response = mvc.perform(
    ...
    def 'CmHandle search endpoint test with one parameter.'() {
        ...
        and: 'the service returns an array of results with one element'
            mockNetworkCmProxyDataService.executeCmHandleIdSearchForInventory(*_) >> [ 'ChHandle' ]
