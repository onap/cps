...
class DeprecationHelperSpec extends Specification {
    ...
    def 'Map deprecated condition properties.'() {
        given: 'a deprecated condition properties'
            def cmHandleQueryRestParameters = new CmHandleQueryRestParameters()
            ...
            cmHandleQueryRestParameters.conditions = [oldConditionProperties]
        ...
        when: 'converted into the new format'
            def result = deprecationHelper.mapOldConditionProperties(cmHandleQueryRestParameters)
