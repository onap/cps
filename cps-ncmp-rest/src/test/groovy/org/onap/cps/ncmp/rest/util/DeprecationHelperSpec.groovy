...
class DeprecationHelperSpec extends Specification {
    ...
    def 'Map deprecated condition properties - #scenario.'() {
        given: 'a deprecated condition properties'
            ...
            cmHandleQueryApiParameters.cmHandleQueryParameters = cmHandleQueryApiParametersArray
        ...
        where:
            scenario                           | oldConditionPropertiesArray                                                                                                   | cmHandleQueryParametersArray                                                                             | cmHandleQueryApiParametersArray
            'mapping old query'                | [new OldConditionProperties(name: 'hasAllModule', conditionParameters: [new ModuleNameAsJsonObject(moduleName: 'module-1')])] | null                                                                                                     | [new ConditionApiProperties(conditionName: 'hasAllModule', conditionParameters: [[moduleName:'module-1']])]
            'old condition is null'            | null                                                                                                                          | null                                                                                                     | null
            'old condition parameters is null' | [new OldConditionProperties(name: 'hasAllModule', conditionParameters: null)]                                                 | null                                                                                                     | []
            'old condition name is null'       | [new OldConditionProperties(name: null, conditionParameters: [new ModuleNameAsJsonObject(moduleName: 'module-1')])]           | null                                                                                                     | []
