...
class RestOutputCmHandleMapperSpec extends Specification {
    ...
    def 'Map cm handles to rest output #scenario.'() {
        ...
        then: 'result has the expected properties'
            assert result.privateCmHandleProperties.containsKey('some key') == includePrivateProperties
            if (trustLevel != null) {
        ...
        where:
            ...
            'not including private properties' | false                    | null
            'including private properties'     | true                     | TrustLevel.NONE
