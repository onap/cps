...
class ProvMnsControllerSpec extends Specification {
    ...
    def 'Put Resource Data from pass-through operational.'() {
        given: 'resource data url'
    ...
    def 'Patch Resource Data from pass-through operational.'() {
        given: 'resource data url'
    ...
    def 'Delete Resource Data from pass-through operational.'() {
        given: 'resource data url'
