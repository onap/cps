...
class ProvMnsControllerSpec extends Specification {
    ...
    @SpringBean
    ProvMnSParametersUtil provMnSParametersMapper = new ProvMnSParametersUtil(new ProvMnSErrorResponseBuilder(),new JsonObjectMapper(new ObjectMapper()), new ObjectMapper())
