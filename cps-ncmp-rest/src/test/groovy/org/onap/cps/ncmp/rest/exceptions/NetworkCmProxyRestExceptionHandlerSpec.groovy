...
class NetworkCmProxyRestExceptionHandlerSpec extends Specification {
    ...
    def 'Get request with generic #scenario exception returns correct HTTP Status with #scenario'() {
        ...
        where:
            ...
            'DataNode Validation' | new DataNodeNotFoundException('myDataspaceName', 'myAnchorName') || null                        | datNodeNotFoundErrorMessage | NOT_FOUND
            'other'               | new IllegalStateException(sampleErrorMessage)                    || null                        | sampleErrorMessage          | INTERNAL_SERVER_ERROR
            'Data Node Not Found' | new DataNodeNotFoundException('myDataspaceName', 'myAnchorName') || datNodeNotFoundErrorMessage | datNodeNotFoundErrorMessage | NOT_FOUND
    }
