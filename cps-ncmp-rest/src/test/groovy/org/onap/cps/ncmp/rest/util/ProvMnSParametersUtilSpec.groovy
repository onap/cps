...
class ProvMnSParametersUtilSpec extends Specification{

    def objectUnderTest = new ProvMnSParametersUtil(new ProvMnSErrorResponseBuilder(),new JsonObjectMapper(new ObjectMapper()), new ObjectMapper())
