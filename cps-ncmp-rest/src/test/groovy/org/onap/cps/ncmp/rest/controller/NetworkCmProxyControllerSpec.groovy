        ...
        then: 'ncmp service method to get yang resource module references is called'
            1 * mockNetworkCmProxyDataService.getAllYangResourcesModuleReferences('some-cmhandle')
                    >> [new ModuleReference(moduleName: 'some-name1',revision: 'some-revision1'),
                        new ModuleReference(moduleName: 'some-name2',revision: 'some-revision2')]
        and: 'response contains an array of module names and revisions'
            response.getContentAsString() == '[{"moduleName":"some-name1","revision":"some-revision1"},{"moduleName":"some-name2","revision":"some-revision2"}]'
