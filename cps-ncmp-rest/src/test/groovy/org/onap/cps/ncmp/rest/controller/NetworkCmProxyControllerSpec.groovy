...
class NetworkCmProxyControllerSpec extends Specification {
    ...
    def 'Get Resource Data from pass-through running.' () {
        ...
        then: 'the NCMP data service is called with getResourceDataPassThroughRunningFoCmHandle'
        1 * mockNetworkCmProxyDataService.getResourceDataPassThroughRunningFoCmHandle('testCmHandle',
                'testResourceIdentifier',
                'application/json',
                'testFields',
                5)
