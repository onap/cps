...
class NetworkCmProxyControllerSpec extends Specification {
    ...
    def 'Execute v2 lightweight cm handle search.'() {
        ...
        and: 'mapper converts cm handles to lightweight response'
            mockRestOutputCmHandleMapper.toRestOutputCmHandleLightweight(ncmpServiceCmHandle1) >> new org.onap.cps.ncmp.rest.model.RestOutputCmHandleLightweight(cmHandle: 'ch-1', cmHandleStatus: 'READY')
            mockRestOutputCmHandleMapper.toRestOutputCmHandleLightweight(ncmpServiceCmHandle2) >> new org.onap.cps.ncmp.rest.model.RestOutputCmHandleLightweight(cmHandle: 'ch-2', cmHandleStatus: 'ADVISED')
