...
class NetworkCmProxyControllerSpec extends Specification {
    ...
    def 'Get Resource Data from #datastoreInUrl with #scenario.'() {
        given: 'resource data url'
            ...
            Executors mockExecutorService = GroovySpy(Executors, global: true)
        when: 'get data resource request is performed'
            def response = mvc.perform(
                    get(getUrl)
                    .contentType(MediaType.APPLICATION_JSON)
        ...
        then: 'the NCMP data service is called with operational data for cm handle'
            expectedNumberOfExecutorExecutions * mockExecutorService.newSingleThreadExecutor().submit() >> Mock(Future)
