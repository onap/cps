...
class NetworkCmProxyControllerSpec extends Specification {
    ...
    def 'Retrieve cm handles.'() {
        ...
        and: 'the expected response content is returned'
            response.contentAsString == '[{"cmHandle":"some-cmhandle-id1","publicCmHandleProperties":[{"color":"yellow"}],"state":null,"trustLevel":"NONE"},{"cmHandle":"some-cmhandle-id2","publicCmHandleProperties":[{"color":"green"}],"state":null,"trustLevel":"COMPLETE"}]'
    }
