...
class NetworkCmProxyControllerSpec extends Specification {
    ...
    @SpringBean
    CpsNcmpTaskExecutor cpsTaskExecutor = Spy()
    ...
    def 'Get Resource Data from #datastoreInUrl with #scenario.'() {
        ...
        where: 'the following parameters are used'
            ...
            'null topic in url'                    | 'passthrough-operational' | '&topic=null'          || 'null'            | 1                                  | HttpStatus.BAD_REQUEST.value()
            ...
            'null topic in url'                    | 'passthrough-running'     | '&topic=null'          || 'null'            | 1                                  | HttpStatus.BAD_REQUEST.value()
