...
public class CpsRestController implements CpsRestApi {
    ...
    public ResponseEntity<Object> createModules(@Valid MultipartFile multipartFile, String dataspaceName) {
        ...
        final SchemaContext schemaContext = moduleStoreService.parseAndValidateModel(fileToParse);
        moduleStoreService.storeSchemaContext(schemaContext, dataspaceName);
