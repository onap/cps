...
public class MultipartFileUtil {
    ...
    /**
     * Extracts yang resources the multipart file instance.
     *
     ...
     * @throws ModelValidationException if the file name extension is not '.yang' or file is empty
    ...
    public static Map<String, String> extractYangResourcesMap(final MultipartFile multipartFile) {
        return ImmutableMap.<String, String>builder().put(
            extractYangResourceName(multipartFile), extractYangResourceContent(multipartFile)
        ).build();
    }
