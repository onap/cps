...
import org.onap.cps.utils.DeltaReportUtils;
...
public class DeltaRestController implements CpsDeltaApi {
    ...
    public ResponseEntity<Object> getDeltaByDataspaceAndAnchors(final String dataspaceName,
        ...
        return buildDeltaResponseEntity(deltaBetweenAnchors, ContentType.fromString(contentTypeInHeader));
    ...
    private ResponseEntity<Object> buildDeltaResponseEntity(final List<DeltaReport> deltaBetweenAnchors,
        ...
        if (ContentType.XML.equals(contentType)) {
            responseData = DeltaReportUtils.buildXmlUsingDom(deltaBetweenAnchors);
        } else {
