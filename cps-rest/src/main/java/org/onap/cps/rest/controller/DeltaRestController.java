...
public class DeltaRestController implements CpsDeltaApi {
    ...
    public ResponseEntity<Object> getDeltaByDataspaceAnchorAndPayload(final String dataspaceName,
        ...
        try {
            targetData = MultipartFileUtil.extractJsonContent(jsonFile, jsonObjectMapper);
        } catch (final IOException exception) {
            return new ResponseEntity<>("Failed to read JSON file: " + exception.getMessage(), HttpStatus.BAD_REQUEST);
