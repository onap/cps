...
public class QueryRestController implements CpsQueryApi {
    ...
    public ResponseEntity<Object> getNodesByDataspaceAndCpsPath(final String dataspaceName,
        ...
        final Integer totalAnchors = getTotalAnchorsForDataspace(dataspaceName);
    ...
    private Integer getTotalAnchorsForDataspace(final String dataspaceName) {
        return cpsQueryService.queryTotalAnchorsForDataspace(dataspaceName);
    }
