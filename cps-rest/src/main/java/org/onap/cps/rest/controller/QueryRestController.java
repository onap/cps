...
public class QueryRestController implements CpsQueryApi {
    ...
    public ResponseEntity<Object> getNodesByDataspaceAndAnchorAndCpsPath(final String dataspaceName,
        ...
        Map<String, Object> dataNodeMap = new HashMap<>();
        for (final DataNode dataNode : dataNodes) {
            dataNodeMap = DataMapUtils.toDataMap(dataNode);
        }
        return new ResponseEntity<>(new Gson().toJson(dataNodeMap), HttpStatus.OK);
    }
}
