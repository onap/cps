...
public class QueryRestController implements CpsQueryApi {
    ...
    @Override
    public ResponseEntity<Object> getNodesCompositeQuery(final String dataspaceName,
                                                                           final String anchorName,
        ...
        final List<Map<String, Object>> dataNodesAsMaps
                = cpsFacade.executeCompositeQuery(dataspaceName, anchorName, compositeQuery, fetchDescendantsOption);
        return buildResponseEntity(dataNodesAsMaps, ContentType.JSON);
    }
