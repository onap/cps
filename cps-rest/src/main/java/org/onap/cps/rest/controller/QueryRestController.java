...
public class QueryRestController implements CpsQueryApi {
    ...
    public ResponseEntity<Object> getNodesByDataspaceAndCpsPath(final String dataspaceName,
        ...
        String prefix = null;
        final Map<String, List<DataNode>> anchorDataNodeListMap = getDataNodesForAnchor(dataNodes);
        ...
        return ResponseEntity.ok().body(jsonObjectMapper.asJsonString(dataNodesAsListOfMaps));
        //return new ResponseEntity<>(jsonObjectMapper.asJsonString(dataNodesAsListOfMaps), HttpStatus.OK);
    }

    private Map<String, List<DataNode>> getDataNodesForAnchor(final Collection<DataNode> dataNodes) {
