...
public class DataRestController implements CpsDataApi {
    ...
    static ResponseEntity<Object> buildResponseEntity(final List<Map<String, Object>> dataMaps,
        ...
        if (dataMaps == null || dataMaps.isEmpty() || dataMaps.stream().anyMatch(Map::isEmpty)) {
            throw new DataValidationException("Data Validation Failed",
                    "Data maps cannot be null, empty, or contain empty entries");
        }
        if (contentType == ContentType.XML) {
            ...
            } catch (final TransformerException | ParserConfigurationException exception) {
