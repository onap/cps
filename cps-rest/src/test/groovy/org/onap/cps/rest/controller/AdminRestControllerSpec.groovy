...
class AdminRestControllerSpec extends Specification {
    ...
    def static schemaSets = ["my-schema-set1","my-schema-set2"].join(',')
    ...
    def 'Get #scenario from a dataspace.'() {
        ...
        where: 'following scenarios are tested'
            ...
            'anchors by schema set name without pagination' | schemaSets     | null      | null
            'anchors by schema set name and pagination'     | schemaSets     | 1         | 4
    }
    ...
    def buildAnchorsRequest(endpoint, schemaSetNames, pageIndex, pageSize) {
        ...
        if (schemaSetNames != null)
            requestBuilder.param('schema-set-names', schemaSetNames)
