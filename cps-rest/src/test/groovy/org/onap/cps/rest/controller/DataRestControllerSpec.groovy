...
class DataRestControllerSpec extends Specification {
    ...
    def 'Get delta between anchor and JSON payload using #fetchDescendantsOption'() {
        ...
        and: 'the service returns a list containing delta'
        ...
        def requestBodyJson = '{"some-key":"some-value","categories":[{"books":[{"authors":["Iain M. Banks"]}]}]}'
        mockCpsDataService.getDeltaByDataspaceAnchorAndPayload(dataspaceName, anchorName, xpath, _ as Map<String, String>, expectedJsonData, INCLUDE_ALL_DESCENDANTS) >> deltaReport
