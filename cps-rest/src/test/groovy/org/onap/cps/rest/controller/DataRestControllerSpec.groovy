...
class DataRestControllerSpec extends Specification {
    ...
    def 'Get delta between two anchors'() {
        given: 'the service returns a list containing delta'
            def deltaReport = new DeltaReportBuilder().actionUpdate().withXpath('/bookstore').withSourceData('bookstore-name': 'Easons').withTargetData('bookstore-name': 'Easons').build()
