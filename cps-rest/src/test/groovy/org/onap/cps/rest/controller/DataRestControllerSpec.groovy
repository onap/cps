...
class DataRestControllerSpec extends Specification {
    ...
    def 'Get delta between anchor and JSON payload using #fetchDescendantsOption'() {
        ...
        and: 'the service returns a list containing delta reports'
            mockCpsDataService.getDeltaByDataspaceAnchorAndPayload(dataspaceName, anchorName, xpath, _ as Map<String, String>, _ as String, INCLUDE_ALL_DESCENDANTS) >> [deltaReports]
        when: 'get delta request is performed using REST API'
            def response =
