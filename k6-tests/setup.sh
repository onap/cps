...
docker-compose --progress plain --env-file docker.env -f ../docker-compose/docker-compose.yml --profile dmi-stub pull

echo "Starting docker containers"
docker-compose --progress plain --env-file docker.env -f ../docker-compose/docker-compose.yml --profile dmi-stub up -d
