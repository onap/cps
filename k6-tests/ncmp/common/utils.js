...
export function makeCustomSummaryReport(testResults, scenarioConfig) {
    const summaryCsvLines = [
        ...
        makeSummaryCsvLine('8', 'Write data job scenario - small', 'milliseconds', 'write_small_data_job_duration', 5000, testResults, scenarioConfig),
        makeSummaryCsvLine('9', 'Write data job scenario - large', 'milliseconds', 'write_large_data_job_duration', 10000, testResults, scenarioConfig),
    ];
