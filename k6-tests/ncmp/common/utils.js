...
function recordMetricIfResponseValid(httpResponse, expectedStatusCode, checkLabel, metricRecorder, metricValueExtractor, customValidatorFn = () => ({ valid: true, reason: undefined})) {
    ...
    if (isSuccess) {
        ...
        logDetailedFailure(httpResponse, checkLabel, isExpectedStatusMatches, reason);
    }
}

function logDetailedFailure(httpResponse, checkLabel, isExpectedStatusMatches, customReason = "") {
