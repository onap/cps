...
var ncmpOverheadTrend = new Trend("ncmp_overhead");
...
export default function() {
    ...
    const cmHandleId = 'ch-' + (Math.floor(Math.random() * 20000) + 1);
    const datastoreName = 'ncmp-datastore%3Apassthrough-operational';
    const url = `${BASE_URL}/ncmp/v1/ch/${cmHandleId}/data/ds/${datastoreName}?resourceIdentifier=x&include-descendants=true`
