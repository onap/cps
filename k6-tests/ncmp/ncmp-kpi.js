...
export function data_operation_async_batch_read() {
    /*
        ...
        The 800 batch read requests are being sent every second for 15 minutes.
        Thus, the expected total number of messages to be consumed 720000.
     */
    const TOTAL_MESSAGES_TO_CONSUME = 720000;
    try {
