...
#   2) Injects them into a scenario execution template file (scenario-execution-definition.tmpl)
#   2) Writes a scenario-execution config file (kpi-scenario-execution-definition.json) with thresholds declarations.
#
