...
class QuerySelectWhereUtilSpec extends Specification {

    def 'getQuerySelectWhere with valid inputs: #scenario'() {
        ...
        'select with multiple conditions' | 'field1,field2' | 'field3 = 3 and field4 = 10' | ['field1', 'field2'] | [new QuerySelectWhere.WhereCondition('field3', '=', 3), new QuerySelectWhere.WhereCondition('field4', '=', 10)] | ['and']
        'string with escaped quote' | 'field1'           | "field6 = 'val''ue'"                   | ['field1']           | [new QuerySelectWhere.WhereCondition('field6', '=', "val'ue")]                          | []
    }

    def 'getQuerySelectWhere with invalid inputs: #scenario'() {
        ...
        'invalid syntax'   | 'field1'    | 'field3 == value'
    }
}