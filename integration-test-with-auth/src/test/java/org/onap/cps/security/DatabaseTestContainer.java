...
public class DatabaseTestContainer extends PostgreSQLContainer {
    ...
    /**
     * Starts the database container and sets the database connection system properties.
     */
    @Override
    public void start() {
        super.start();
    ...
    /**
     * Overridden to prevent premature container shutdown; cleanup is handled via terminate() on JVM shutdown.
     */
    @Override
    public void stop() {
