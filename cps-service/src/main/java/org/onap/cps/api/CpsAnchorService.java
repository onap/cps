...
public interface CpsAnchorService {
     ...
     * @return a collection of anchors
     */
    Collection<Anchor> getAnchorsPagination(String dataspaceName, Collection<String> schemaSetNames,
                                            Integer pageIndex, Integer pageSize);

    /**
     * Read all anchors with or without schema sets in given dataspace.
     *
     * @param dataspaceName  dataspaceName
     * @param schemaSetNames schema-set names
     * @return a collection of anchors
     */
    Collection<Anchor> getAnchorsWithOrWithoutSchemaSet(String dataspaceName, Collection<String> schemaSetNames);
}
