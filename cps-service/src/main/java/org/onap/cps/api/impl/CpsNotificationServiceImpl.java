...
public class CpsNotificationServiceImpl implements CpsNotificationService {
    ...
    @Override
    public void updateNotificationSubscription(String dataspaceName, String subscription, List<String> anchors) {
    ...
    @Override
    public boolean isNotificationEnabled(String dataspaceName, String anchorName) {
