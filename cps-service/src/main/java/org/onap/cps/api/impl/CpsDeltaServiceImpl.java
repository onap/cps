...
public class CpsDeltaServiceImpl implements CpsDeltaService {
    ...
    public List<DeltaReport> getDeltaReports(final String xpath, final Collection<DataNode> sourceDataNodes,
        ...
        deltaReports.addAll(getGroupedAddedDeltaReports(sourceDataNodes, targetDataNodes));
        return deltaReports;
    }
    ...
    private static List<DeltaReport> getGroupedUpdatedDeltaReports(final String xpath, final DataNode sourceDataNode,
        ...
        updatedDeltaReportEntries.addAll(getGroupedAddedDeltaReports(sourceDataNode.getChildDataNodes(),
                targetDataNode.getChildDataNodes()));
        return updatedDeltaReportEntries;
    }
    ...
    private static List<DeltaReport> getGroupedAddedDeltaReports(final Collection<DataNode> sourceDataNodes,
            final Collection<DataNode> targetDataNodes) {
        ...
        if (!jsonDataAdded.isEmpty()) {
            ...
            final DeltaReport deltaReport = new DeltaReportBuilder().actionCreate().withXpath(normalizedXpath)
