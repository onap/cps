...
public interface CpsQueryService {
    ...
    int NO_LIMIT = 0;
    int SKIP_LEAF_CONDITION_VALIDATION = -1;
     ...
     * @param numberOfConditions         expected number of leaf conditions in the cps path, or -1 to skip validation
     * @return a collection of data objects of an expected type
     * @throws DataValidationException if numberOfConditions is not -1 and the actual count does not match
     */
     ...
     */
    Collection<DataNode> compositeQueryDataNodes(String dataspaceName, String anchorName,
