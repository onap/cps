...
public interface CpsDataService {
     ...
     * @param observedTimestamp observedTimestamp
     * @param contentType       JSON/XML content type
     * @return                  true if the data was newly created, false if existing data was replaced
     */
    Action updateDataNodeAndDescendants(String dataspaceName, String anchorName, String parentNodeXpath,
