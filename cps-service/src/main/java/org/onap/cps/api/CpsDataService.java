...
public interface CpsDataService {
     ...
     * @param observedTimestamp observedTimestamp
     */
    void saveListElementsCollection(String dataspaceName, String anchorName, String parentNodeXpath,
            List<String> jsonDataList, OffsetDateTime observedTimestamp);
