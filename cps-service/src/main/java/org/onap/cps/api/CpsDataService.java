...
public interface CpsDataService {
     ...
     * @param observedTimestamp observedTimestamp
     */
    void saveListElementsData(@NonNull String dataspaceName, @NonNull String anchorName,
    ...
    /**
     * Deletes (if exists) a list or a list-element under given anchor and dataspace.
     *
     * @param dataspaceName dataspace name
     * @param anchorName    anchor name
     ...
     * @param observedTimestamp observedTimestamp
     */
    void deleteListOrElement(@NonNull String dataspaceName, @NonNull String anchorName,
