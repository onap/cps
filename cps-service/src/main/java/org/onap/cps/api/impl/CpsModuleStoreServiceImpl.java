...
@Component("CpsModuleStoreServiceImpl")
public class CpsModuleStoreServiceImpl implements CpsModuleStoreService {

    @Autowired
    private CpsModuleStorePersistenceService cpsModuleStorePersistenceService;
    ...
    public void storeSchemaContext(SchemaContext schemaContext, String dataspaceName) {
        for (final Module module : schemaContext.getModules()) {
            ...
            cpsModuleStorePersistenceService.storeModule(module.getNamespace().toString(), module.toString(),
