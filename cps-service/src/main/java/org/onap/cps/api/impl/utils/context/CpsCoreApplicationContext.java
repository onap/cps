...
package org.onap.cps.api.impl.utils.context;
...
@Component
public class CpsCoreApplicationContext implements ApplicationContextAware {
    ...
    private static synchronized void setCpsApplicationContext(final ApplicationContext cpsApplicationContext) {
        CpsCoreApplicationContext.applicationContext = cpsApplicationContext;
    }
}