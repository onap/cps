...
public interface DataNodeBuilderService {
     ...
     */
    Collection<DataNode> buildDataNodesWithAnchorAndXpathToNodeData(Anchor anchor,
                                                                    Map<String, String> nodesData,
                                                                    ContentType contentType);

    /**
     * Build data nodes using an anchor, xpath, and JSON/XML string.
     *
     * @param anchor        name of Anchor sharing same schema structure as the JSON/XML string
     ...
     * @return              a collection of {@link DataNode}
     */
    Collection<DataNode> buildDataNodesWithAnchorXpathAndNodeData(Anchor anchor, String xpath,
                                                                  String nodeData, ContentType contentType);

    /**
     * Build data nodes using an anchor, parent data node xpath, and JSON/XML string.
     *
     * @param anchor            name of Anchor sharing same schema structure as the JSON/XML string
     ...
     * @return                  a collection of {@link DataNode}
     */
    Collection<DataNode> buildDataNodesWithAnchorParentXpathAndNodeData(Anchor anchor,
                                                                        String parentNodeXpath,
                                                                        String nodeData,
                                                                        ContentType contentType);

    /**
     * Build data nodes using a map of YANG resource name to content, xpath, and JSON/XML string.
     *
