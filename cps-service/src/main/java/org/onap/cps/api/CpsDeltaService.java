...
public interface CpsDeltaService {
     ...
     * @param targetDataNode   collection of {@link DataNode} as target data for delta generation
     * @return                 list od {@link DeltaReport} containing delta information
     */
    List<DeltaReport> getDeltaReport(Collection<DataNode> sourceDataNodes,
                                     Collection<DataNode> targetDataNode);
}
