...
public class CpsModuleServiceImpl implements CpsModuleService {
    ...
    @Autowired
    private YangTextSchemaSourceCache yangTextSchemaSourceCache;
    ...
    public void createSchemaSet(final String dataspaceName, final String schemaSetName,
        ...
        yangTextSchemaSourceCache.updateCache(dataspaceName, schemaSetName, yangTextSchemaSourceSet);
    }

    @Override
    public SchemaSet getSchemaSet(final String dataspaceName, final String schemaSetName) {
        final YangTextSchemaSourceSet yangTextSchemaSourceSet = yangTextSchemaSourceCache
