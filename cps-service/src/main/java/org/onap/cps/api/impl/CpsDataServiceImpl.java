...
public class CpsDataServiceImpl implements CpsDataService {
    ...
    @Override
    public void validateData(final String dataspaceName, final String anchorName,
                                        final String parentNodeXpath, final String nodeData,
                                        final ContentType contentType) {

        final Anchor anchor = cpsAnchorService.getAnchor(dataspaceName, anchorName);
        if (ROOT_NODE_XPATH.equals(parentNodeXpath)) {
            yangParser.parseAndValidateData(anchor, PARENT_NODE_XPATH_FOR_ROOT_NODE_XPATH, nodeData, contentType);
        } else {
            final String normalizedParentNodeXpath = CpsPathUtil.getNormalizedXpath(parentNodeXpath);
            yangParser.parseAndValidateData(anchor, normalizedParentNodeXpath, nodeData, contentType);
        }
    }
