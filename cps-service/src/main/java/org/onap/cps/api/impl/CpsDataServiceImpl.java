...
public class CpsDataServiceImpl implements CpsDataService {
    ...
    private static final Anchor NULL_ANCHOR = null;
    ...
    public void saveData(final String dataspaceName, final String anchorName, final String jsonData,
        ...
        processDataUpdatedEventAsync(dataspaceName, anchorName, NULL_ANCHOR, observedTimestamp, ROOT_NODE_XPATH,
                CREATE);
    }
    ...
    public void saveData(final String dataspaceName, final String anchorName, final String parentNodeXpath,
        ...
        processDataUpdatedEventAsync(dataspaceName, anchorName, NULL_ANCHOR, observedTimestamp, parentNodeXpath,
                CREATE);
    }
    ...
    public void deleteDataNode(final String dataspaceName, final String anchorName, final String dataNodeXpath,
        ...
        processDataUpdatedEventAsync(dataspaceName, anchorName, NULL_ANCHOR, observedTimestamp, dataNodeXpath, DELETE);
    }
    ...
    public void deleteDataNodes(final String dataspaceName, final String anchorName,
        ...
        processDataUpdatedEventAsync(dataspaceName, anchorName, anchor, observedTimestamp, ROOT_NODE_XPATH, DELETE);
    }
    ...
    public void deleteListOrListElement(final String dataspaceName, final String anchorName, final String listNodeXpath,
        ...
        processDataUpdatedEventAsync(dataspaceName, anchorName, NULL_ANCHOR, observedTimestamp, listNodeXpath, DELETE);
    }
    ...
    private void processDataUpdatedEventAsync(final String dataspaceName, final String anchorName, final Anchor anchor,
            final OffsetDateTime observedTimestamp, final String xpath,
            final Operation operation) {
        try {
            notificationService.processDataUpdatedEvent(dataspaceName, anchorName, anchor, observedTimestamp, xpath,
                    operation);
