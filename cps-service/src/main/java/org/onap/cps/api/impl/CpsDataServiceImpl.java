...
public class CpsDataServiceImpl implements CpsDataService {
    ...
    private Collection<DataNode> rebuildDataNodes(final Anchor sourceAnchor, final String xpath,
        ...
        final String sourceDataAsJsonString = jsonObjectMapper.asJsonString(mergedDataMap);
        return buildDataNodesWithXpath(sourceAnchor, xpath, sourceDataAsJsonString, ContentType.JSON);
    }
    ...
    private Collection<DataNode> buildDataNodesWithXpath(final Anchor sourceAnchor, final String xpath,
        ...
        if (!isRootNodeXpath(xpath)) {
            ...
            if (parentNodeXpath.isEmpty()) {
                return buildDataNodes(sourceAnchor, ROOT_NODE_XPATH, jsonPayload, contentType);
            }
            return buildDataNodes(sourceAnchor, parentNodeXpath, jsonPayload, contentType);
        }
        return buildDataNodes(sourceAnchor, xpath, jsonPayload, contentType);
    }
