...
public class CpsDataServiceImpl implements CpsDataService {
    ...
    public List<DeltaReport> getDeltaByDataspaceAnchorAndPayload(final String dataspaceName,
        ...
        final Collection<DataNode> dataNodesFromSourceAnchor = getDataNodes(dataspaceName,
    ...
    private Collection<DataNode> rebuildDataNodes(final Anchor sourceAnchor, final String xpath,
        ...
        return buildDataNodesWithXpath(sourceAnchor, xpath, sourceDataAsJsonObjectString, ContentType.JSON);
    }

    private Collection<DataNode> buildDataNodesWithXpath(final Anchor sourceAnchor, final String xpath,
                                                         final String sourceDataAsJsonObjectString,
                                                         final ContentType contentType) {
        ...
        if (!isRootNodeXpath(xpath)) {
            ...
            if (parentNodeXpath.isEmpty()) {
                return buildDataNodes(sourceAnchor, ROOT_NODE_XPATH, sourceDataAsJsonObjectString, contentType);
            }
            return buildDataNodes(sourceAnchor, parentNodeXpath, sourceDataAsJsonObjectString, contentType);
        }
        return buildDataNodes(sourceAnchor, xpath, sourceDataAsJsonObjectString, contentType);
    }
