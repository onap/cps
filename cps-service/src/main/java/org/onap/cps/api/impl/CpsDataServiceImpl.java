...
public class CpsDataServiceImpl implements CpsDataService {
    ...
    private final CpsDataUpdateEventsService dataUpdateEventsService;
    ...
    private void sendDataUpdatedEvent(final Anchor anchor, final String xpath,
        ...
        try {
            dataUpdateEventsService.publishCpsDataUpdateEvent(anchor, xpath, operation, observedTimestamp);
