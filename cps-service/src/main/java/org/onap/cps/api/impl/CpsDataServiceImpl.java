...
public class CpsDataServiceImpl implements CpsDataService {
    ...
    public void saveData(final String dataspaceName, final String anchorName, final String jsonData,
        ...
        final Collection<DataNode> dataNodes = buildDataNodesWithCollection(dataspaceName, anchorName, ROOT_NODE_XPATH, jsonData);
    ...
    public void saveData(final String dataspaceName, final String anchorName, final String parentNodeXpath,
        ...
        CpsValidator.validateNameCharacters(dataspaceName, anchorName);
        final Collection<DataNode> dataNodes = buildDataNodesWithCollection(dataspaceName, anchorName, parentNodeXpath, jsonData);
        for (DataNode dataNode: dataNodes) {
    ...
    public void saveListElements(final String dataspaceName, final String anchorName,
        ...
        final Collection<DataNode> listElementDataNodeCollection =
            buildDataNodesWithCollection(dataspaceName, anchorName, parentNodeXpath, jsonData);
    ...
    public void updateNodeLeavesAndExistingDescendantLeaves(final String dataspaceName, final String anchorName,
        ...
        final Collection<DataNode> dataNodeUpdates =
            buildDataNodesWithCollection(dataspaceName, anchorName,
    ...
    private DataNode buildDataNode(final String dataspaceName, final String anchorName,
        ...
        if (ROOT_NODE_XPATH.equals(parentNodeXpath)) {
            final Collection<DataContainerChild<? extends YangInstanceIdentifier.PathArgument, ?>> normalizedNode = YangUtils.parseJsonData(jsonData, schemaContext);
            return new DataNodeBuilder().withNormalizedNodeCollection(normalizedNode).build();
        }

        final Collection<DataContainerChild<? extends YangInstanceIdentifier.PathArgument, ?>> normalizedNode = YangUtils.parseJsonData(jsonData, schemaContext, parentNodeXpath);
    ...
    private Collection<DataNode> buildDataNodesWithCollection(final String dataspaceName,
        ...
        if (ROOT_NODE_XPATH.equals(parentNodeXpath)) {
            final Collection<DataContainerChild<? extends YangInstanceIdentifier.PathArgument, ?>> dataContainerChildren = YangUtils.parseJsonData(jsonData, schemaContext);
        ...
        final Collection<DataContainerChild<? extends YangInstanceIdentifier.PathArgument, ?>> dataContainerChildren = YangUtils.parseJsonData(jsonData, schemaContext, parentNodeXpath);
        final Collection<DataNode> dataNodes = new DataNodeBuilder()
            .withParentNodeXpath(parentNodeXpath)
            .withNormalizedNodeCollection(dataContainerChildren)
            .buildCollection();
    ...
    private Collection<Collection<DataNode>> buildDataNodes(final String dataspaceName, final String anchorName,
        ...
        return jsonDataList.stream()
                .map(jsonData -> buildDataNodesWithCollection(dataspaceName, anchorName, parentNodeXpath, jsonData))
