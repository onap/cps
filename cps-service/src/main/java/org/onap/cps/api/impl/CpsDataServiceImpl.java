...
public class CpsDataServiceImpl implements CpsDataService {
    ...
    @Override
    public void saveListsElements(final String dataspaceName, final String anchorName, final String parentNodeXpath,
            final List<String> jsonDataList, final OffsetDateTime observedTimestamp) {
        CpsValidator.validateNameCharacters(dataspaceName, anchorName);
