...
import static org.onap.cps.notification.updatedevents.Operation.CREATE;
import static org.onap.cps.notification.updatedevents.Operation.DELETE;
import static org.onap.cps.notification.updatedevents.Operation.UPDATE;
...
public class CpsDataServiceImpl implements CpsDataService {
    ...
    private final CpsUpdatedEventNotificationService cpsUpdatedEventNotificationService;
    ...
    private void processDataUpdatedEventAsync(final Anchor anchor,
        ...
        final OffsetDateTime observedTimestamp) {
        try {
            cpsUpdatedEventNotificationService.processDataUpdatedEvent(anchor, observedTimestamp, xpath,
                operation);
