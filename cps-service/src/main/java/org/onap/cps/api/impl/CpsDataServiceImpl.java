...
public class CpsDataServiceImpl implements CpsDataService {
    ...
    public void validateData(final String dataspaceName, final String anchorName, final String parentNodeXpath,
        ...
        final Anchor anchor = cpsAnchorService.getAnchor(dataspaceName, anchorName);
        final String xpathToUse = ROOT_NODE_XPATH.equals(parentNodeXpath) ? PARENT_NODE_XPATH_FOR_ROOT_NODE_XPATH :
                CpsPathUtil.getNormalizedXpath(parentNodeXpath);
        yangParser.parseData(anchor, xpathToUse, nodeData, contentType);
    }
