...
public interface CpsModuleService {
     ...
     * @param dataspaceName dataspace name
     * @param anchorName    anchor name
     * @return a collection of module definition (moduleName, revision, yang resource content)
     */
    Collection<ModuleDefinition> getModuleDefinitionsByCmHandle(String dataspaceName, String anchorName);
