...
public final class YangTextSchemaSourceSetBuilder {
    ...
    private static class YangTextSchemaSourceSetImpl implements YangTextSchemaSourceSet {
        ...
        @Override
        public List<ModuleRef> getModulesRef() {
            return schemaContext.getModules().stream()
                           .map(YangTextSchemaSourceSetImpl::toModuleRef)
                           .collect(Collectors.toList());
        }

        private static ModuleRef toModuleRef(final Module module) {
            return ModuleRef.builder()
     ...
     * @return the SchemaContext context
     */
