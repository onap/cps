...
/**
 * Class responsible to handle errors for async request response events.
 */
@Component
@Slf4j
class CpsAsyncRequestResponseEventErrorHandler implements KafkaListenerErrorHandler {
