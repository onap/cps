...
import org.onap.cps.event.model.ResponseOriginData;
...
public class CpsAsyncRequestResponseEventUtil {
    ...
    public CpsAsyncRequestResponseEventWithOrigin toCpsAsyncRequestResponseEventWithOrigin(
        ...
        cpsAsyncRequestResponseEventWithOrigin.setEvent(getEventOriginContent(cpsAsyncRequestResponseEvent));
    ...
    private EventOrigin getEventOrigin(final CpsAsyncRequestResponseEvent cpsAsyncRequestResponseEvent) {
        ...
        eventOrigin.setEventCorrelationId(
            cpsAsyncRequestResponseEvent.getEventCorrelationId());
    ...
    private EventOriginContent getEventOriginContent(final CpsAsyncRequestResponseEvent cpsAsyncRequestResponseEvent) {
        ...
        eventOriginContent.setResponseStatus(cpsAsyncRequestResponseEvent.getEvent().getResponseCode());
        eventOriginContent.setResponseDataSchema(cpsAsyncRequestResponseEvent.getEvent().getResponseCode());

        final ResponseOriginData responseOriginData = new ResponseOriginData();
