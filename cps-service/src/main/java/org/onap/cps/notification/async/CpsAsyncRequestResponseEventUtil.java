...
public class CpsAsyncRequestResponseEventUtil {
    ...
    private EventOriginContent getReceivedEvent(final CpsAsyncRequestResponseEvent receivedAsyncEvent) {
        ...
        setOriginData(receivedAsyncEvent, outgoingAsyncRequestEventOriginContent);
        return outgoingAsyncRequestEventOriginContent;
    }

    private void setOriginData(final CpsAsyncRequestResponseEvent receivedAsyncEvent,
                               final EventOriginContent eventOriginContent) {
        final OriginResponseData outgoingAsyncRequestResponseOriginData = new OriginResponseData();
        outgoingAsyncRequestResponseOriginData.setAdditionalProperty(DATA, getOriginData(receivedAsyncEvent));
        eventOriginContent.setResponseOriginData(outgoingAsyncRequestResponseOriginData);
    }
