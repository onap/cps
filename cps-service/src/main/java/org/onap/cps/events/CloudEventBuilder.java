...
import org.onap.cps.api.impl.utils.EventDateTimeFormatter;
import org.onap.cps.api.impl.utils.context.CpsCoreApplicationContext;
...
public class CloudEventBuilder {
    ...
    public CloudEvent build() {
        final JsonObjectMapper jsonObjectMapper = CpsCoreApplicationContext.getCpsBean(JsonObjectMapper.class);
        final io.cloudevents.core.builder.CloudEventBuilder cloudEventBuilder = io.cloudevents.core.builder
                ...
                .withTime(EventDateTimeFormatter.toIsoOffsetDateTime(EventDateTimeFormatter
