...
public class CpsExceptionBuilder {
    ...
    private static final String SCHEMASET_IS_INVALID = "SchemaSet is invalid.";
     ...
     */
    public static CpsException invalidSchemaSetException(String dataspaceName, String moduleSetName) {
        return new CpsValidationException(SCHEMASET_IS_INVALID,
            String.format("SchemaSet with name %s was not found for dataspace %s.", moduleSetName, dataspaceName));
    }
    ...
    public static CpsException emptySchemaSetException() {
        return new CpsValidationException(SCHEMASET_IS_INVALID, "SchemaSet has no YANG files to persist");
    }
     ...
     */
    public static CpsException duplicateSchemaSetException(String dataspaceName, String schemaSetName) {
        return new CpsValidationException(SCHEMASET_IS_INVALID,
            String.format("SchemaSet with name %s already exists for dataspace %s.", schemaSetName, dataspaceName));
    }
     ...
     * @param schemaSetName schemaset name
     */
    public static CpsException schemaSetNotFoundException(String dataspaceName, String schemaSetName) {
        return new CpsNotFoundException("SchemaSet was not found.",
            String.format("SchemaSet with name %s was not found for dataspace %s.", schemaSetName, dataspaceName));
    }
