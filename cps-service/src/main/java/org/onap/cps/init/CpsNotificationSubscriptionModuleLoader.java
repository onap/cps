...
public class CpsNotificationSubscriptionModuleLoader extends AbstractCpsModuleLoader {
    ...
    public CpsNotificationSubscriptionModuleLoader(final CpsDataspaceService cpsDataspaceService,
    ...
    private void createInitialSubscription(final String dataspaceName, final String anchorName) {
        ...
        Optional.ofNullable(dataSpaces).ifPresent(dsList -> dsList.forEach(dataspace ->
                subscribeNotificationForDataspace(dataspace)));
    }

    private void subscribeNotificationForDataspace(final Dataspace ds) {
