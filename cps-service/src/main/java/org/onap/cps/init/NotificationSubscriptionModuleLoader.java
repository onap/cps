...
@Slf4j
@Service
public class NotificationSubscriptionModuleLoader extends AbstractModuleLoader {

    public NotificationSubscriptionModuleLoader(final CpsDataspaceService cpsDataspaceService,
