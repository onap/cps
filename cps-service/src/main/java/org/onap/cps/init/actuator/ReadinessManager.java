...
public class ReadinessManager {
    ...
    public void registerProcess(final String processName) {
        startupProcesses.add(processName);
    }

    public void markProcessComplete(final String processName) {
        startupProcesses.remove(processName);
    }
