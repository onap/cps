...
public class CompletionExceptionUtils {
     ...
     */
    public static RuntimeException handleCompletionException(final CompletionException completionException,
                                                             final String errorMessage,
                                                             final String errorDetails) {
        if (completionException.getCause() instanceof RuntimeException runtimeException) {
            throw runtimeException;
        }
        throw new CpsException(errorMessage, errorDetails, completionException.getCause());
    }
}
