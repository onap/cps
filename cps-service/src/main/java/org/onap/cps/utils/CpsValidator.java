...
public final class CpsValidator {
    ...
    private static final String UNSUPPORTED_NAME_CHARACTERS = "!“” #$%&‘()*+,./\\:;<=>?@[]^`{|}~";
    ...
    public static void validateNameCharacters(final String... names) {
        for (final String name : names) {
            ...
            for (final char unsupportedCharacter : UNSUPPORTED_NAME_CHARACTERS.toCharArray()) {
