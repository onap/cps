...
public class DataMapUtils {
     ...
     * @param prefixResolver  PrefixResolver.
     * @return a map representing the hierarchical structure of data nodes.
     */
    public static Map<String, Object> listDataNodes(final Collection<DataNode> dataNodes, final Anchor anchor,
                                                     final PrefixResolver prefixResolver) {
        final Map<String, List<Map<String, Object>>> groupedLists = new LinkedHashMap<>();
        for (final DataNode dataNode : dataNodes) {
            final String parentNodeName = getParentNodeName(dataNode.getXpath(), anchor, prefixResolver);
    ...
    private static String getParentNodeName(final String xpath, final Anchor anchor,
                                            final PrefixResolver prefixResolver) {

        final String prefix = prefixResolver.getPrefix(anchor, xpath);
        final String nodeIdentifier = getNodeIdentifier(xpath);
        return (prefix != null ? prefix + ":" : "") + nodeIdentifier;
    }
