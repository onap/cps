...
public class DataMapUtils {
    ...
    public static Map<String, Object> toDataMap(final DataNode dataNode) {
        return ImmutableMap.of(getNodeIdentifier(dataNode.getXpath()), buildDataMap(dataNode));
    }

    private static Map<String, Object> buildDataMap(final DataNode dataNode) {
            ...
            .putAll(
                dataNodes.stream()
                    ...
                    .collect(groupingBy(
                        ...
                        mapping(DataMapUtils::buildDataMap, toUnmodifiableList())
                    ))
            ).build();
    }
