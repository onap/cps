...
public class ApplyDeltaReport {
     ...
     * @param deltaReportString the delta report as a JSON string
     */
    @Transactional
    public void applyDeltaOnAnchor(final String dataspaceName, final String anchorName, final String deltaReportString) {
        ...
        for (final DeltaReport deltaReport: deltaReports) {
            ...
            if (action.equals(DeltaReport.REPLACE_ACTION)) {
                ...
                updateDataNodesUsingDelta(dataspaceName, anchorName, xpath, dataForUpdate);
                ...
                final String dataToAdd = jsonObjectMapper.asJsonString(deltaReport.getTargetData());
                addDataNodesUsingDelta(dataspaceName, anchorName, xpath, dataToAdd);
            }
        }
    }
