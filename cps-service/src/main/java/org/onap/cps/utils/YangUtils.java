...
public class YangUtils {
     ...
     */
    public DataNode createDataNodeTreeFromNormalizedNode(final NormalizedNode<? extends PathArgument, ?> tree) {
        final String xpath = buildXpathId(tree.getIdentifier());
        final DataNode parentDataNode = CpsDataNodeBuilder.createDataNode(xpath);
        createDataNodeTreeFromNormalizedNode(parentDataNode, tree);
        return parentDataNode;
    }

    private void createDataNodeTreeFromNormalizedNode(final DataNode currentDataNode,
    ...
    private void inspectLeaf(final DataNode currentDataNode, final ValueNode valueNode) {
        final Object value = valueNode.getValue();
        cpsDataNodeBuilder.addLeafValue(valueNode.getNodeType().getLocalName(), value);
    }

    private void inspectLeafList(final DataNode currentDataNode, final LeafSetNode leafSetNode) {
        cpsDataNodeBuilder.addLeafListName(leafSetNode.getNodeType().getLocalName());
    ...
    private void inspectContainer(final DataNode currentDataNode, final DataContainerNode dataContainerNode) {
    ...
    private void inspectKeyedList(final DataNode currentDataNode, final MapNode mapNode) {
     ...
     */
    private void createNodeForEachListElement(final DataNode currentDataNode, final MapNode mapNode) {
