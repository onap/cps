...
public class YangParserHelper {
    ...
    public ContainerNode parseData(final ContentType contentType,
        ...
        return buildContainerNodeForXmlData(normalizedNodeResult);
    }
    ...
    private ContainerNode buildContainerNodeForXmlData(final NormalizedNodeResult normalizedNodeResult) {
