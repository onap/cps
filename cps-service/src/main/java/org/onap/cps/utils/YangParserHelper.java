...
public class YangParserHelper {
    ...
    public ContainerNode parseData(final ContentType contentType,
        ...
        return buildContainerNodeForXmlData(nodeData, schemaContext, parentNodeXpath);
    }
    ...
    private ContainerNode buildContainerNodeForXmlData(final String xmlData, final SchemaContext schemaContext,
                                                       final String parentNodeXpath) {
        final NormalizedNodeResult normalizedNodeResult = parseXmlData(xmlData, schemaContext, parentNodeXpath);
