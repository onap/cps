...
public class YangParserHelper {
    ...
    public ContainerNode parseData(final ContentType contentType,
        ...
        return parseXmlDataToContainerNode(nodeData, schemaContext, parentNodeXpath);
    }
    ...
    private ContainerNode parseXmlDataToContainerNode(final String xmlData, final SchemaContext schemaContext,
                                                       final String parentNodeXpath) {
