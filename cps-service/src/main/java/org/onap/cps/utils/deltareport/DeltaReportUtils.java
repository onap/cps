...
public final class DeltaReportUtils {
    /**
    ...
    public static String buildXml(final List<DeltaReport> deltaReports) {
        try {
            return XML_MAPPER
                    .writer()
                    .withRootName("deltaReports")
                    .writeValueAsString(new DeltaReportWrapper(deltaReports));
        } catch (final DOMException | NullPointerException | JsonProcessingException
                exception) {
