...
public class DataNodeBuilder {
     ...
     * @return this {@link DataNodeBuilder} object
     */
    public DataNodeBuilder withNormalizedNodeCollection(final Collection<DataContainerChild<? extends YangInstanceIdentifier.PathArgument, ?>> dataContainerChildren) {
    ...
    private Collection<DataNode> buildCollectionFromNormalizedNodeTree() {
        ...
        for (NormalizedNode normalizedNode: normalizedNodeCollection) {
