...
@Slf4j
public class DeltaReportCustomBuilder {
    ...
    public DeltaReportCustomBuilder withXpath(final String xpath) {
        this.xpath = xpath;
        return this;
    }

    public DeltaReportCustomBuilder withSourceData(final Map<String, Serializable> sourceData) {
        this.sourceData = sourceData;
        return this;
    }

    public DeltaReportCustomBuilder withTargetData(final Map<String, Serializable> targetData) {
        this.targetData = targetData;
        return this;
    }

    public DeltaReportCustomBuilder actionAdd() {
        this.action = DeltaReport.ADD_ACTION;
        return this;
    }

    public DeltaReportCustomBuilder actionRemove() {
        this.action = DeltaReport.REMOVE_ACTION;
        return this;
    }

    public DeltaReportCustomBuilder actionUpdate() {
