...
public interface ModelPersistenceService {
     ...
     *
     * @param moduleSet the data descriptor including dataspace name, moduleset name and modules descriptors
     */
    void storeModuleSet(ModuleSetDescriptor moduleSet);
     ...
     * @param moduleSetName the moduleset name
     */
    ModuleSetDescriptor getModuleSet(String dataspaceName, String moduleSetName);
     ...
     * @param dataspaceName the dataspace name
     */
    List<ModuleSetDescriptor> getAllModuleSets(String dataspaceName);
}
