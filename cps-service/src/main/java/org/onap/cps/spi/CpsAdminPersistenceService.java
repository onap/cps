...
public interface CpsAdminPersistenceService {
    ...
    /**
     * Read all anchors associated with the given schema-set in the given dataspace with pagination.
     *
     * @param dataspaceName  dataspace name
     * @param schemaSetName schema-set name
     * @param paginationOption pagination Option
     ...
     */
    int countAnchorsBySchemaSetName(String dataspaceName, String schemaSetName);
