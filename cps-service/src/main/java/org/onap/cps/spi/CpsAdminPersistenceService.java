...
public interface CpsAdminPersistenceService {
    ...
    /**
     * Read anchors from a dataspace. Anchors can be filtered using schema set name and paginated.
     *
     * @param dataspaceName dataspace name
     ...
     * @return a collection of anchors
     */
    Collection<Anchor> getAnchors(String dataspaceName, final Collection<String> schemaSetNames,
