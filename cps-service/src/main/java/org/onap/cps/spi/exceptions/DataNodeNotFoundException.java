...
public class DataNodeNotFoundException extends DataValidationException {
     ...
     */
    public DataNodeNotFoundException(final String dataspaceName, final String xpath) {
        super("DataNode not found", String
            .format("DataNode with xpath %s was not found for dataspace %s.", xpath, dataspaceName));
    }
}
