...
public interface CpsDataPersistenceService {
    ...
    /**
     * Retrieves multiple datanodes over multiple XPaths for given dataspace and anchor. This is only being used by
     * internally by NCMP to get data nodes over multiple xPaths.
     *
     * @param dataspaceName           dataspace name
     * @param anchorName              anchor name
