...
public class CpsNotificationServiceImpl implements CpsNotificationService {
    ...
    private static final String DATASPACE_SUBSCRIPTION_XPATH = "/dataspaces/dataspace[@name='%s']";
    private static final String ANCHORS_SUBSCRIPTION_XPATH = "/dataspaces/dataspace[@name='%s']/anchors";
    private static final String ANCHOR_SUBSCRIPTION_XPATH =
    ...
    private boolean isNotificationEnabledForAnchor(final String dataspaceName, final String anchorName) {
        final String xpath = String.format(ANCHOR_SUBSCRIPTION_XPATH, dataspaceName, anchorName);
    ...
    private boolean isNotificationEnabledForAllAnchors(final String dataspaceName) {
        final String xpath = String.format(DATASPACE_SUBSCRIPTION_XPATH, dataspaceName);
    ...
    private boolean isAnyAnchorEnabledInDataspace(final String dataspaceName) {
        final String xpathForAnchors = String.format(ANCHORS_SUBSCRIPTION_XPATH, dataspaceName);
