...
public class DataNodeBuilderServiceImpl implements DataNodeBuilderService {
     ...
     */
    @Override
    public Collection<DataNode> buildDataNodesWithAnchorParentXpathAndNodeData(final Anchor anchor, final String parentNodeXpath,
    ...
    public Collection<DataNode> buildDataNodesWithAnchorXpathAndNodeData(final Anchor anchor, final String xpath,
        ...
        if (!isRootNodeXpath(xpath)) {
            ...
            if (parentNodeXpath.isEmpty()) {
                return buildDataNodesWithAnchorParentXpathAndNodeData(anchor, ROOT_NODE_XPATH, nodeData, contentType);
            }
    ...
    public Collection<DataNode> buildDataNodesWithYangResourceXpathAndNodeData(
        ...
        if (!isRootNodeXpath(xpath)) {
            final String parentNodeXpath = CpsPathUtil.getNormalizedParentXpath(xpath);
            if (parentNodeXpath.isEmpty()) {
                return buildDataNodesWithYangResourceParentNodeXpathAndNodeData(yangResourcesNameToContentMap, ROOT_NODE_XPATH,
                        nodeData, contentType);
            }
            return buildDataNodesWithYangResourceParentNodeXpathAndNodeData(yangResourcesNameToContentMap, parentNodeXpath,
                    nodeData, contentType);
        }
        return buildDataNodesWithYangResourceParentNodeXpathAndNodeData(yangResourcesNameToContentMap, xpath, nodeData, contentType);
    }
