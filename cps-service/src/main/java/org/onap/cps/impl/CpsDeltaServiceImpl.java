...
public class CpsDeltaServiceImpl implements CpsDeltaService {
    ...
    public List<DeltaReport> getDeltaByDataspaceAndAnchors(final String dataspaceName,
        ...
        final Collection<DataNode> targetDataNodes = cpsDataPersistenceService.getDataNodesForMultipleXpaths(
            dataspaceName, targetAnchorName, Collections.singletonList(xpath), fetchDescendantsOption);
