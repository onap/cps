    ...
    private Collection<DataNode> rebuildSourceDataNodes(final String xpath,
        ...
        if (sourceDataNodes != null) {
            ...
            if (XML.equals(contentType)) {
                final String sourceDataNodesAsJson = xmlObjectMapper.convertXmlNodeToString(sourceDataNodesAsMap);
                final Collection<DataNode> dataNodes = dataNodeFactory
                        .createDataNodesWithAnchorXpathAndNodeData(sourceAnchor, xpath, sourceDataNodesAsJson, XML);
        ...
        if (XML.equals(contentType)) {
            if (yangResourceContentPerName.isEmpty()) {
                return dataNodeFactory
                    .createDataNodesWithAnchorXpathAndNodeData(sourceAnchor, xpath, targetData, XML);
            }else { return dataNodeFactory
                    .createDataNodesWithYangResourceXpathAndNodeData
                            (yangResourceContentPerName, xpath, targetData, XML);
            }}else{
            if (yangResourceContentPerName.isEmpty()) {
                return dataNodeFactory
