...
public class CpsAnchorServiceImpl implements CpsAnchorService {
    ...
    private Collection<Anchor> getAnchors(final String dataspaceName, final PaginationOption paginationOption) {
        ...
        return cpsAdminPersistenceService.getAnchors(dataspaceName, null, paginationOption);
    }
    ...
    public Collection<Anchor> getAnchors(final String dataspaceName,
        ...
        return getAnchorsBySchemaSetNames(dataspaceName, List.of(schemaSetNames.split(",")), paginationOption);
    }
