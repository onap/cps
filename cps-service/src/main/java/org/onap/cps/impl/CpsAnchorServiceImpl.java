...
public class CpsAnchorServiceImpl implements CpsAnchorService {
    ...
    @Override
    public Collection<Anchor> getAnchorsPagination(final String dataspaceName,
                                                   final String schemaSetNames,
        ...
        if (StringUtils.isEmpty(schemaSetNames)) {
            return getAnchors(dataspaceName, paginationOption);
        }
        final List<String> listOfSchemaSetNames = List.of(schemaSetNames.split(","));
        return getAnchorsBySchemaSetNames(dataspaceName, listOfSchemaSetNames, paginationOption);
    }

    @Override
    public Collection<Anchor> getAnchorsWithOrWithoutSchemaSet(final String dataspaceName,
                                                               final String schemaSetNames) {
        if (StringUtils.isEmpty(schemaSetNames)) {
            return getAnchors(dataspaceName);
        }
        final List<String> listOfSchemaSetNames = List.of(schemaSetNames.split(","));
        return getAnchorsBySchemaSetNames(dataspaceName, listOfSchemaSetNames);
    }
}
