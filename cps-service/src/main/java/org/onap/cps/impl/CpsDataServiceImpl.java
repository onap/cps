...
public class CpsDataServiceImpl implements CpsDataService {
    ...
    public void updateNodeLeavesAndExistingDescendantLeaves(final String dataspaceName,
        ...
        sendDataUpdatedEvent(anchor, parentNodeXpath, REPLACE_ACTION, Collections.emptyList(), observedTimestamp);
    }
    ...
    public void deleteListOrListElement(final String dataspaceName, final String anchorName, final String listNodeXpath,
        ...
        final Anchor anchor = cpsAnchorService.getAnchor(dataspaceName, anchorName);
        sendDataUpdatedEvent(anchor, listNodeXpath, REMOVE_ACTION, Collections.emptyList(), observedTimestamp);
    }
