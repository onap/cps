...
public class CpsDataServiceImpl implements CpsDataService {
    ...
    public void updateDataNodesAndDescendants(final String dataspaceName, final String anchorName,
        ...
        if (deltaNotificationEnabled) {
            nodeDataPerParentNodeXPath.forEach((nodeXpath, nodeData) ->
            {
                final String xpath = nodeXpathToDataNodeMap.get(nodeXpath).getXpath();
    ...
    private void sendDataUpdatedEvent(final Anchor anchor, final String xpath, final List<DeltaReport> deltaReports,
        ...
        try {
            cpsDataUpdateEventsProducer.sendCpsDataUpdateEvent(anchor, deltaReports, xpath, operation, observedTimestamp);
    ...
    private List<DeltaReport> generateDeltaReportForEvents(final String dataspaceName,
        ...
        final Anchor anchor = cpsAnchorService.getAnchor(dataspaceName, anchorName);
        final Map<String, Object> dataNodesAsMap = dataMapper.toFlatDataMap(anchor, dataNodes);
