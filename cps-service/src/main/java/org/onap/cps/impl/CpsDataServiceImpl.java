...
public class CpsDataServiceImpl implements CpsDataService {
    ...
    public void saveData(final String dataspaceName, final String anchorName, final String parentNodeXpath,
        ...
        final Collection<DataNode> dataNodes =
               dataNodeBuilderService.buildDataNodesWithAnchorParentXpathAndNodeData(anchor, parentNodeXpath, nodeData, contentType);
    ...
    public void updateNodeLeavesAndExistingDescendantLeaves(final String dataspaceName, final String anchorName,
        ...
        final Collection<DataNode> dataNodeUpdates = dataNodeBuilderService
                .buildDataNodesWithAnchorParentXpathAndNodeData(anchor, parentNodeXpath, dataNodeUpdatesAsJson, ContentType.JSON);
    ...
    public void updateDataNodesAndDescendants(final String dataspaceName, final String anchorName,
        ...
        final Anchor anchor = cpsAnchorService.getAnchor(dataspaceName, anchorName);
        final Collection<DataNode> dataNodes = dataNodeBuilderService
                .buildDataNodesWithAnchorAndXpathToNodeData(anchor, nodeDataPerXPath, contentType);
        cpsDataPersistenceService.updateDataNodesAndDescendants(dataspaceName, anchorName, dataNodes);
    ...
    private Collection<DataNode> rebuildSourceDataNodes(final String xpath, final Anchor sourceAnchor,
        ...
        if (sourceDataNodes != null) {
            ...
            sourceDataNodesRebuilt.addAll(dataNodeBuilderService
                    .buildDataNodesWithAnchorXpathAndNodeData(sourceAnchor, xpath, sourceDataNodesAsJson, ContentType.JSON));
        }
    ...
    private Collection<DataNode> buildTargetDataNodes(final Anchor sourceAnchor, final String xpath,
        ...
        if (yangResourcesNameToContentMap.isEmpty()) {
            ...
            return dataNodeBuilderService
                    .buildDataNodesWithYangResourceXpathAndNodeData(yangResourcesNameToContentMap, xpath,
