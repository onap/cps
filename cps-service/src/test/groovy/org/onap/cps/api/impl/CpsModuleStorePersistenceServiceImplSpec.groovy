...
class CpsModuleStorePersistenceServiceImplSpec extends Specification {
    def mockModuleStoreService = Mock(CpsModuleStorePersistenceService)
    def objectUnderTest = new CpsModuleStoreServiceImpl()

    def setup() {
        objectUnderTest.cpsModuleStorePersistenceService = mockModuleStoreService
    }
