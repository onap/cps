...
class CpsDeltaServiceImplSpec extends Specification{
    ...
    @Shared
    def sourceDataNodeWithLeafData = [new DataNode(xpath: '/parent', leaves: ['parent-leaf': 'parent-payload-in-source'])]
    @Shared
    def sourceDataNodeWithoutLeafData = [new DataNode(xpath: '/parent')]
    @Shared
    def targetDataNodeWithLeafData = [new DataNode(xpath: '/parent', leaves: ['parent-leaf': 'parent-payload-in-target'])]
    @Shared
    def targetDataNodeWithoutLeafData = [new DataNode(xpath: '/parent')]
    @Shared
    def sourceDataNodeWithMultipleLeaves = [new DataNode(xpath: '/parent', leaves: ['leaf-1': 'leaf-1-in-source', 'leaf-2': 'leaf-2-in-source'])]
    @Shared
    def targetDataNodeWithMultipleLeaves = [new DataNode(xpath: '/parent', leaves: ['leaf-1': 'leaf-1-in-target', 'leaf-2': 'leaf-2-in-target'])]
