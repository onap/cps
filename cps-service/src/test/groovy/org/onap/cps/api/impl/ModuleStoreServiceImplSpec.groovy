...
class ModuleStoreServiceImplSpec extends Specification {
    def mockModuleStoreService = Mock(ModuleStoreService)
    def objectUnderTest = new ModuleStoreServiceImpl()

    def setup() {
        objectUnderTest.moduleStoreService = mockModuleStoreService
    }
