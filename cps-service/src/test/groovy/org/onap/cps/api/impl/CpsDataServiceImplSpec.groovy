...
class CpsDataServiceImplSpec extends Specification {
    ...
    def 'Get delta between 2 anchors with #scenario and #fetchDescendantsOption'() {
        ...
        where:
            ...
            'unique anchor names'     | ANCHOR_NAME_1 | ANCHOR_NAME_2 | FetchDescendantsOption.INCLUDE_ALL_DESCENDANTS  | [["some-key": "some-value", "categories": [["books": [["authors": ["Unknown Author"]]]]]]]
            'unique anchor names'     | ANCHOR_NAME_1 | ANCHOR_NAME_2 | FetchDescendantsOption.OMIT_DESCENDANTS         | [["some-key": "some-value", "categories": [["books": [["authors": ["Unknown Author"]]]]]]]
