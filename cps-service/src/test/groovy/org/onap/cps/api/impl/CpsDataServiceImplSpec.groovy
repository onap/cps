...
class CpsDataServiceImplSpec extends Specification {
    ...
    def timedYangParser = new YangParser(new YangParserHelper(), mockYangTextSchemaSourceSetCache)
    def mockCpsDeltaService = Mock(CpsDeltaService);

    def objectUnderTest = new CpsDataServiceImpl(mockCpsDataPersistenceService, mockCpsAnchorService, mockCpsValidator, timedYangParser, mockCpsDeltaService)
