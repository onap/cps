...
class CpsDataServiceImplSpec extends Specification {
    ...
    def 'Saving list element data fragment under existing node.'() {
        ...
        when: 'save data method is invoked with list element json data'
            ...
            objectUnderTest.saveListElementsData(dataspaceName, anchorName, '/test-tree', jsonData, observedTimestamp)
        then: 'the persistence service method is invoked with correct parameters'
    ...
    def 'Saving empty list element data fragment.'() {
        given: 'schema set for given anchor and dataspace references test-tree model'
            setupSchemaSetMocks('test-tree.yang')
        when: 'save data method is invoked with empty list element data fragment'
            def jsonData = '{"branch": []}'
            objectUnderTest.saveListElementsData(dataspaceName, anchorName, '/test-tree', jsonData, observedTimestamp)
    ...
    def 'Delete list element data fragment under existing node.'() {
        ...
        when: 'delete list data method is invoked with list element json data'
            objectUnderTest.deleteListOrElement(dataspaceName, anchorName, '/test-tree/branch', observedTimestamp)
        then: 'the persistence service method is invoked with correct parameters'
