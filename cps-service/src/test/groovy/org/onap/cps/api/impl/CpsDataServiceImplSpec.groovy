...
class CpsDataServiceImplSpec extends Specification {
    ...
    def 'Get delta between 2 anchors with #scenario and #fetchDescendantsOption'() {
        ...
        then: 'the dataspace and anchor names are validated'
            numberOfInvocations * mockCpsValidator.validateNameCharacters(_)
        ...
        where: 'following data is used'
            ...
            'unique anchor names'     | ANCHOR_NAME_1   | ANCHOR_NAME_2   | FetchDescendantsOption.INCLUDE_ALL_DESCENDANTS |        2
            'unique anchor names'     | ANCHOR_NAME_1   | ANCHOR_NAME_2   | FetchDescendantsOption.OMIT_DESCENDANTS        |        2
