...
class CpsDataServiceImplSpec extends Specification {
    ...
    def 'Get delta between anchor and payload with user provided schema #scenario'() {
        ...
        where: 'following data was used'
            ...
            'root node xpath'    | '/'          | [new DataNodeBuilder().withXpath('/bookstore').build()]                                                  | '{"bookstore":{"bookstore-name":"Easons","categories":[{"code":"01/1","name":"SciFi"},{"name":"kids","code":"02"}]}}' | '/bookstore'
            'non-root xpath'     | '/bookstore' | [new DataNodeBuilder().withXpath("/bookstore/categories[@code='02']").withLeaves(["code":'02']).build()] | '{"bookstore-name":"Easons","categories":[{"code":"01/1","name":"SciFi"},{"name":"kids","code":"02"}]}'               | '/bookstore/categories[@code=\'02\']'
    }
    ...
    def 'Get delta between anchor and payload by using schema from anchor #scenario'() {
        ...
        where: 'following data was used'
            ...
            'non-root xpath'  | '/bookstore' | [new DataNodeBuilder().withXpath("/bookstore/categories[@code='02']").withLeaves(["code":'02']).build()] | "{'categories':[{'name':'kids','code':'02'}]}" | "/bookstore/categories[@code='02']"
    }
