...
class CpsDataServiceImplSpec extends Specification {
    ...
    def 'Get delta between 2 anchors with #scenario and #fetchDescendantsOption'() {
        ...
        and: 'the equivalent method of persistence layer is invoked with same parameters'
            numberOfInvocations * mockCpsDataPersistenceService.getDeltaByDataspaceAndAnchors(dataspaceName, referenceAnchor, comparandAnchor, xpath, fetchDescendantsOption)
        where: 'following data is used'
            scenario                  | referenceAnchor | comparandAnchor | fetchDescendantsOption                         | numberOfInvocations
