...
class CpsAdminServiceImplSpec extends Specification {
    ...
    def 'Delete anchor.'() {
        ...
        and: 'delete data nodes is invoked with expected parameters on the data persistence service'
            1 * mockCpsDataPersistenceService.deleteDataNodes('my-dataspace','my-anchor')
        and: 'delete anchor is invoked with expected parameters on the admin persistence service'
            1 * mockCpsAdminPersistenceService.deleteAnchor('my-dataspace','my-anchor')
        and: 'notification is sent for my-anchor'
