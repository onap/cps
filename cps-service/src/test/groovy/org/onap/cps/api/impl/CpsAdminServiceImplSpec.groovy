...
class CpsAdminServiceImplSpec extends Specification {
    ...
    def 'Delete anchor.'() {
        ...
        then: 'delete data nodes is invoked on data service with expected parameters'
            1 * mockCpsDataService.deleteDataNodes('someDataspace','someAnchor', _ as OffsetDateTime )
        and: 'Persistence service method is invoked with same parameters to delete anchor'
