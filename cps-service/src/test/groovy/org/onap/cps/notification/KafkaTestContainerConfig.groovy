...
class KafkaTestContainerConfig {
    ...
    /* TODO
         1. figure out how to set the repository for pulling images.
         2. Two different repository nexus for postgres and dockerhub for kafka
         3. handle docker image pull count issue with anonymous user
     */
