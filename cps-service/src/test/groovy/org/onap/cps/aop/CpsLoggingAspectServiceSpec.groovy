...
class CpsLoggingAspectServiceSpec extends Specification {
    ...
    def 'Log method execution time with : #scenario.'() {
        ...
        where: 'the following log levels are used'
            scenario                    | logLevel       || expectedNumberOfMethodExecution
            'If log level is Info'      | Level.INFO     || 0
            'If log level is Fine'      | Level.FINE     || 1
            'If log level is Finest'    | Level.FINEST   || 1
    }
