...
class DeltaReportExecutorSpec extends Specification {
    ...
    @Shared
    def bookstoreCategoryNode = [new DataNode(xpath: '/bookstore/categories[@code=\'1\']', leaves: ['code': '1', 'name': 'Children'])]
    @Shared
    def bookstoreBookNode = [new DataNode(xpath: '/bookstore/categories[@code=\'1\']/books[@title=\'Matilda\']', leaves: ['price': 20, 'title': 'Matilda'])]
    ...
    def 'Perform delete operation on existing data under an anchor using delta report'() {
        ...
        where:
            ...
            'JSON'   | ContentType.JSON  | '[{"action":"remove","xpath":"/bookstore"}]'
            'XML'    | ContentType.XML   | '<deltaReports><deltaReport><action>remove</action><xpath>/bookstore</xpath><sourceData><categories><code>1</code></categories></sourceData></deltaReport></deltaReports>'
    }
    ...
    def 'Perform create operation on existing data under an anchor using delta report to add a node with #scenario'() {
        ...
        where:
            ...
            'xpath'           | ContentType.JSON | '[{"action":"create","xpath":"/bookstore"}]'                                                                                                                                                                     | bookstoreCategoryNode   || '/bookstore'
            'list node xpath' | ContentType.JSON | '[{"action":"create","xpath":"/bookstore/categories[@code=\'1\']"}]'                                                                                                                                             | bookstoreBookNode       || '/bookstore/categories[@code=\'1\']'
            'xpath'           | ContentType.XML  | '<deltaReports><deltaReport><action>create</action><xpath>/bookstore</xpath><targetData><categories><code>1</code><name>Children</name></categories></targetData></deltaReport></deltaReports>'                  | bookstoreCategoryNode   || '/bookstore'
            'list node xpath' | ContentType.XML  | '<deltaReports><deltaReport><action>create</action><xpath>/bookstore/categories[@code=\'1\']</xpath><targetData><books><price>20</price><title>Matilda</title></books></targetData></deltaReport></deltaReports>'| bookstoreBookNode       || '/bookstore/categories[@code=\'1\']'
    }
    ...
    def 'Perform create operation on existing data under an anchor using delta report to add a parent list node with #scenario'() {
        ...
        where:
            scenario | contentType      | deltaReport
            'JSON'   | ContentType.JSON | '[{"action":"create","xpath":"/bookstore-address[@bookstore-name=\'Easons\']"}]'
    ...
    def 'Perform replace operation on existing data under an anchor using delta report'() {
        ...
        where:
            scenario | contentType       | deltaReport
            'JSON'   | ContentType.JSON  | '[{"action":"replace","xpath":"/bookstore/categories[@code=\'1\']"}]'
            'XML'    | ContentType.XML   | '<deltaReports><deltaReport><action>replace</action><xpath>/bookstore/categories[@code=\'1\']</xpath><sourceData><categories><code>1</code><name>Children</name></categories></sourceData><targetData><categories><code>1</code><name>Children</name></categories></targetData></deltaReport></deltaReports>'
    }
