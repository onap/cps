...
class DeltaReportExecutorSpec extends Specification {
    ...
    static def DELTA_REPORT_REMOVE_JSON = '[{"action":"remove","xpath":"/bookstore"}]'
    static def DELTA_REPORT_REMOVE_XML = '<deltaReports><deltaReport><action>remove</action><xpath>/bookstore</xpath><sourceData><categories><code>1</code></categories></sourceData></deltaReport></deltaReports>'
    static def DELTA_REPORT_CREATE_BOOKSTORE_JSON = '[{"action":"create","xpath":"/bookstore"}]'
    static def DELTA_REPORT_CREATE_BOOKSTORE_XML = '<deltaReports><deltaReport><action>create</action><xpath>/bookstore</xpath><targetData><categories><code>1</code><name>Children</name></categories></targetData></deltaReport></deltaReports>'
    static def DELTA_REPORT_CREATE_CATEGORY_JSON = '[{"action":"create","xpath":"/bookstore/categories[@code=\'1\']"}]'
    static def DELTA_REPORT_CREATE_CATEGORY_XML = '<deltaReports><deltaReport><action>create</action><xpath>/bookstore/categories[@code=\'1\']</xpath><targetData><books><price>20</price><title>Matilda</title></books></targetData></deltaReport></deltaReports>'
    static def DELTA_REPORT_CREATE_ADDRESS_JSON = '[{"action":"create","xpath":"/bookstore-address[@bookstore-name=\'Easons\']"}]'
    static def DELTA_REPORT_CREATE_ADDRESS_XML = '<deltaReports><deltaReport><action>create</action><xpath>/bookstore-address[@bookstore-name=\'Easons\']</xpath><targetData><bookstore-address><bookstore-name>Easons</bookstore-name></bookstore-address></targetData></deltaReport></deltaReports>'
    static def DELTA_REPORT_REPLACE_JSON = '[{"action":"replace","xpath":"/bookstore/categories[@code=\'1\']"}]'
    static def DELTA_REPORT_REPLACE_XML = '<deltaReports><deltaReport><action>replace</action><xpath>/bookstore/categories[@code=\'1\']</xpath><sourceData><categories><code>1</code><name>Children</name></categories></sourceData><targetData><categories><code>1</code><name>Children</name></categories></targetData></deltaReport></deltaReports>'
    ...
    def 'Perform delete operation on existing data under an anchor using delta report'() {
        ...
        where:
            ...
            'JSON'   | ContentType.JSON  | DELTA_REPORT_REMOVE_JSON
            'XML'    | ContentType.XML   | DELTA_REPORT_REMOVE_XML
    }
    ...
    def 'Perform create operation on existing data under an anchor using delta report to add a node with #scenario'() {
        ...
        where:
            ...
            'xpath'           | ContentType.JSON | DELTA_REPORT_CREATE_BOOKSTORE_JSON | bookstoreCategoryNode   || '/bookstore'
            'list node xpath' | ContentType.JSON | DELTA_REPORT_CREATE_CATEGORY_JSON  | bookstoreBookNode       || '/bookstore/categories[@code=\'1\']'
            'xpath'           | ContentType.XML  | DELTA_REPORT_CREATE_BOOKSTORE_XML  | bookstoreCategoryNode   || '/bookstore'
            'list node xpath' | ContentType.XML  | DELTA_REPORT_CREATE_CATEGORY_XML   | bookstoreBookNode       || '/bookstore/categories[@code=\'1\']'
    }
    ...
    def 'Perform create operation on existing data under an anchor using delta report to add a parent list node with #scenario'() {
        ...
        where:
            scenario | contentType      | deltaReport
            'JSON'   | ContentType.JSON | DELTA_REPORT_CREATE_ADDRESS_JSON
            'XML'    | ContentType.XML  | DELTA_REPORT_CREATE_ADDRESS_XML
    }
    ...
    def 'Perform replace operation on existing data under an anchor using delta report'() {
        ...
        where:
            scenario | contentType       | deltaReport
            'JSON'   | ContentType.JSON  | DELTA_REPORT_REPLACE_JSON
            'XML'    | ContentType.XML   | DELTA_REPORT_REPLACE_XML
    }
