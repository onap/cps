...
class XmlFileUtilsSpec extends Specification {
    ...
    def 'Convert data maps to XML #scenario'() {
        ...
        where:
            ...
            'xmlContent map with null key/value' | [['test-tree': [branch: [name: 'Left', nest: []]]]]                                                                                      || '<test-tree><branch><name>Left</name><nest/></branch></test-tree>'
            'xmlContent list is empty'           | [['nest': ['name': 'Small', 'birds': []]]]                                                                                               || '<nest><name>Small</name><birds/></nest>'
    }
