...
class XmlFileUtilsSpec extends Specification {
    ...
    def 'convertDataMapsToXml should throw DataValidationException due to NullPointerException'() {
        ...
        and:'the cause for exception'
            assert exception.cause instanceof NullPointerException
    }

    def 'convertDataMapsToXml should throw DataValidationException due to DOMException'() {
        given: 'A list of maps where entry is null'
