...
class CpsFacadeImplSpec extends Specification {
    ...
    def objectUnderTest = new CpsFacadeImpl(mockCpsAnchorService, mockCpsDataService, mockCpsQueryService , mockPrefixResolver)
    ...
    def 'Execute dataspace query.'() {
        ...
        then: 'all nodes (from the query service result) are returned, grouped by anchor'
            ...
            assert result[1].toString() == '{anchorName=other anchor, dataNodes=[{prefix1:path3={}}]}'
    }
