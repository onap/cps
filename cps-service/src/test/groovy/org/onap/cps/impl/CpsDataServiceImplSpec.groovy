...
class CpsDataServiceImplSpec extends Specification {
    ...
    def 'Save data nodes with delta notifications enabled'() {
        ...
        and: 'delta report notifications is enabled'
        ...
        then: 'delta report is generated by the delta report generator'
    ...
    def 'Save data nodes with xpath and delta notifications enabled'() {
        given: 'schema set for given anchor and dataspace references test-tree model, json data and a delta report'
            setupSchemaSetMocks('test-tree.yang')
    ...
    //Check
    def 'Save list data node with delta notifications enabled'() {
        given: 'schema set for given anchor and dataspace references test-tree model, json data and a delta report'
            setupSchemaSetMocks('test-tree.yang')
            def jsonData = '{"branch": [ { "name" : "Left" }]}'
    ...
    def 'Update data node leaves and descendants with delta notifications enabled'() {
        given: 'schema set for given anchor and dataspace references test-tree model, json data and a delta report'
            setupSchemaSetMocks('test-tree.yang')
            def jsonData = '{"branch": [ { "name" : "Left" }]}'
            def deltaReports = [new DeltaReportBuilder().withXpath('/test-tree/branch[@name=\'Left\']').actionReplace().withTargetData(['name': 'Left']).build()]
    ...
    def 'Update node leaves with delta notifications enabled'() {
        given: 'schema set for given anchor and dataspace references test-tree model, json data and a delta report'
            setupSchemaSetMocks('test-tree.yang')
            def jsonData = '{"branch": [ { "name" : "Left" }]}'
            def deltaReports = [new DeltaReportBuilder().withXpath('/test-tree/branch[@name=\'Left\']').actionReplace().withTargetData(['name': 'Left']).build()]
    ...
    def 'Update data nodes and descendants with delta notifications enabled'() {
        given: 'schema set for given anchor and dataspace references test-tree model, json data and a delta report'
            setupSchemaSetMocks('test-tree.yang')
            def jsonData = '{"branch": [ { "name" : "Left" }]}'
            def deltaReports = [new DeltaReportBuilder().withXpath('/test-tree/branch[@name=\'Left\']').actionReplace().withTargetData(['name': 'Left']).build()]
    ...
    def 'Replace list content with delta notifications enabled'() {
        given: 'schema set for given anchor and dataspace references test-tree model, json data and a delta report'
            setupSchemaSetMocks('test-tree.yang')
            def jsonData = '{"branch": [ { "name" : "Left" }]}'
            def deltaReports = [new DeltaReportBuilder().withXpath('/test-tree/branch[@name=\'Left\']').actionReplace().withTargetData(['name': 'Left']).build()]
    ...
    def 'Delete data node with delta notifications enabled'() {
    ...
    def 'Delete list element with delta notifications enabled'() {
        given: 'schema set for given anchor and dataspace references test-tree model and a delta report'
            setupSchemaSetMocks('test-tree.yang')
    ...
    def 'Delete data nodes with delta notifications enabled'() {
