...
class CpsDeltaServiceImplSpec extends Specification {
    ...
    def 'Delta Report between parent nodes with children where #scenario'() {
        ...
        where: 'the following data is used'
            ...
            'Data node is added with grouping disabled'                           | []                      | targetDataNodeWithChild | GROUPING_DISABLED || 'create'             | null                                          | ['parent-leaf': 'parent-leaf-as-target-data'] | 'create'            | '/parent/child'    | null                                                  | ['child-leaf': 'child-leaf-as-target-data']
            'Data node is removed with grouping disabled'                         | sourceDataNodeWithChild | []                      | GROUPING_DISABLED || 'remove'             | ['parent-leaf': 'parent-leaf-as-source-data'] | null                                          | 'remove'            | '/parent/child'    | ['child-leaf': 'child-leaf-as-source-data']           | null
            'Data node is updated with grouping disabled'                         | sourceDataNodeWithChild | targetDataNodeWithChild | GROUPING_DISABLED || 'replace'            | expectedParentSourceData                      | expectedParentTargetData                      | 'replace'           | '/parent/child'    | ['child':['child-leaf': 'child-leaf-as-source-data']] | ['child':['child-leaf': 'child-leaf-as-target-data']]
            'parent node is updated, child node is added with grouping enabled'   | sourceDataNode          | targetDataNodeWithChild | GROUPING_ENABLED  || 'replace'            | expectedParentSourceData                      | expectedParentTargetData                      | 'create'            | '/parent'          | null                                                  | ['child':['child-leaf': 'child-leaf-as-target-data']]
            'parent node is updated, child node is removed with grouping enabled' | sourceDataNodeWithChild | targetDataNode          | GROUPING_ENABLED  || 'replace'            | expectedParentSourceData                      | expectedParentTargetData                      | 'remove'            | '/parent'          | ['child':['child-leaf':'child-leaf-as-source-data']]  | null
            'parent and child node are updated with grouping enabled'             | sourceDataNodeWithChild | targetDataNodeWithChild | GROUPING_ENABLED  || 'replace'            | expectedParentSourceData                      | expectedParentTargetData                      | 'replace'           | '/parent/child'    | ['child':['child-leaf': 'child-leaf-as-source-data']] | ['child':['child-leaf': 'child-leaf-as-target-data']]
    }
    ...
    def 'Delta Report between data nodes with list node xpath where data is #scenario with grouping of data nodes enabled'() {
