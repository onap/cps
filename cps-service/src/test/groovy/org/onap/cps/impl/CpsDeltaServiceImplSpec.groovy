...
class CpsDeltaServiceImplSpec extends Specification {
    ...
    def mockApplyDeltaReport = Mock(ApplyDeltaReport)
    ...
    def objectUnderTest = new CpsDeltaServiceImpl(mockApplyDeltaReport, mockCpsAnchorService, mockCpsDataService, dataNodeFactory, dataMapper, jsonObjectMapper, deltaReportGenerator, groupedDeltaReportGenerator)
    ...
    def 'Perform REST operations using delta report'() {
        ...
        then: 'apply delta utility class is invoked'
            1 * mockApplyDeltaReport.applyDelta(dataspaceName, ANCHOR_NAME_1, deltaReportJson)
    }
