...
class CpsDeltaServiceImplSpec extends Specification {
    ...
    def objectUnderTest = new CpsDeltaServiceImpl(mockCpsAnchorService, mockCpsDataService, dataNodeFactory)
    ...
    def 'Get delta between anchor and payload with user provided schema #scenario'() {
        ...
        where: 'following data was used'
            ...
            'root node xpath' | '/'                                 | [new DataNode(xpath: '/bookstore')]                        | '{"bookstore":{"bookstore-name":"Easons"}}'   || '/bookstore'
            'parent xpath'    | '/bookstore'                        | [new DataNode(xpath: '/bookstore')]                        | '{"bookstore":{"bookstore-name":"Easons"}}'   || '/bookstore'
            'non-root xpath'  | '/bookstore/categories[@code="02"]' | [new DataNode(xpath: '/bookstore/categories[@code="02"]')] | '{"categories":[{"name":"kids","code":"02"}]}' || '/bookstore/categories[@code="02"]'
    }
    ...
    def 'Get delta between anchor and payload by using schema from anchor #scenario'() {
        ...
        where: 'following data was used'
            ...
            'root node xpath' | '/'                                 | [new DataNode(xpath: '/bookstore')]                        | '{"bookstore":{"bookstore-name":"Easons"}}'     || '/bookstore'
            'parent xpath'    | '/bookstore'                        | [new DataNode(xpath: '/bookstore')]                        | '{"bookstore":{"bookstore-name":"Easons"}}'     || '/bookstore'
            'non-root xpath'  | '/bookstore/categories[@code="02"]' | [new DataNode(xpath: '/bookstore/categories[@code="02"]')] | '{"categories":[{"name":"Child","code":"02"}]}' || '/bookstore/categories[@code="02"]'
    }
