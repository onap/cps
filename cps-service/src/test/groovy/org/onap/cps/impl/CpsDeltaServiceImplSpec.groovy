...
class CpsDeltaServiceImplSpec extends Specification {
    ...
    def 'Get Delta Report between with grouping enabled between #scenario'() {
        ...
        where: 'following data was used'
            scenario                                   | sourceDataNodes         | targetDataNodes                                                                             || expectedAction | expectedSourceData                                                                                            | expectedTargetData
            'Data node with parent node xpath added'   | []                      | targetDataNodeWithChild                                                                     || 'create'       | null                                                                                                          | ['parent':['parent-leaf': 'parent-leaf-as-target-data', 'child':['child-leaf': 'child-leaf-as-target-data']]]
            'Data node with xpath'                     | []                      | [new DataNode(xpath: '/parent/child', leaves: ['child-leaf': 'child-leaf-as-target-data'])] || 'create'       | null                                                                                                          | ['child':['child-leaf': 'child-leaf-as-target-data']]
            'Data node with parent node xpath removed' | sourceDataNodeWithChild | []                                                                                          || 'remove'       | ['parent':['parent-leaf': 'parent-leaf-as-source-data', 'child':['child-leaf': 'child-leaf-as-source-data']]] | null
