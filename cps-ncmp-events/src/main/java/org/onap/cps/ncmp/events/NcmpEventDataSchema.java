...
public enum NcmpEventDataSchema {
    ...
    BATCH_RESPONSE_V1("urn:cps:org.onap.cps.ncmp.events.batch-response:1.0.0"),
    ...
    INVENTORY_EVENTS_V1("urn:cps:org.onap.cps.ncmp.events:inventory-event-schema:1.0.0"),
