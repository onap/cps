...
ROBOT_VARIABLES="-v CPS_HOST:$CPS_HOST -v CPS_PORT:$CPS_PORT -v DMI_HOST:$DMI_HOST -v DMI_PORT:$DMI_PORT -v MANAGEMENT_PORT:$MANAGEMENT_PORT -v DATADIR:$WORKSPACE/data -v DMI_SERVICE_URL:http://$LOCAL_IP:8783"