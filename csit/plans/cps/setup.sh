...
cp $WORKSPACE/../docker-compose/csit/*.yml $WORKSPACE/archives/dc-cps
cd $WORKSPACE/archives/dc-cps

# download docker-compose of a required version (2.6.0 supports configuration of version 3.7)
...
docker-compose -f csit-docker-compose.yml up -d
