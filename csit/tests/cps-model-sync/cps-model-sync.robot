...
${jsonDataCreate}               {"dmiPlugin":"${dmiUrl}","dmiDataPlugin":null,"dmiModelPlugin":null,"createdCmHandles":[{"restModelCmHandle":"PNFDemo","cmHandleProperties":{"Book1":"Sci-Fi Book"},"publicCmHandleProperties":{"Contact":"storeemail@bookstore.com"}}]}
${jsonDataUpdate}               {"dmiPlugin":"${dmiUrl}","dmiDataPlugin":null,"dmiModelPlugin":null,"updatedCmHandles":[{"restModelCmHandle":"PNFDemo","cmHandleProperties":{"Book1":"Romance Book"},"publicCmHandleProperties":{"Contact":"newemailforstore@bookstore.com"}}]}
...
Get CM Handle details and confirm it has been registered.
    ...
    IF    "${responseJson['restModelCmHandle']}" == "PNFDemo"
           FOR   ${item}   IN  @{responseJson['cmHandleProperties']}
