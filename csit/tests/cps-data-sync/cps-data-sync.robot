...
Set and Verify dataSyncEnabled flag to TRUE
    ...
    ${verifyResponseJson}=    Set Variable        ${verifyResponse.json()['state']}
    Should Be Equal As Strings                    ${verifyResponseJson['dataSyncEnabled']}   True
    Sleep   10
