...
${newCmHandleRequestBody}               {"dmiPlugin":"${dmipluginCsitStubUrL}","createdCmHandles":[{"cmHandle":"DataOperationTest"}]}
...
Consume cloud event of type DataOperationEvent from client topic
