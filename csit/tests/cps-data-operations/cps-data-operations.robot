...
${dmipluginCSITStubUrL}                 http://${DMI_DEMO_STUB_HOST}:${DMI_DEMO_STUB_PORT}
${CmHandleReadyJsonReqBody}             {"dmiPlugin":"${dmipluginCSITStubUrL}","createdCmHandles":[{"cmHandle":"DataOperationTest","cmHandleProperties":{"Book3":"Horror Book"}}]}

*** Test Cases ***

Process the received Data operation request at NCMP then forward a request to respective DMI plugin and it publishes a response to client topic
