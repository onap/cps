...
public class CpsAdminPersistenceServiceTest {
    ...
    private static final String ANCHOR_NAME_EXISTING = "ANCHOR-001";
    ...
    public void testCreateAnchorWithNameAlreadyDefined() {
        cpsAdminPersistenceService.createAnchor(DATASPACE_NAME, SCHEMA_SET_NAME, ANCHOR_NAME_EXISTING);
    }
