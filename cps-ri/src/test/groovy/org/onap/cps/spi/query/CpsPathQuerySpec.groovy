...
class CpsPathQuerySpec extends Specification {
    ...
    def 'Parse cps path with #scenario.'() {
        ...
        where: 'the following data is used'
            ...
            'unmatched quotes'                                                  | '/parent/child[@someString="value with unmatched quotes\']'
            'unmatched quotes'                                                  | '/parent/child[@someString=\'value with unmatched quotes"]'
    ...
    def 'Convert cps leaf value to valid type with leaf of type #scenario'() {
        ...
        where: "the following data is used"
            ...
            'String containing single quotes' | '"value with \'"'            || 'value with \''
            'String containing double quotes' | '\'value with "\''           || 'value with "'
