...
@SpringBootTest(classes=[CpsModulePersistenceServiceImpl, YangResourceRepository, SchemaSetRepository, DataspaceRepository, CpsAdminPersistenceService, ModuleReferenceRepository])
@EnableRetry
