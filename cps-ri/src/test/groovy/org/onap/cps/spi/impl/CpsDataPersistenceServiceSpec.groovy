...
class CpsDataPersistenceServiceSpec extends Specification {
    ...
    def mockFragmentNativeRepository = Mock(FragmentNativeRepository);

    def objectUnderTest = Spy(new CpsDataPersistenceServiceImpl(mockDataspaceRepository, mockAnchorRepository, mockFragmentRepository, jsonObjectMapper, mockSessionManager, mockFragmentNativeRepository))
