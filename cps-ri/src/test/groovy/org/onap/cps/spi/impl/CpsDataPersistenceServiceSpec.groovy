...
class CpsDataPersistenceServiceSpec extends Specification {
    ...
    def 'Retrieving multiple data nodes.'() {
        ...
        and: 'fragment repository returns a collection of fragments'
            mockFragmentRepository.findExtractsWithDescendantsByAnchorIdAndXpaths(123, ['/xpath1', '/xpath2'] as Set, _) >> [
    ...
    def 'update data node and descendants: #scenario'(){
        given: 'mocked responses'
            ...
            mockFragmentRepository.findExtractsWithDescendantsByAnchorIdAndXpaths(_, [] as Set, _) >> []
            mockFragmentRepository.findExtractsWithDescendantsByAnchorIdAndXpaths(_, ['/test/xpath'] as Set, _) >> [
    ...
    def 'update data nodes and descendants'() {
        given: 'the fragment repository returns fragment entities related to the xpath inputs'
            mockFragmentRepository.findExtractsWithDescendantsByAnchorIdAndXpaths(123, ['/test/xpath1', '/test/xpath2'] as Set, _) >> [
    ...
    def createDataNodesAndMockRepositoryMethodSupportingThem(Map<String, String> xpathToScenarioMap) {
        ...
        mockFragmentRepository.findExtractsWithDescendantsByAnchorIdAndXpaths(_, xpathToScenarioMap.keySet(), _) >> fragmentExtracts
        return dataNodes
    }
    ...
    def mockFragmentWithJson(json) {
        ...
        mockFragmentRepository.findExtractsWithDescendantsByAnchorIdAndXpaths(123, ['/parent-01'] as Set, _) >> [fragmentExtract]
    }
