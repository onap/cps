...
class CpsDataPersistenceServiceSpec extends Specification {
    ...
    def 'Converting fragment with property String #scenario'() {
        ...
        'Without dot'                   |'15174'                ||15174                 |Integer
        'With dot'                      |'15174.32'             ||15174.32              |Double
        'With 0 value after dot'        |'15174.0'              ||15174.0               |Double
        'With 0 value before dot'       |'0.32'                 ||0.32                  |Double
        'Higher than max int'           |'2147483648'           ||2147483648            |Long
        'Text'                          |'"Test"'               ||'Test'                |String
        'With exponent'                 |'1.2345e5'             ||1.2345e5              |Double
        'Long with 0 value after dot'   |'123456789101112.0'    ||123456789101112.0     |Double
        'With Text and Numbers'         |'"String = \'1234\'"'  ||'String = \'1234\''   |String
        'With String Number'            |'"12345"'              ||'12345'               |String
    }
