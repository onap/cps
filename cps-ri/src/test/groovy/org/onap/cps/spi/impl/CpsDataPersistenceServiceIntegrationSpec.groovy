...
class CpsDataPersistenceServiceIntegrationSpec extends CpsPersistenceSpecBase {
    ...
    def 'Delete multiple lists using scenario: #scenario.'() {
        when: 'deleting lists is executed for: #scenario.'
        ...
        where: 'following parameters were used'
            ...
            'valid datanode but not a list'   | ['/parent-203/child-203']                                              || ["/parent-203/child-203", "/parent-203/child-204[@key='A']", "/parent-203/child-204[@key='B']"]
    }
