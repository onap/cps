...
class CpsDataPersistenceServiceIntegrationSpec extends CpsPersistenceSpecBase {
    ...
    def 'Delete list-node content of #scenario.'() {
        ...
        where: 'following parameters were used'
            ...
            'existing list-node'                         | '/parent-203/child-204[@key="A"]'                            | LIST_DATA_NODE_PARENT203_FRAGMENT_ID || ['/parent-203/child-203', '/parent-203/child-204[@key="X"]']
            'existing list-node'                         | '/parent-203/child-204[@key="X"]'                            | LIST_DATA_NODE_PARENT203_FRAGMENT_ID || ['/parent-203/child-203', '/parent-203/child-204[@key="A"]']
            'existing grand-child list node'             | '/parent-203/child-204[@key="X"]/grand-child-204[@key2="Y"]' | LIST_DATA_NODE_PARENT203_FRAGMENT_ID || ['/parent-203/child-203', '/parent-203/child-204[@key="X"]', '/parent-203/child-204[@key="A"]']
            'existing list-node with two keys'           | '/parent-202/child-205[@key="A" and @key2="B"]'              | LIST_DATA_NODE_PARENT202_FRAGMENT_ID || ['/parent-202/child-206[@key="A"]']
    }
    ...
    def 'Delete list-node fragment error scenario: #scenario.'() {
        ...
        where: 'following parameters were used'
            ...
            'existing list-node'                               | '/parent-203/child-204'                            || DataValidationException
            'existing grandchild list-node'                    | '/parent-200/child-202/grand-child-202'            || DataValidationException
            'existing grand-child list node with key'          | '/parent-203/child-204[@key="X"]/grand-child-204'  || DataValidationException
            'list parent node does not exist'                  | '/unknown/unknown'                                 || DataNodeNotFoundException
            'list child nodes parent does not exist'           | '/parent-200/unknown'                              || DataValidationException
            'list child nodes parent does not exist'           | '/parent-200/unknown[@key="C"]'                    || DataNodeNotFoundException
