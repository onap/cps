...
class CpsDataPersistenceQueryDataNodeSpec extends CpsPersistenceSpecBase {
    ...
    def 'Cps Path query using descendant anywhere with #scenario condition(s) for a list element.'() {
        ...
        where: 'the following data is used'
            ...
            'leaf has same keys with OR operator'                                                 | '//author[@FirstName="Jane" or @Firstname="Joe"]'                        || ["/shops/shop[@id='1']/categories[@code='2']/book/author[@FirstName='Jane']"]
            'leaf has same keys with combinations of operators'                                   | '//author[@FirstName="Jane" or @Firstname="Joe" and @surname= "smith"]'  || ["/shops/shop[@id='1']/categories[@code='2']/book/author[@FirstName='Jane']"]
            'mix of partial key and non key leaf with combinations of operators'                  | '//author[@FirstName="John" and @Surname= "Rudra" and @title="title"]'   || ["/shops/shop[@id='1']/categories[@code='2']/book/author[@FirstName='John']"]
            'leaf has same keys with combinations of operators'                                   | '//author[@FirstName="Jane" or @Firstname="Joe" or @surname= "smith"]'   || ["/shops/shop[@id='1']/categories[@code='2']/book/author[@FirstName='Jane']"]
            'mix of partial key and non key leaf with combinations of operators in reverse order' | '//author[@FirstName="Jane" and  @surname= "smith" or @Firstname="Joe"]' || ["/shops/shop[@id='1']/categories[@code='2']/book/author[@FirstName='Jane']"]
    }
