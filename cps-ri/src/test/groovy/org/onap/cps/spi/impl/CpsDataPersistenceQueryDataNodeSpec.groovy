...
class CpsDataPersistenceQueryDataNodeSpec extends CpsPersistenceSpecBase {
    ...
    def 'Cps Path query using descendant anywhere with #scenario condition(s) for a list element.'() {
        ...
        where: 'the following data is used'
            ...
            'leaf has same keys with OR operator'                                                 | '//author[@FirstName="Jane" or @title="crime"]'                        || ["/shops/shop[@id='1']/categories[@code='2']/book/author[@FirstName='Jane']"]
            'leaf has same keys with combinations of operators'                                   | '//author[@Firstname="monie" and @surname= "mary" or @title="techno"]' || ["/shops/shop[@id='1']/categories[@code='2']/book/author[@FirstName='annie']"]
            'mix of partial key and non key leaf with combinations of operators'                  | '//author[@FirstName="John" and @Surname= "keil" and @title="title"]'  || ["/shops/shop[@id='1']/categories[@code='2']/book/author[@FirstName='John']"]
            'leaf has same keys with combinations of operators'                                   | '//author[@FirstName="Jane" or @title="techno" or @surname= "smith"]'  || ["/shops/shop[@id='1']/categories[@code='2']/book/author[@FirstName='Jane']", "/shops/shop[@id='1']/categories[@code='2']/book/author[@FirstName='annie']"]
            'mix of partial key and non key leaf with combinations of operators in reverse order' | '//author[@FirstName="Rahul" or @title="none" and @surname="Kumar"]'   || ["/shops/shop[@id='1']/categories[@code='2']/book/author[@FirstName='Rahul']"]
    }
