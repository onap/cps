...
class CpsDataPersistenceQueryDataNodeSpec extends CpsPersistenceSpecBase {
    ...
    def 'Cps Path query across anchors with #scenario.'() {
        ...
        where: 'the following data is used'
            ...
            'string leaf-condition'                     | '/shops/shop[@id=1]/categories[@code=1]/book[@title="Dune"]' || ['ANCHOR-004', 'ANCHOR-005'] | ["/shops/shop[@id='1']/categories[@code='1']/book", "/shops/shop[@id='1']/categories[@code='1']/book"]
            'integer leaf-condition'                    | '/shops/shop[@id=1]/categories[@code=1]/book[@price=5]'      || ['ANCHOR-004', 'ANCHOR-005'] | ["/shops/shop[@id='1']/categories[@code='1']/book", "/shops/shop[@id='1']/categories[@code='1']/book"]
            ...
            'ancestor with parent'                      | '//phonenumbers[@type="mob"]/ancestor::info/contact'         || ['ANCHOR-004', 'ANCHOR-005'] | ["/shops/shop[@id='3']/info/contact", "/shops/shop[@id='3']/info/contact"]
            'ancestor combined with text condition'     | '//book/title[text()="Dune"]/ancestor::shop'                 || ['ANCHOR-004', 'ANCHOR-005'] | ["/shops/shop[@id='1']", "/shops/shop[@id='1']"]
    ...
    def 'Cps Path query across anchors with #scenario descendants.'() {
        when: 'a query is executed to get a data node by the given cps path'
            def result = objectUnderTest.queryDataNodesAcrossAnchors(DATASPACE_NAME, "/shops/shop[@id=1]/categories[@code=1]", fetchDescendantsOption)
        then: 'correct number of datanodes are returned'
            assert countDataNodes(result) == expectedNumberOfDataNodes
        where: 'the following data is used'
            scenario | fetchDescendantsOption  || expectedNumberOfDataNodes
            'no'     | OMIT_DESCENDANTS        || 2
            'direct' | DIRECT_CHILDREN_ONLY    || 4
            'all'    | INCLUDE_ALL_DESCENDANTS || 6
    }
