...
class CpsDataPersistenceQueryDataNodeSpec extends CpsPersistenceSpecBase {
    ...
    def 'Cps Path query using descendant anywhere with #scenario '() {
        ...
        where: 'the following data is used'
            ...
            'descendant name match end of other node'                | '//book'                                      || ["/shops/shop[@id='1']/categories[@code='1']/book", "/shops/shop[@id='1']/categories[@code='2']/book",  "/shops/shop[@id='1']/categories[@code='3']/book" , "/shops/shop[@id='1']/categories[@code='4']/book"]
            ...
            'descendant name match of leaf containing /'             | '//book/title[text()="Chapters/cookery"]'     || ["/shops/shop[@id='1']/categories[@code='3']/book"]
            'descendant with text condition on leaf containing /'    | '//book[@title="Chapters/cookery"]'           || ["/shops/shop[@id='1']/categories[@code='3']/book"]
            'descendant with text condition on leaf containing ['    | '//book[@title="Chapters/co[okery"]'          || ["/shops/shop[@id='1']/categories[@code='4']/book"]
    }
