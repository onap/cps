...
class CpsDataPersistenceQueryDataNodeSpec extends CpsPersistenceSpecBase {
    ...
    def 'Cps Path query using descendant anywhere with #scenario condition(s) for a list element.'() {
        ...
        where: 'the following data is used'
            ...
            'leaf with Integer having ' > ' angular operators'  | '//categories[@code=2]/book[@price>12]'        || ["/shops/shop[@id='1']/categories[@code='2']/book"]
            'leaf with Integer having ' < ' angular operators'  | '//categories[@code=1]/book[@price<6]'         || ["/shops/shop[@id='1']/categories[@code='1']/book"]
            'leaf with Integer having ' >= ' angular operators' | '//categories[@code=2]/book[@price>=15]'       || ["/shops/shop[@id='1']/categories[@code='2']/book"]
            'leaf with Integer having ' <= ' angular operators' | '//categories[@code=1]/book[@price<=5]'        || ["/shops/shop[@id='1']/categories[@code='1']/book"]
    }
