...
class CpsDataPersistenceQueryDataNodeSpec extends CpsPersistenceSpecBase {
    ...
    def 'Cps Path query for single leaf value with type: #type.'() {
        ...
        then: 'the correct data is returned'
            def leaves = '[price:5.0, title:Dune, labels:[special offer, classics, ]]'
        ...
        where: 'the following data is used'
            ...
            'Integer and descendants'   | '/shops/shop[@id=1]/categories[@code=1]/book[@price=5]'     | INCLUDE_ALL_DESCENDANTS  || 1
    }
