...
class CpsAdminPersistenceServiceSpec extends CpsPersistenceSpecBase {
    ...
    def 'Retrieve cm handle ids when #scenario.'() {
        ...
        where: 'the following data is used'
            ...
            'public properties match'                               | ['Contact' : 'newemailforstore@bookstore.com']                                                || ['PNFDemo2', 'PNFDemo', 'PNFDemo4'] as Set
            'public properties dont match'                          | ['wont_match' : 'wont_match']                                                                 || [] as Set
            'one matches, one does not'                             | ['Contact' : 'wont_match']                                                                    || [] as Set
            'No public properties - return all cm handles'          | [ : ]                                                                                         || ['PNFDemo3', 'PNFDemo', 'PNFDemo2', 'PNFDemo4'] as Set
            'there are more than one items in the publicProperties' | ['Contact' : 'newemailforstore@bookstore.com', 'Contact2': 'newemailforstore2@bookstore.com'] || ['PNFDemo4'] as Set
    }
}
