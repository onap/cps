...
class CpsAdminPersistenceServiceSpec extends CpsPersistenceSpecBase {
    ...
    def 'Query all anchors for an #scenario.'() {
        ...
        where: 'the following data is used'
            ...
            'unknown module and known module in an existing dataspace' | 'dataspace-1'       | ['module-name-1', 'module-does-not-exist'] || ModuleNamesNotFoundException | 'module-does-not-exist' | 'module-name-1'
    }
