...
class CpsAdminPersistenceServiceSpec extends CpsPersistenceSpecBase {
    ...
    def 'Get anchor identifiers for #scenario.'() {
        ...
        when: 'get anchors is performed'
            def anchors = objectUnderTest.getAnchorIdentifiers(modules)
        ...
        where: 'the following data is used'
            ...
            'one module'                           | ['MODULE-NAME-001']                    || '[ANCHOR1]'
            'two modules'                          | ['MODULE-NAME-001', 'MODULE-NAME-002'] || '[ANCHOR1, ANCHOR2, ANCHOR3]'
            'module attached to multiple anchors'  | ['MODULE-NAME-003']                    || '[ANCHOR1, ANCHOR2]'
            'same module with different revisions' | ['MODULE-NAME-002']                    || '[ANCHOR2, ANCHOR3]'
            'not attached to an anchor'            | ['MODULE-NAME-004']                    || '[]'
            'module does not exist'                | ['MODULE-NAME-001', 'test']            || '[ANCHOR1]'
    }
}
