...
class CpsAdminPersistenceServiceSpec extends CpsPersistenceSpecBase {
    ...
    def 'Get anchors for #scenario.'() {
        ...
        where: 'the following data is used'
            ...
            'a module that is not not attached to an anchor' | ['MODULE-NAME-004']                    || []
            'a module does not exist'                        | ['MODULE-NAME-001', 'does-not-exist']  || [buildAnchor('ANCHOR1', 'DATASPACE-001', 'SCHEMA-SET-001')]
    }
