...
INSERT INTO FRAGMENT (ID, DATASPACE_ID, ANCHOR_ID, PARENT_ID, XPATH) VALUES
    ...
    (2, 1001, 3001, 1, '/bookstore/categories[@name="SciFi"]'),
    (3, 1001, 3001, 2, '/bookstore/categories[@name="SciFi"]/books'),
    (4, 1001, 3001, 1, '/bookstore/categories[@name="kids"]'),
    (5, 1001, 3001, 4, '/bookstore/categories[@name="kids"]/books');