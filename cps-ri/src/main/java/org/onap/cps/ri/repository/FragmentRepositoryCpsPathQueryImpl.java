...
public class FragmentRepositoryCpsPathQueryImpl implements FragmentRepositoryCpsPathQuery {
    ...
    public List<Map<String, Object>> findCustomNodes(final Long id, final String xpath,
        ...
        final Query query =  fragmentQueryBuilder.getCustomNodesQuery(xpath,
                selectFields, querySelectWhere);
        ...
        for (final Object result : results) {
            ...
            try {
                ...
                throw new JsonParsingException("Failed to parse JSON result in findCustomNodes", e);
            }
