...
public class FragmentQueryBuilder {
    ...
    /**
     * Create an SQL query based on the configured FragmentQueryBuilder.
     *
     * @return a executable JPA Query object
     */
    public Query build() {
        addSearchPrefix();
        addWhereClause();
    ...
    /**
     * Create an SQL query returning anchor IDs for pagination in a dataspace.
     *
