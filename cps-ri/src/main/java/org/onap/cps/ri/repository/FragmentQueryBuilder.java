...
public class FragmentQueryBuilder {
     ...
     * @param limit limit number of returned entities
     *              (if the limit is less than 1 the method returns all related entities)
     *
    ...
    public Query getQueryForAnchorAndCpsPath(final AnchorEntity anchorEntity,
        ...
        addLimitClause(sqlStringBuilder, queryParameters, limit);
