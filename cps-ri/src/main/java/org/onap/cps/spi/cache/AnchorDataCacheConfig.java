...
public class AnchorDataCacheConfig {
    ...
    private static final MapConfig anchorDataCacheConfig = createMapConfig("anchorDataCacheConfig");
    ...
    public IMap<String, AnchorDataCacheEntry> anchorDataCache() {
        return createHazelcastInstance("anchorDataCache", anchorDataCacheConfig)
