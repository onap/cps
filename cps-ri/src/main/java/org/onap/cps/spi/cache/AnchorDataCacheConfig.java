...
public class AnchorDataCacheConfig {
    ...
    private static final MapConfig anchorDataCacheSemaphoreConfig =
            createMapConfig("anchorDataCacheSemaphoreConfig");
    ...
    public IMap<String, AnchorDataCacheEntry> anchorDataCache() {
        return createHazelcastInstance("anchorDataCache", anchorDataCacheSemaphoreConfig)
    ...
    private Config initializeConfig(final String instanceName, final NamedConfig namedConfig) {
        ...
        config.setClusterName("anchor-data-cache");
        return config;
    }
