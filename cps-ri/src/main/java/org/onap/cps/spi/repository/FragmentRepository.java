...
public interface FragmentRepository extends JpaRepository<FragmentEntity, Long>, FragmentRepositoryCpsPathQuery {
    ...
    void deleteByAnchorIdAndXpathIn(@Param("anchorId") int anchorId, @Param("xpaths") String[] xpaths);

    default void deleteByAnchorIdAndXpathIn(final int anchorId, final Collection<String> xpaths) {
        deleteByAnchorIdAndXpathIn(anchorId, xpaths.toArray(new String[0]));
    }
