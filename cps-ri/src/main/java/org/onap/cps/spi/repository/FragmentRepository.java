...
public interface FragmentRepository extends JpaRepository<FragmentEntity, Long>, FragmentRepositoryCpsPathQuery,
    ...
    /**
     * following segment of code to be used when V1 of Get Data Node API will be deprecated. It will return a
     * collection of Fragment Entities as opposed to a single fragment entity being returned now
     */
    ...
    /**
     * Retrieve all fragments by Dataspace, Anchor and xPath.
     *
    ...
    default Collection<FragmentEntity> getAllByDataspaceAndAnchorAndXpath(@NonNull DataspaceEntity dataspaceEntity,
                                                                          @NonNull AnchorEntity anchorEntity,
                                                                          @NonNull String xpath) {
        final Collection<FragmentEntity> fragmentEntities = findAllByDataspaceAndAnchorAndXpath(dataspaceEntity,
                anchorEntity, xpath);
