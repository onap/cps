...
public class FragmentQueryBuilder {
    ...
    public Query getQueryForAnchorIdsForPagination(final DataspaceEntity dataspaceEntity,
        ...
        addConditionToSearchOnlyChildrenOfAbsoluteParent(cpsPathQuery, sqlStringBuilder, queryParameters, ACROSS_ALL_ANCHORS);
    ...
    private Query getQueryForDataspaceOrAnchorAndCpsPath(final DataspaceEntity dataspaceEntity,
        ...
        addConditionToSearchOnlyChildrenOfAbsoluteParent(cpsPathQuery, sqlStringBuilder, queryParameters, anchorEntity);
        addXpathSearchCondition(cpsPathQuery, sqlStringBuilder, queryParameters);
        addLeafConditions(cpsPathQuery, sqlStringBuilder);
        addTextFunctionCondition(cpsPathQuery, sqlStringBuilder, queryParameters);
        addContainsFunctionCondition(cpsPathQuery, sqlStringBuilder, queryParameters);
    ...
    private static void addConditionToSearchOnlyChildrenOfAbsoluteParent(final CpsPathQuery cpsPathQuery,
                                                                         final StringBuilder sqlStringBuilder,
                                                                         final Map<String, Object> queryParameters,
                                                                         final AnchorEntity anchorEntity) {
        if (CpsPathPrefixType.ABSOLUTE.equals(cpsPathQuery.getCpsPathPrefixType())) {
