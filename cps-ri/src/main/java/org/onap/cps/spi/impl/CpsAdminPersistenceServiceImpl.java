...
public class CpsAdminPersistenceServiceImpl implements CpsAdminPersistenceService {
    ...
    public Collection<Anchor> getAnchors(final String dataspaceName, final Collection<String> inputModuleNames) {
        validateModuleNames(dataspaceName, inputModuleNames);
    ...
    private void validateModuleNames(final String dataspaceName, final Collection<String> inputModuleNames) {
