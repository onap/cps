...
public class CpsAdminPersistenceServiceImpl implements CpsAdminPersistenceService {
    ...
    /**
     * Search for anchors, with dataspace and module names,
     * if dataspace or one of the module names is not exists, return with an empty collection.
     *
     * @param dataspaceName dataspace name
     * @param inputModuleNames a collection of module names
     * @return the collection of the filtered anchors
     */
    @Override
