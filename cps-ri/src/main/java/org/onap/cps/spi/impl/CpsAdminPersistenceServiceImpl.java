...
public class CpsAdminPersistenceServiceImpl implements CpsAdminPersistenceService {
    ...
    @Override
    public void createAnchorFromNewModulesAndExistingModules(final String cmHandleId,
        ...
        final var dataspaceEntity = dataspaceRepository.getByName(dataspaceName);
        cpsModulePersistenceService.storeSchemaSet(dataspaceName, cmHandleId, newYangResourcesModuleNameToContentMap);
        final var schemaSetEntity =
                schemaSetRepository.getByDataspaceAndName(dataspaceEntity, cmHandleId);
        ...
        createAnchor(dataspaceName, cmHandleId, cmHandleId);
