...
public class CpsAdminPersistenceServiceImpl implements CpsAdminPersistenceService {
    ...
    public Collection<Anchor> getAnchors(final String dataspaceName) {
        ...
        return anchorEntities.stream().map(entity -> buildAnchor(entity, dataspaceName)).collect(Collectors.toList());
    }

    private static Anchor buildAnchor(final AnchorEntity anchorEntity, final String dataspaceName) {
