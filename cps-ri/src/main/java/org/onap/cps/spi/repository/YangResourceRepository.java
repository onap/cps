...
public interface YangResourceRepository extends JpaRepository<YangResourceEntity, Long>,
    ...
    @Query(value = "select inputYangResourceModuleReference.module_name, inputYangResourceModuleReference.revision\n"
        + " from inputYangResourceModuleReference left join moduleReference\n"
        + " ON inputYangResourceModuleReference.module_name=moduleReference.module_name\n"
        + " and inputYangResourceModuleReference.revision=moduleReference.revision\n"
        + " where moduleReference.module_name is null;", nativeQuery = true)
