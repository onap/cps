...
import org.onap.cps.spi.entities.ModuleNameAndRevision;
...
public class CpsModulePersistenceServiceImpl implements CpsModulePersistenceService {
    ...
    public List<ModuleReference> getAllYangResourcesModuleReferences() {
        final List<ModuleNameAndRevision> yangResourceEntities =
    ...
    private static ModuleReference toModuleResource(final ModuleNameAndRevision moduleNameAndRevisionList) {
        return ModuleReference.builder()
                .name(moduleNameAndRevisionList.getModuleName())
                .revision(moduleNameAndRevisionList.getRevision())
                .build();
    }
}
