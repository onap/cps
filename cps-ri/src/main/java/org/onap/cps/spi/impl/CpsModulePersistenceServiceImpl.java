...
import org.onap.cps.spi.entities.ModuleNameAndRevisionEntity;
...
public class CpsModulePersistenceServiceImpl implements CpsModulePersistenceService {
    ...
    public List<ModuleReference> getAllYangResourcesModuleReferences() {
        final Collection<ModuleNameAndRevisionEntity> yangResourceEntities =
    ...
    private static ModuleReference toModuleResource(final ModuleNameAndRevisionEntity yangResourceEntity) {
