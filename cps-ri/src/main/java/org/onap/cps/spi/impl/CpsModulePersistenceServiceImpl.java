...
public class CpsModulePersistenceServiceImpl implements CpsModulePersistenceService {
    ...
    public List<ModuleReference> identifyNewYangResourceModuleReferences(
        ...
        final List<ModuleReference> newModuleReferences = yangResourceRepository
            .identifyNewYangResourceModuleReferences().stream().map(commonModuleReference ->
                toModuleReference(commonModuleReference)
            ).collect(Collectors.toList());
    ...
    public List<ModuleReference> existingYangResourceModuleReferences(
        ...
        final List<ModuleReference> existingModuleReferences = yangResourceRepository
            .existingYangResourceModuleReferences().stream().map(existingModuleReference ->
                toModuleReference(existingModuleReference)
            ).collect(Collectors.toList());
