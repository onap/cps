...
public class SchemaSetYangResourceRepositoryImpl implements SchemaSetYangResourceRepository {
    ...
    @Override
    public void identifyNewYangResourceModuleReferences(
        final Collection<ModuleReference> inputYangResourceModuleReference) {
        createTemporaryTablesAndInsertData(inputYangResourceModuleReference);
    }

    private void createTemporaryTablesAndInsertData(
        final Collection<ModuleReference> inputYangResourceModuleReference) {
