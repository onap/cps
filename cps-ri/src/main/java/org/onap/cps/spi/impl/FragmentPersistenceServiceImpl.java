...
public class FragmentPersistenceServiceImpl implements FragmentPersistenceService {
    ...
    private ModuleEntity findModule(AnchorDetails anchorDetails, final Dataspace dataspace)
    ...
    private Dataspace findDatasapce(AnchorDetails anchorDetails) throws CpsNotFoundException {
