...
public class CpsDataPersistenceServiceImpl implements CpsDataPersistenceService {
    ...
    public List<DataNode> queryDataNodes(final String dataspaceName, final String anchorName, final String cpsPath,
        ...
        populateDataNodesFromFragmentEntities(fetchDescendantsOption, anchorEntity, fragmentEntities, dataNodes);
        return Collections.unmodifiableList(dataNodes);
    }

    private void populateDataNodesFromFragmentEntities(final FetchDescendantsOption fetchDescendantsOption,
                                                       final AnchorEntity anchorEntity,
