...
public class CpsDataPersistenceServiceImpl implements CpsDataPersistenceService {
    ...
    private static FragmentEntity getFragmentForReplacement(final FragmentEntity parentEntity,
        ...
        if (dataNodeHasNoChildren(replacementDataNode)) {
            copyAttributesFromReplacementDataNode(parentEntity, existingListNodeElementEntity, replacementDataNode);
    ...
    private static boolean dataNodeHasNoChildren(final DataNode replacementDataNode) {
        return replacementDataNode.getChildDataNodes().isEmpty();
    }
    ...
    private static void copyAttributesFromReplacementDataNode(final FragmentEntity parentEntity,
                                                              final FragmentEntity existingListNodeElementEntity,
                                                              final DataNode replacementDataNode) {
        final FragmentEntity fragmentEntity =
            toFragmentEntity(parentEntity.getDataspace(),
                ...
                replacementDataNode);
        existingListNodeElementEntity.setAttributes(fragmentEntity.getAttributes());
    }
