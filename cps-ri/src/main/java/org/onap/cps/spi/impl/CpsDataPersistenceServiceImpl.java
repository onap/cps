...
public class CpsDataPersistenceServiceImpl implements CpsDataPersistenceService {
    ...
    @Override
    @Transactional
    public void addListElementsCollection(final String dataspaceName, final String anchorName,
            final String parentNodeXpath, final List<Collection<DataNode>> newListsElements) {
