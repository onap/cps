...
public class CpsDataPersistenceServiceImpl implements CpsDataPersistenceService {
    ...
    public void batchUpdateDataLeaves(final String dataspaceName, final String anchorName,
        ...
        final Collection<String> xpathsOfUpdatedDataNodes = xpathToUpdatedDataNode.keySet();
        final Collection<FragmentEntity> fragmentEntities = getFragmentEntities(anchorEntity, xpathsOfUpdatedDataNodes,
                FetchDescendantsOption.INCLUDE_ALL_DESCENDANTS);

        for (final FragmentEntity fragmentEntity : fragmentEntities) {
            final DataNode dataNode = xpathToUpdatedDataNode.get(fragmentEntity.getXpath());
