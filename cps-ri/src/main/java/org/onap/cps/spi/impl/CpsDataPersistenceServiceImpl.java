...
public class CpsDataPersistenceServiceImpl implements CpsDataPersistenceService {
    ...
    public void addChildDataNode(final String dataspaceName, final String anchorName, final String parentNodeXpath,
        ...
        addNewChildDataNode(getAnchorEntity(dataspaceName, anchorName), parentNodeXpath, newChildDataNode);
    }
    ...
    public void addChildDataNodes(final String dataspaceName, final String anchorName,
        ...
        addChildrenDataNodes(getAnchorEntity(dataspaceName, anchorName), parentNodeXpath, dataNodes);
    }

    @Override
    public void addListElements(final String dataspaceName, final String anchorName, final String parentNodeXpath,
                                final Collection<DataNode> newListElements) {
        addChildrenDataNodes(getAnchorEntity(dataspaceName, anchorName), parentNodeXpath, newListElements);
    }
    ...
    public Collection<DataNode> getDataNodesForMultipleXpaths(final String dataspaceName, final String anchorName,
        ...
        final Collection<FragmentEntity> fragmentEntities =
            getFragmentEntities(getAnchorEntity(dataspaceName, anchorName), xpaths);
    ...
    public void updateDataLeaves(final String dataspaceName, final String anchorName, final String xpath,
        ...
        final FragmentEntity fragmentEntity = getFragmentEntity(getAnchorEntity(dataspaceName, anchorName), xpath);
    ...
    public void updateDataNodeAndDescendants(final String dataspaceName, final String anchorName,
        ...
        final FragmentEntity fragmentEntity = getFragmentEntity(getAnchorEntity(dataspaceName, anchorName),
            dataNode.getXpath());
    ...
    public void replaceListContent(final String dataspaceName, final String anchorName, final String parentNodeXpath,
                                   final Collection<DataNode> newListElements) {
        final FragmentEntity parentEntity = getFragmentEntity(getAnchorEntity(dataspaceName, anchorName),
            parentNodeXpath);
    ...
    private void deleteDataNode(final String dataspaceName, final String anchorName, final String targetXpath,
        ...
        if (isRootXpath(targetXpath)) {
            ...
            parentFragmentEntity = getFragmentEntity(getAnchorEntity(dataspaceName, anchorName), parentNodeXpath);
