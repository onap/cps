...
public class CpsDataPersistenceServiceImpl implements CpsDataPersistenceService {
    ...
    private int addChildDataNodes(final String dataspaceName, final String anchorName, final String parentNodeXpath,
        ...
        try {
            ...
            return fragmentRepository.saveAll(fragmentEntities).size();
