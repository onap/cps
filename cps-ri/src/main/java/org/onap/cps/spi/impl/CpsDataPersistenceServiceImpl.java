...
public class CpsDataPersistenceServiceImpl implements CpsDataPersistenceService {
    ...
    private Collection<FragmentEntity> getFragmentEntities(final AnchorEntity anchorEntity,
        ...
        final List<FragmentEntity> fragmentEntities =
                fragmentRepository.findByAnchorAndXpathIn(anchorEntity, normalizedXpaths);

        return fragmentRepository.prefetchDescendantsForFragmentEntities(fetchDescendantsOption, fragmentEntities);
    }
