...
public class CpsDataPersistenceServiceImpl implements CpsDataPersistenceService {
    ...
    public List<DataNode> queryDataNodes(final String dataspaceName, final String anchorName, final String cpsPath,
        ...
        } else if (CpsPathQueryType.XPATH_HAS_DESCENDANT_WITH_LEAF_VALUE.equals(cpsPathQuery.getCpsPathQueryType())) {
            fragmentEntities = fragmentRepository
                .getByAnchorAndXpathEndsInDescendantNameWithLeafAttributes(anchorEntity.getId(),
                    cpsPathQuery.getDescendantName(), cpsPathQuery.getAlternatingLeafValueList());
        } else {
            fragmentEntities = fragmentRepository
