...
CREATE TABLE IF NOT EXISTS MODULESET
(
    ID SERIAL PRIMARY KEY,
    NAME TEXT NOT NULL,
    DATASPACE_ID BIGINT NOT NULL,
    UNIQUE (NAME, DATASPACE_ID),
    CONSTRAINT MODULESET_DATASPACE FOREIGN KEY (DATASPACE_ID) REFERENCES DATASPACE (ID) ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS MODULESET_FILES
(
    YANG_FILE_ID BIGINT NOT NULL REFERENCES YANG_FILE(ID),
    MODULESET_ID BIGINT NOT NULL,
    CONSTRAINT MODULESET_FILE FOREIGN KEY (MODULESET_ID) REFERENCES MODULESET(ID) ON DELETE CASCADE
);
