...
(
    ...
    DATASPACE_ID BIGINT NOT NULL,
    MODULESET_ID BIGINT,
    UNIQUE (DATASPACE_ID, MODULESET_ID, NAMESPACE, REVISION),
    CONSTRAINT MODULE_DATASPACE FOREIGN KEY (DATASPACE_ID) REFERENCES DATASPACE (ID) ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT MODULE_MODULESET FOREIGN KEY (MODULESET_ID) REFERENCES MODULESET (ID) ON UPDATE CASCADE ON DELETE CASCADE
);
