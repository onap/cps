...
(
    ...
    CONSTRAINT ANCHOR_DATASPACE FOREIGN KEY (DATASPACE_ID) REFERENCES DATASPACE (ID) ON DELETE CASCADE,
    CONSTRAINT ANCHOR_SCHEMA_SET FOREIGN KEY (SCHEMA_SET_ID) REFERENCES SCHEMA_SET (ID) ON DELETE CASCADE
);
