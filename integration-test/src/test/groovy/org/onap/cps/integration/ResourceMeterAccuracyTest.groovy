...
class ResourceMeterAccuracyTest extends Specification {
    ...
    def 'Resource meter duration measurement.'() {
        ...
        then: 'the resource meter reports a duration within 10ms of the expected duration'
            assert objectUnderTest.getTotalTimeInSeconds() >= 1.99
            assert objectUnderTest.getTotalTimeInSeconds() <= 2.01
    }
