...
class CpsPerfTestBase extends PerfTestBase {
    ...
    def addOpenRoadData() {
        ...
        recordAndAssertResourceUsage('Creating openroadm anchors with large data tree', 100, durationInSeconds, 200, resourceMeter.getTotalMemoryUsageInMB())
    }
    ...
    def 'Warm the database'() {
        ...
        and: 'all data is read within expected time'
            recordAndAssertResourceUsage("Warming database", 200, durationInSeconds, 100, resourceMeter.getTotalMemoryUsageInMB())
    }
