...
class CpsPerfTestBase extends PerfTestBase {
    ...
    def addOpenRoadData() {
        ...
        recordAndAssertPerformance('Creating openroadm anchors with large data tree', TimeUnit.SECONDS.toMillis(200), durationInMillis, 200, resourceMeter.getTotalMemoryUsageInMB())
    }
    ...
    def 'Warm the database'() {
        ...
        and: 'all data is read within expected time'
            recordAndAssertPerformance("Warming database", TimeUnit.SECONDS.toMillis(200), durationInMillis, 200, resourceMeter.getTotalMemoryUsageInMB())
    }
