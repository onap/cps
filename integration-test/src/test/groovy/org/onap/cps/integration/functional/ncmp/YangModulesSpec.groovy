...
class YangModulesSpec extends CpsIntegrationSpecBase {
    ...
    def 'Get yang module references returns expected modules.'() {
    ...
    def 'Get yang module definitions returns expected modules.'() {
    ...
    def 'Get yang module definition for specific module.'() {
