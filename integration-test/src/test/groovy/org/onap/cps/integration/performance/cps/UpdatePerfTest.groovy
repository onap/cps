...
class UpdatePerfTest extends CpsPerfTestBase {
    ...
    def 'Replace single data node and descendants: #scenario.'() {
        ...
        where:
            ...
            'Update Warmup #1 (ignore)'        | 100        | 1       | false        ||         8 | 250
            'Update Warmup #2 (ignore)'        | 0          | 1       | true         ||         8 | 250
            'Replace 0 nodes with 100'         | 100        | 1       | false        ||         7 | 250
            'Replace 100 using same data'      | 100        | 1       | false        ||         6 | 250
            'Replace 100 with new leaf values' | 100        | 1       | true         ||         5 | 250
            'Replace 100 with 100 new nodes'   | 100        | 101     | false        ||        10 | 300
            'Replace 50 existing and 50 new'   | 100        | 151     | true         ||         7 | 250
    ...
    def 'Replace list content: #scenario.'() {
        ...
        where:
            ...
            'Replace list of 100 using same data'      | 100        | 1       | false        ||         6 | 250
            'Replace list of 100 with new leaf values' | 100        | 1       | true         ||         5 | 250
            'Replace list with 100 new nodes'          | 100        | 101     | false        ||        10 | 300
            'Replace list with 50 existing and 50 new' | 100        | 151     | true         ||         7 | 250
