...
class UpdatePerfTest extends CpsPerfTestBase {
    ...
    def 'Replace single data node and descendants: #scenario.'() {
        ...
        where:
            ...
            'Replace 100 using same data'      | 100        | 1       | false        || 5.5          | false
    ...
    def 'Replace list content: #scenario.'() {
        ...
        where:
            ...
            'Replace list of 100 using same data'      | 100        | 1       | false        || 5.5
            'Replace list of 100 with new leaf values' | 100        | 1       | true         || 5.5
            'Replace list with 100 new nodes'          | 100        | 101     | false        || 9.0
            'Replace list with 50 existing and 50 new' | 100        | 151     | true         || 8.0
