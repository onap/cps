...
class CmSubscriptionSpec extends CpsIntegrationSpecBase {
    ...
    def createAndAcceptSubscriptionA() {
        ...
        sendSubscriptionRequest(subscriptionTopic, 'dataJobA', eventPayload, 'myDataJobId')
    ...
    def createAndAcceptSubscriptionB() {
        ...
        sendSubscriptionRequest(subscriptionTopic, 'dataJobB', eventPayload, 'myDataJobId')
