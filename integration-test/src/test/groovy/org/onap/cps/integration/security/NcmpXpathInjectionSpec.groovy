...
class NcmpXpathInjectionSpec extends CpsIntegrationSpecBase {
    ...
    def 'Set data sync enabled via REST with #scenario'() {
    ...
    def 'Search cm handles with #scenario in property value'() {
        ...
        then: 'the injection does not return all cm handles'
            def body = response.body ?: '[]'
            assert !body.contains('ch-1')
            assert !body.contains('ch-2')
        where:
    ...
    def 'Search cm handles with #scenario in DMI plugin identifier'() {
