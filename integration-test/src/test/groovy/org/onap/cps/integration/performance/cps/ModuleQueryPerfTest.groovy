...
class ModuleQueryPerfTest extends CpsPerfTestBase {
    ...
    def 'Module query - Preload test data (needed for other tests).'() {
        given: 'a schema set with different sizes of Yang modules is created'
            cpsModuleService.createSchemaSet(CPS_PERFORMANCE_TEST_DATASPACE, SCHEMA_SET_PREFIX + '0', [
                    ...
                    'module1.yang': makeYangModuleOfLength('module1', 200 * KILOBYTE),
                    'module2.yang': makeYangModuleOfLength('module2', 400 * KILOBYTE),
                    'module3.yang': makeYangModuleOfLength('module3', 600 * KILOBYTE),
                    'module4.yang': makeYangModuleOfLength('module4', 800 * KILOBYTE),
                    'module5.yang': makeYangModuleOfLength('module5', 1000 * KILOBYTE),
            ])
        and: 'these modules will be used again to create many schema sets'
            def allModuleReferences = [
                    ...
                    new ModuleReference('module2', MODULE_REVISION),
                    new ModuleReference('module3', MODULE_REVISION),
                    new ModuleReference('module4', MODULE_REVISION),
                    new ModuleReference('module5', MODULE_REVISION),
            ]
    ...
    def 'Bug CPS-2190: Querying anchors by module name IS dependant on the file size of the module.'() {
        ...
        where: 'the following parameters are used'
            ...
            '1 KB module'    | 'module0'      || 3.0
            '200 KB module'  | 'module1'      || 4.8
            '400 KB module'  | 'module2'      || 5.3
            '600 KB module'  | 'module3'      || 7.4
            '800 KB module'  | 'module4'      || 9.3
            '1000 KB module' | 'module5'      || 12.0
    }
