...
class DataServiceIntegrationSpec extends FunctionalSpecBase {
    ...
    def 'FAILING TEST: Replace data node at root xpath on an anchor with no existing data.'() {
        ...
        then: 'the method reports that data was created'
            // assert dataTreeUpdateAction == true
        and: 'the data is not persisted and throws exception'
