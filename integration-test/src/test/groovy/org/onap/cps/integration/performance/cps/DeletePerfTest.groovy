...
class DeletePerfTest extends CpsPerfTestBase {
    ...
    def 'Delete 100 container nodes'() {
        ...
        then: 'delete duration is within expected time'
            recordAndAssertPerformance('Delete 100 containers', 2000, deleteDurationInMillis)
    }
    ...
    def 'Delete 100 list elements'() {
        ...
        when: 'list elements are deleted'
            ...
            def deleteDurationInMillis = stopWatch.getTotalTimeMillis()
        then: 'delete duration is within expected time'
            recordAndAssertPerformance('Delete 100 lists elements', 2000, deleteDurationInMillis)
    }
    ...
    def 'Delete 100 whole lists'() {
        ...
        when: 'lists are deleted'
            ...
            def deleteDurationInMillis = stopWatch.getTotalTimeMillis()
        then: 'delete duration is within expected time'
            recordAndAssertPerformance('Delete 100 whole lists', 5000, deleteDurationInMillis)
    }
    ...
    def 'Batch delete 100 whole lists'() {
        ...
        when: 'lists are deleted'
            ...
            def deleteDurationInMillis = stopWatch.getTotalTimeMillis()
        then: 'delete duration is within expected time'
            recordAndAssertPerformance('Batch delete 100 whole lists', 4000, deleteDurationInMillis)
    }
    ...
    def 'Delete 1 large data node'() {
        when: 'parent node is deleted'
            ...
            def deleteDurationInMillis = stopWatch.getTotalTimeMillis()
        then: 'delete duration is within expected time'
            recordAndAssertPerformance('Delete one large node', 1500, deleteDurationInMillis)
    }
    ...
    def 'Delete root node with many descendants'() {
        when: 'root node is deleted'
            ...
            def deleteDurationInMillis = stopWatch.getTotalTimeMillis()
        then: 'delete duration is within expected time'
            recordAndAssertPerformance('Delete root node', 1500, deleteDurationInMillis)
    }
    ...
    def 'Delete data nodes for an anchor'() {
        when: 'data nodes are deleted'
            ...
            def deleteDurationInMillis = stopWatch.getTotalTimeMillis()
        then: 'delete duration is within expected time'
            recordAndAssertPerformance('Delete data nodes for anchor', 1500, deleteDurationInMillis)
    }
    ...
    def 'Batch delete 100 non-existing nodes'() {
        ...
        when: 'child nodes are deleted'
            ...
            def deleteDurationInMillis = stopWatch.getTotalTimeMillis()
        then: 'delete duration is within expected time'
            recordAndAssertPerformance('Batch delete 100 non-existing', 6000, deleteDurationInMillis)
    }
    ...
    def 'Clean up test data'() {
        ...
        when: 'data nodes are deleted'
            ...
            def deleteDurationInMillis = stopWatch.getTotalTimeMillis()
        then: 'delete duration is within expected time'
            recordAndAssertPerformance('Delete test cleanup', 10_000, deleteDurationInMillis)
    }
