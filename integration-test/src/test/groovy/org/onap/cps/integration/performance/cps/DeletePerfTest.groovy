...
class DeletePerfTest extends CpsPerfTestBase {
    ...
    def 'Create test data (please note, subsequent tests depend on this running first).'() {
        ...
        then: 'setup duration is below accepted margin of the expected average'
            recordAndAssertResourceUsage('CPS:', 'Delete test setup', 103, setupDurationInSeconds, 800, resourceMeter.getTotalMemoryUsageInMB(), false)
    }
    ...
    def 'Delete 100 container nodes'() {
        ...
        then: 'delete duration is below accepted margin of the expected average'
            recordAndAssertResourceUsage('CPS:', 'Delete 100 containers', 2.1, deleteDurationInSeconds, 20, resourceMeter.getTotalMemoryUsageInMB(), false)
    }
    ...
    def 'Batch delete 100 container nodes'() {
        ...
        when: 'child nodes are deleted'
            ...
            def deleteDurationInSeconds = resourceMeter.getTotalTimeInSeconds()
        then: 'delete duration is below accepted margin of the expected average'
            recordAndAssertResourceUsage('CPS:', 'Batch delete 100 containers', 0.65, deleteDurationInSeconds, 2, resourceMeter.getTotalMemoryUsageInMB(), false)
    }
    ...
    def 'Delete 100 list elements'() {
        ...
        when: 'list elements are deleted'
            ...
            def deleteDurationInSeconds = resourceMeter.getTotalTimeInSeconds()
        then: 'delete duration is below accepted margin of the expected average'
            recordAndAssertResourceUsage('CPS:', 'Delete 100 lists elements', 2.3, deleteDurationInSeconds, 20, resourceMeter.getTotalMemoryUsageInMB(), false)
    }
    ...
    def 'Batch delete 100 list elements'() {
        ...
        when: 'list elements are deleted'
            ...
            def deleteDurationInSeconds = resourceMeter.getTotalTimeInSeconds()
        then: 'delete duration is below accepted margin of the expected average'
            recordAndAssertResourceUsage('CPS:', 'Batch delete 100 lists elements', 0.7, deleteDurationInSeconds, 2, resourceMeter.getTotalMemoryUsageInMB(), false)
    }
    ...
    def 'Delete 100 whole lists'() {
        ...
        then: 'delete duration is below accepted margin (4x) of the expected average'
            recordAndAssertResourceUsage('CPS:', 'Delete 100 whole lists', 3.2, deleteDurationInSeconds, 20, resourceMeter.getTotalMemoryUsageInMB(), false)
    }
    ...
    def 'Batch delete 100 whole lists'() {
        ...
        then: 'delete duration is below accepted margin (3x) of the expected average'
            recordAndAssertResourceUsage('CPS:', 'Batch delete 100 whole lists', 2.4, deleteDurationInSeconds, 3, resourceMeter.getTotalMemoryUsageInMB(), false)
    }
    ...
    def 'Delete 1 large data node'() {
        when: 'parent node is deleted'
            ...
            def deleteDurationInSeconds = resourceMeter.getTotalTimeInSeconds()
        then: 'delete duration is below accepted margin of the expected average'
            recordAndAssertResourceUsage('CPS:', 'Delete one large node', 1.9, deleteDurationInSeconds, 1, resourceMeter.getTotalMemoryUsageInMB(), false)
    }
    ...
    def 'Delete root node with many descendants'() {
        when: 'root node is deleted'
            ...
            def deleteDurationInSeconds = resourceMeter.getTotalTimeInSeconds()
        then: 'delete duration is below accepted margin of the expected average'
            recordAndAssertResourceUsage('CPS:', 'Delete root node', 1.9, deleteDurationInSeconds, 1, resourceMeter.getTotalMemoryUsageInMB(), false)
    }
    ...
    def 'Delete data nodes for an anchor'() {
        when: 'data nodes are deleted'
            ...
            def deleteDurationInSeconds = resourceMeter.getTotalTimeInSeconds()
        then: 'delete duration is below accepted margin of the expected average'
            recordAndAssertResourceUsage('CPS:', 'Delete data nodes for anchor', 1.9, deleteDurationInSeconds, 1, resourceMeter.getTotalMemoryUsageInMB(), false)
    }
    ...
    def 'Batch delete 100 non-existing nodes'() {
        ...
        when: 'child nodes are deleted'
            ...
            def deleteDurationInSeconds = resourceMeter.getTotalTimeInSeconds()
        then: 'delete duration is below accepted margin of the expected average'
            recordAndAssertResourceUsage('CPS:', 'Batch delete 100 non-existing', 2, deleteDurationInSeconds, 3, resourceMeter.getTotalMemoryUsageInMB(), false)
    }
    ...
    def 'Clean up test data'() {
        ...
        when: 'data nodes are deleted'
            ...
            def deleteDurationInSeconds = resourceMeter.getTotalTimeInSeconds()
        then: 'delete duration is below accepted margin of the expected average'
            recordAndAssertResourceUsage('CPS:', 'Delete test cleanup', 11.09, deleteDurationInSeconds, 1, resourceMeter.getTotalMemoryUsageInMB(), false)
    }
