...
class CpsQueryServiceIntegrationSpec extends FunctionalSpecBase {
    ...
    def 'Cps Path query across anchors using pagination option with #scenario.'() {
        ...
        and: 'the correct number of page size is rer]turned'
        ...
        where: 'the following data is used'
            ...
            'container node first page with size one'                        | 1         | 1        | '/bookstore'                                          || [BOOKSTORE_ANCHOR_1]                     || ["/bookstore"]
            'container node 1st page two size'                               | 1         | 2        | '/bookstore'                                          || [BOOKSTORE_ANCHOR_1, BOOKSTORE_ANCHOR_2] || ["/bookstore"]
            'container node 2nd page with size one'                          | 2         | 1        | '/bookstore'                                          || [BOOKSTORE_ANCHOR_2]                     || ["/bookstore"]
            'container node 2nd page with size two'                          | 2         | 2        | '/bookstore'                                          || []                                       || []
            'list node 1st page with size one'                               | 1         | 1        | '/bookstore/categories'                               || [BOOKSTORE_ANCHOR_1]                     || ["/bookstore/categories[@code='1']", "/bookstore/categories[@code='2']", "/bookstore/categories[@code='3']", "/bookstore/categories[@code='4']"]
            ...
            'list node 2nd page with size one'                               | 2         | 1        | '/bookstore/categories'                               || [BOOKSTORE_ANCHOR_2]                     || ["/bookstore/categories[@code='1']", "/bookstore/categories[@code='2']", "/bookstore/categories[@code='3']", "/bookstore/categories[@code='4']"]
            'list node 2nd page with size two'                               | 2         | 2        | '/bookstore/categories'                               || []                                       || []
            'multiple list-ancestors 1st page with size 1'                   | 1         | 1        | '//books/ancestor::categories'                        || [BOOKSTORE_ANCHOR_1]                     || ["/bookstore/categories[@code='1']", "/bookstore/categories[@code='2']", "/bookstore/categories[@code='3']", "/bookstore/categories[@code='4']"]
            ...
            'list with index value in the xpath prefix 2nd page with size 1' | 2         | 1        | '//categories[@code="1"]/books/ancestor::bookstore'   || [BOOKSTORE_ANCHOR_2]                     || ["/bookstore"]
