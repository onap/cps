...
class FunctionalSpecBase extends CpsIntegrationSpecBase {
    ...
    def static BOOKSTORE_ANCHOR_6 = 'bookstoreAnchorForUpdateInDelta1'
    ...
    def static bookstoreJsonDataForUpdatesInDelta = readResourceDataFile('bookstore/bookstoreDataForUpdatesInDelta.json')
    ...
    def addDeltaData() {
        ...
        addAnchorsWithData(NUMBER_OF_ANCHORS_PER_DATASPACE_WITH_BOOKSTORE_DELTA_DATA, FUNCTIONAL_TEST_DATASPACE_3, BOOKSTORE_SCHEMA_SET, 'bookstoreTargetAnchor', bookstoreJsonDataForDelta)
        ...
        addAnchorsWithData(NUMBER_OF_ANCHORS_PER_DATASPACE_WITH_BOOKSTORE_DELTA_DATA, FUNCTIONAL_TEST_DATASPACE_3, BOOKSTORE_SCHEMA_SET, 'bookstoreAnchorForUpdateInDelta', bookstoreJsonDataForUpdatesInDelta)
    }
