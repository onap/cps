...
class FunctionalSpecBase extends CpsIntegrationSpecBase {
    ...
    def static BOOKSTORE_ANCHOR_4 = 'bookstoreTargetAnchor1'
    def static BOOKSTORE_ANCHOR_5 = 'copyOfSourceAnchor1'
    def static BOOKSTORE_ANCHOR_6 = 'bookstoreAnchorForUpdateAndDeleteAction1'
    ...
    def static bookstoreJsonDataForTargetAnchor = readResourceDataFile('bookstore/bookstoreDeltaDataForTargetAnchor.json')
    def static bookstoreJsonDataForUpdateAndDeleteAction = readResourceDataFile('bookstore/bookstoreDataForUpdateAndDeleteAction.json')
    ...
    def addDeltaData() {
        ...
        addAnchorsWithData(NUMBER_OF_ANCHORS_PER_DATASPACE_WITH_BOOKSTORE_DELTA_DATA, FUNCTIONAL_TEST_DATASPACE_3, BOOKSTORE_SCHEMA_SET, 'bookstoreTargetAnchor', bookstoreJsonDataForTargetAnchor)
        ...
        addAnchorsWithData(NUMBER_OF_ANCHORS_PER_DATASPACE_WITH_BOOKSTORE_DELTA_DATA, FUNCTIONAL_TEST_DATASPACE_3, BOOKSTORE_SCHEMA_SET, 'bookstoreAnchorForUpdateAndDeleteAction', bookstoreJsonDataForUpdateAndDeleteAction)
    }
