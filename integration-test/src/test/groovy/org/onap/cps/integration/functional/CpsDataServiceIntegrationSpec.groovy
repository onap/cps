...
class CpsDataServiceIntegrationSpec extends FunctionalSpecBase {
    ...
    def 'Get delta between anchors for update operation #scenario'() {
        ...
        where: 'following data was used'
            scenario                                                                          | index | xpath                            | sourceAnchor         | targetAnchor         || expectedSourceData                      || expectedTargetData                      || expectedParentNodeXpath                                                          | fetchDescendantsOption  | expectedChildNodeXpaths
