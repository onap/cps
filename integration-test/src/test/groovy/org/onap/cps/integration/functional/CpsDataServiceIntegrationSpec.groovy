...
class CpsDataServiceIntegrationSpec extends FunctionalSpecBase {
    ...
    def 'Get delta between anchors for added nodes #scenario'() {
        ...
        where: 'following data was used'
            ...
            'node with only leaves'                      |   1   | EMPTY_BOOKSTORE_DATA | BOOKSTORE_ANCHOR_4   | 31                      | '/bookstore'                       | "/bookstore/categories[@code='6']"
            'node with leaves and child data node'       |   2   | EMPTY_BOOKSTORE_DATA | BOOKSTORE_ANCHOR_4   | 31                      | '/bookstore'                       | "/bookstore/categories[@code='1']"
            'node with no leaves and no child data node' |   19  | EMPTY_BOOKSTORE_DATA | BOOKSTORE_ANCHOR_4   | 31                      | '/bookstore'                       | "/bookstore/container-without-leaves"
            'node with only child data node'             |   24  | EMPTY_BOOKSTORE_DATA | BOOKSTORE_ANCHOR_4   | 31                      | '/bookstore'                       | "/bookstore/premises/addresses[@house-number='2' and @street='Main Street']"
