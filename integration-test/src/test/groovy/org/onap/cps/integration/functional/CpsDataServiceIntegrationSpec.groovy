...
class CpsDataServiceIntegrationSpec extends FunctionalSpecBase {
    ...
    def 'Get delta between anchor and payload error scenario: #scenario'() {
        ...
        'invalid anchor 1 name'                        | FUNCTIONAL_TEST_DATASPACE_3 | 'invalid anchor'      | '/'          | '{some-json}' || DataValidationException
        'non-existing dataspace'                       | 'non-existing'              | 'not-relevant1'       | '/'          | '{some-json}' || DataspaceNotFoundException
