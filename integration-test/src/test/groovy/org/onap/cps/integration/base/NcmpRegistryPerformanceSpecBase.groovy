...
class NcmpRegistryPerformanceSpecBase extends PerformanceSpecBase {
    ...
    def createInitialData() {
        ...
        cpsAdminService.createAnchor(PERFORMANCE_TEST_DATASPACE, REGISTRY_SCHEMA_SET, REGISTRY_ANCHOR)
        cpsDataService.saveData(PERFORMANCE_TEST_DATASPACE, REGISTRY_ANCHOR, data, OffsetDateTime.now())
    }
    ...
    def setupPerformanceInfraStructure() {
        ...
        cpsModuleService.createSchemaSet(PERFORMANCE_TEST_DATASPACE, REGISTRY_SCHEMA_SET, [registry: modelAsString])
    }
