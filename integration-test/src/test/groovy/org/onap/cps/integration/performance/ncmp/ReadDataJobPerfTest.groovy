...
class ReadDataJobPerfTest extends CpsIntegrationSpecBase {
    ...
    def 'Performance test single read data job classification'() {
        given: 'a read request with 10 selectors (90% broadcast)'
        ...
        and: 'each run completes under 1 second. Averages below 0.1s'
    ...
    def 'Performance test 20 parallel read data job classifications'() {
        ...
        and: 'each batch of 20 jobs completes under 1 second. Averages below 0.1s'
