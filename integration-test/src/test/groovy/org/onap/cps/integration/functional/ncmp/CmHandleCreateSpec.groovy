...
class CmHandleCreateSpec extends CpsIntegrationSpecBase {
    ...
    def 'CM Handle registration.'() {
        ...
        then: 'sleep a little to allow message to appear'
            //TODO: to review the timing with Toine when in office.
            Thread.sleep(2000)

        then: 'get the latest messages'
            //TODO: to review the timing with Toine when in office.
            def consumerRecords = kafkaConsumer.poll(Duration.ofMillis(2000))
