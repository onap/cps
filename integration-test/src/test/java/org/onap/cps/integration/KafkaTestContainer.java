...
public class KafkaTestContainer extends ConfluentKafkaContainer {
     ...
     *
     * @param producerGroupId producer group id
     * @param valueSerializer value serializer
     * @return                kafka test producer
     */
    public static KafkaProducer createProducer(final String producerGroupId, final Object valueSerializer) {
        ...
        configProps.put(ProducerConfig.CLIENT_ID_CONFIG, producerGroupId);
