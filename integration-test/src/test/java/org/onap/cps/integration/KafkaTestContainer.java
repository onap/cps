...
public class KafkaTestContainer extends KafkaContainer {
    ...
    @Override
    public void stop() {
        // never stop otherwise upon test completion, otherwise the data in topics will be lost
    }

    private static Map<String, Object> consumerProperties(final String consumerGroupId, final Object valueDeserializer) {
