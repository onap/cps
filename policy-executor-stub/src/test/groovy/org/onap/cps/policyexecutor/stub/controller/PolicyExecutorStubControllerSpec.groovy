...
class PolicyExecutorStubControllerSpec extends Specification {
    ...
    def 'Permission request with #resourceIdentifier.'() {
        ...
        where: 'the following targets are used'
            ...
            'prefix/policySimulation=policyResponse_deny'  || '2'        | 'deny'         | 'Stub is mocking a policy response: deny'
            'prefix/policySimulation=policyResponse_other' || '3'        | 'other'        | 'Stub is mocking a policy response: other'
    }
